...
cat(int fd)
{
  ...
  44:	8b058593          	add	a1,a1,-1872 # 8f0 <malloc+0x108>
  48:	4509                	li	a0,2
  ...
  72:	89a58593          	add	a1,a1,-1894 # 908 <malloc+0x120>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 10a:	81a58593          	add	a1,a1,-2022 # 920 <malloc+0x138>
 10e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ac:	4f050513          	add	a0,a0,1264 # 998 <digits>
 4b0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b2:	39270713          	add	a4,a4,914 # 940 <malloc+0x158>
 ...
 63e:	35eb8b93          	add	s7,s7,862 # 998 <digits>
 ...
 656:	0992                	sll	s3,s3,0x4
 658:	397d                	addw	s2,s2,-1
 ...
 694:	2a890913          	add	s2,s2,680 # 938 <malloc+0x150>
        while(*s != 0){
...
free(void *ap)
{
 ...
 768:	e422                	sd	s0,8(sp)
 76a:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 76c:	ff050693          	add	a3,a0,-16
 ...
 79c:	00e6ea63          	bltu	a3,a4,7b0 <free+0x4a>
{
 ...
 7b4:	6390                	ld	a2,0(a5)
 7b6:	02059813          	sll	a6,a1,0x20
 7ba:	01c85713          	srl	a4,a6,0x1c
 ...
 7c4:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 7c8:	4790                	lw	a2,8(a5)
 7ca:	02061593          	sll	a1,a2,0x20
 7ce:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 838:	7cc90913          	add	s2,s2,1996 # 1000 <freep>
  if(p == (char*)-1)
 83c:	5afd                	li	s5,-1
 ...
 84c:	9c878793          	add	a5,a5,-1592 # 1210 <base>
