...
wc(int fd, char *name)
{
  ...
  aa:	8da50513          	add	a0,a0,-1830 # 980 <malloc+0x12a>
  ...
  d8:	89c50513          	add	a0,a0,-1892 # 970 <malloc+0x11a>
...
main(int argc, char *argv[])
{
 ...
 15a:	81258593          	add	a1,a1,-2030 # 968 <malloc+0x112>
 15e:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 8a6:	75e90913          	add	s2,s2,1886 # 1000 <freep>
  if(p == (char*)-1)
 8aa:	5afd                	li	s5,-1
 ...
 8ba:	95a78793          	add	a5,a5,-1702 # 1210 <base>
