...
void copyinstr1(char *s)
{
    ...
    for (int ai = 0; ai < 2; ai++)
    {
      ...
      42:	10250513          	add	a0,a0,258 # 6140 <malloc+0x104>
      ...
      74:	8082                	ret
{
      ...
      84:	0e050513          	add	a0,a0,224 # 6160 <malloc+0x124>
...
000000000000009a <opentest>:
{
    ...
    fd = open("echo", 0);
      ...
      ac:	0d050513          	add	a0,a0,208 # 6178 <malloc+0x13c>
    ...
    fd = open("doesnotexist", 0);
      ...
      ca:	0d250513          	add	a0,a0,210 # 6198 <malloc+0x15c>
    ...
    if (fd >= 0)
      ...
      ea:	09a50513          	add	a0,a0,154 # 6180 <malloc+0x144>
     ...
     106:	0a650513          	add	a0,a0,166 # 61a8 <malloc+0x16c>
...
000000000000011c <truncate2>:
{
    ...
    unlink("truncfile");
     ...
     130:	0a450513          	add	a0,a0,164 # 61d0 <malloc+0x194>
     134:	00006097          	auipc	ra,0x6
     138:	b18080e7          	jalr	-1256(ra) # 5c4c <unlink>
    int fd1 = open("truncfile", O_CREATE | O_TRUNC | O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	09050513          	add	a0,a0,144 # 61d0 <malloc+0x194>
    ...
    write(fd1, "abcd", 4);
     ...
     158:	08c58593          	add	a1,a1,140 # 61e0 <malloc+0x1a4>
     15c:	00006097          	auipc	ra,0x6
     160:	ac0080e7          	jalr	-1344(ra) # 5c1c <write>
    int fd2 = open("truncfile", O_TRUNC | O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	06850513          	add	a0,a0,104 # 61d0 <malloc+0x194>
    ...
    int n = write(fd1, "x", 1);
     ...
     180:	06c58593          	add	a1,a1,108 # 61e8 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
    ...
    unlink("truncfile");
     ...
     198:	03c50513          	add	a0,a0,60 # 61d0 <malloc+0x194>
    ...
    close(fd2);
     ...
     1ce:	02650513          	add	a0,a0,38 # 61f0 <malloc+0x1b4>
...
0000000000000264 <bigwrite>:
{
    ...
    unlink("bigwrite");
     ...
     280:	f9c50513          	add	a0,a0,-100 # 6218 <malloc+0x1dc>
    ...
    for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471)
     ...
     294:	f88a8a93          	add	s5,s5,-120 # 6218 <malloc+0x1dc>
    ...
    for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471)
     ...
     316:	f1650513          	add	a0,a0,-234 # 6228 <malloc+0x1ec>
     ...
     338:	f1450513          	add	a0,a0,-236 # 6248 <malloc+0x20c>
...
void badwrite(char *s)
{
    ...
    unlink("junk");
     ...
     362:	f0250513          	add	a0,a0,-254 # 6260 <malloc+0x224>
    ...
    for (int i = 0; i < assumed_free; i++)
    {
     ...
     376:	eee98993          	add	s3,s3,-274 # 6260 <malloc+0x224>
        if (fd < 0)
        {
    ...
    int fd = open("junk", O_CREATE | O_WRONLY);
     ...
     3c2:	ea250513          	add	a0,a0,-350 # 6260 <malloc+0x224>
    ...
    if (write(fd, "x", 1) != 1)
     ...
     3da:	e1258593          	add	a1,a1,-494 # 61e8 <malloc+0x1ac>
     ...
     3e8:	04f50963          	beq	a0,a5,43a <badwrite+0xec>
    {
     ...
     3f0:	e9450513          	add	a0,a0,-364 # 6280 <malloc+0x244>
     ...
     40a:	e6250513          	add	a0,a0,-414 # 6268 <malloc+0x22c>
     ...
     424:	e4850513          	add	a0,a0,-440 # 6268 <malloc+0x22c>
    ...
    unlink("junk");
     ...
     448:	e1c50513          	add	a0,a0,-484 # 6260 <malloc+0x224>
...
000000000000052e <copyin>:
{
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     554:	d40a0a13          	add	s4,s4,-704 # 6290 <malloc+0x254>
        uint64 addr = addrs[ai];
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     600:	c9c50513          	add	a0,a0,-868 # 6298 <malloc+0x25c>
     ...
     61e:	c9650513          	add	a0,a0,-874 # 62b0 <malloc+0x274>
     ...
     63c:	ca850513          	add	a0,a0,-856 # 62e0 <malloc+0x2a4>
     ...
     656:	cbe50513          	add	a0,a0,-834 # 6310 <malloc+0x2d4>
     ...
     674:	cb050513          	add	a0,a0,-848 # 6320 <malloc+0x2e4>
...
000000000000068a <copyout>:
{
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     6b2:	ca2a0a13          	add	s4,s4,-862 # 6350 <malloc+0x314>
        n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b32a8a93          	add	s5,s5,-1230 # 61e8 <malloc+0x1ac>
        uint64 addr = addrs[ai];
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     760:	bfc50513          	add	a0,a0,-1028 # 6358 <malloc+0x31c>
     ...
     77e:	bf650513          	add	a0,a0,-1034 # 6370 <malloc+0x334>
     ...
     798:	b7c50513          	add	a0,a0,-1156 # 6310 <malloc+0x2d4>
     ...
     7b2:	bf250513          	add	a0,a0,-1038 # 63a0 <malloc+0x364>
     ...
     7d0:	bec50513          	add	a0,a0,-1044 # 63b8 <malloc+0x37c>
...
00000000000007e6 <truncate1>:
{
    ...
    write(fd1, "abcd", 4);
     ...
     826:	9be58593          	add	a1,a1,-1602 # 61e0 <malloc+0x1a4>
    ...
    int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	99250513          	add	a0,a0,-1646 # 61d0 <malloc+0x194>
    ...
    fd1 = open("truncfile", O_WRONLY | O_TRUNC);
     ...
     86e:	96650513          	add	a0,a0,-1690 # 61d0 <malloc+0x194>
    ...
    int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	95250513          	add	a0,a0,-1710 # 61d0 <malloc+0x194>
    ...
    write(fd1, "abcdef", 6);
     ...
     8c0:	b8c58593          	add	a1,a1,-1140 # 6448 <malloc+0x40c>
     8c4:	854e                	mv	a0,s3
    ...
    unlink("truncfile");
     ...
     902:	8d250513          	add	a0,a0,-1838 # 61d0 <malloc+0x194>
    ...
    close(fd3);
     ...
     946:	aa650513          	add	a0,a0,-1370 # 63e8 <malloc+0x3ac>
     ...
     962:	aaa50513          	add	a0,a0,-1366 # 6408 <malloc+0x3cc>
     ...
     976:	aa650513          	add	a0,a0,-1370 # 6418 <malloc+0x3dc>
     ...
     992:	aaa50513          	add	a0,a0,-1366 # 6438 <malloc+0x3fc>
     ...
     9a6:	a7650513          	add	a0,a0,-1418 # 6418 <malloc+0x3dc>
     ...
     9c4:	a9050513          	add	a0,a0,-1392 # 6450 <malloc+0x414>
     ...
     9e2:	a9250513          	add	a0,a0,-1390 # 6470 <malloc+0x434>
...
00000000000009f8 <writetest>:
{
    ...
    fd = open("small", O_CREATE | O_RDWR);
     ...
     a16:	a7e50513          	add	a0,a0,-1410 # 6490 <malloc+0x454>
    ...
    if (fd < 0)
     ...
     a2e:	a8e98993          	add	s3,s3,-1394 # 64b8 <malloc+0x47c>
        if (write(fd, "bbbbbbbbbb", SZ) != SZ)
     a32:	00006a97          	auipc	s5,0x6
     a36:	abea8a93          	add	s5,s5,-1346 # 64f0 <malloc+0x4b4>
    for (i = 0; i < N; i++)
    ...
    fd = open("small", O_RDONLY);
     ...
     a7c:	a1850513          	add	a0,a0,-1512 # 6490 <malloc+0x454>
    ...
    if (unlink("small") < 0)
     ...
     ab8:	9dc50513          	add	a0,a0,-1572 # 6490 <malloc+0x454>
     ...
     ae2:	9ba50513          	add	a0,a0,-1606 # 6498 <malloc+0x45c>
     ...
     b00:	9cc50513          	add	a0,a0,-1588 # 64c8 <malloc+0x48c>
     ...
     b1e:	9e650513          	add	a0,a0,-1562 # 6500 <malloc+0x4c4>
     ...
     b3a:	9f250513          	add	a0,a0,-1550 # 6528 <malloc+0x4ec>
     ...
     b56:	9f650513          	add	a0,a0,-1546 # 6548 <malloc+0x50c>
     ...
     b72:	9f250513          	add	a0,a0,-1550 # 6560 <malloc+0x524>
...
0000000000000b88 <writebig>:
{
    ...
    fd = open("big", O_CREATE | O_RDWR);
     ...
     ba4:	9e050513          	add	a0,a0,-1568 # 6580 <malloc+0x544>
    ...
    fd = open("big", O_RDONLY);
     ...
     bf6:	98e50513          	add	a0,a0,-1650 # 6580 <malloc+0x544>
    ...
    if (fd < 0)
     ...
     c3e:	94e50513          	add	a0,a0,-1714 # 6588 <malloc+0x54c>
     ...
     c5c:	95050513          	add	a0,a0,-1712 # 65a8 <malloc+0x56c>
     ...
     c78:	95c50513          	add	a0,a0,-1700 # 65d0 <malloc+0x594>
    ...
    if (unlink("big") < 0)
     ...
     ca4:	8e050513          	add	a0,a0,-1824 # 6580 <malloc+0x544>
     ...
     cd0:	92450513          	add	a0,a0,-1756 # 65f0 <malloc+0x5b4>
     ...
     cee:	92e50513          	add	a0,a0,-1746 # 6618 <malloc+0x5dc>
     ...
     d0c:	92850513          	add	a0,a0,-1752 # 6630 <malloc+0x5f4>
     ...
     d28:	93450513          	add	a0,a0,-1740 # 6658 <malloc+0x61c>
...
0000000000000d3e <unlinkread>:
{
    ...
    fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	91e50513          	add	a0,a0,-1762 # 6670 <malloc+0x634>
    ...
    write(fd, "hello", SZ);
     ...
     d6e:	93658593          	add	a1,a1,-1738 # 66a0 <malloc+0x664>
    ...
    fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ea50513          	add	a0,a0,-1814 # 6670 <malloc+0x634>
    ...
    if (unlink("unlinkread") != 0)
     ...
     da0:	8d450513          	add	a0,a0,-1836 # 6670 <malloc+0x634>
    ...
    fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	8be50513          	add	a0,a0,-1858 # 6670 <malloc+0x634>
    ...
    write(fd1, "yyy", 3);
     ...
     dca:	92258593          	add	a1,a1,-1758 # 66e8 <malloc+0x6ac>
    ...
    unlink("unlinkread");
     ...
     e32:	84250513          	add	a0,a0,-1982 # 6670 <malloc+0x634>
     ...
     e52:	83250513          	add	a0,a0,-1998 # 6680 <malloc+0x644>
     ...
     e6e:	83e50513          	add	a0,a0,-1986 # 66a8 <malloc+0x66c>
     ...
     e8a:	84250513          	add	a0,a0,-1982 # 66c8 <malloc+0x68c>
     ...
     ea6:	84e50513          	add	a0,a0,-1970 # 66f0 <malloc+0x6b4>
     ...
     ec2:	85250513          	add	a0,a0,-1966 # 6710 <malloc+0x6d4>
     ...
     ede:	85650513          	add	a0,a0,-1962 # 6730 <malloc+0x6f4>
...
0000000000000ef4 <linktest>:
{
    ...
    if (write(fd, "hello", SZ) != SZ)
     ...
     f42:	76258593          	add	a1,a1,1890 # 66a0 <malloc+0x664>
    ...
    if (link("lf1", "lf2") < 0)
     ...
     f62:	7fa58593          	add	a1,a1,2042 # 6758 <malloc+0x71c>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ea50513          	add	a0,a0,2026 # 6750 <malloc+0x714>
    ...
    unlink("lf1");
     ...
     f7e:	7d650513          	add	a0,a0,2006 # 6750 <malloc+0x714>
     f82:	00005097          	auipc	ra,0x5
     f86:	cca080e7          	jalr	-822(ra) # 5c4c <unlink>
    if (open("lf1", 0) >= 0)
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7c450513          	add	a0,a0,1988 # 6750 <malloc+0x714>
    ...
    fd = open("lf2", 0);
     ...
     fa6:	7b650513          	add	a0,a0,1974 # 6758 <malloc+0x71c>
    ...
    if (link("lf2", "lf2") >= 0)
     ...
     fde:	77e58593          	add	a1,a1,1918 # 6758 <malloc+0x71c>
     fe2:	852e                	mv	a0,a1
    ...
    unlink("lf2");
     ...
     ff4:	76850513          	add	a0,a0,1896 # 6758 <malloc+0x71c>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c54080e7          	jalr	-940(ra) # 5c4c <unlink>
    if (link("lf2", "lf1") >= 0)
    1000:	00005597          	auipc	a1,0x5
    1004:	75058593          	add	a1,a1,1872 # 6750 <malloc+0x714>
    1008:	00005517          	auipc	a0,0x5
    100c:	75050513          	add	a0,a0,1872 # 6758 <malloc+0x71c>
    ...
    1020:	73458593          	add	a1,a1,1844 # 6750 <malloc+0x714>
    1024:	00006517          	auipc	a0,0x6
    1028:	83c50513          	add	a0,a0,-1988 # 6860 <malloc+0x824>
    ...
    104a:	71a50513          	add	a0,a0,1818 # 6760 <malloc+0x724>
    ...
    1066:	71650513          	add	a0,a0,1814 # 6778 <malloc+0x73c>
    ...
    1082:	71250513          	add	a0,a0,1810 # 6790 <malloc+0x754>
    ...
    109e:	71650513          	add	a0,a0,1814 # 67b0 <malloc+0x774>
    ...
    10ba:	72a50513          	add	a0,a0,1834 # 67e0 <malloc+0x7a4>
    ...
    10d6:	72650513          	add	a0,a0,1830 # 67f8 <malloc+0x7bc>
    ...
    10f2:	72250513          	add	a0,a0,1826 # 6810 <malloc+0x7d4>
    ...
    110e:	72e50513          	add	a0,a0,1838 # 6838 <malloc+0x7fc>
    ...
    112a:	74250513          	add	a0,a0,1858 # 6868 <malloc+0x82c>
...
0000000000001140 <validatetest>:
{
    ...
    115c:	73098993          	add	s3,s3,1840 # 6888 <malloc+0x84c>
    1160:	597d                	li	s2,-1
    for (p = 0; p <= (uint)hi; p += PGSIZE)
    ...
    1198:	70450513          	add	a0,a0,1796 # 6898 <malloc+0x85c>
...
00000000000011ae <bigdir>:
{
    ...
    11fe:	6bea0a13          	add	s4,s4,1726 # 68b8 <malloc+0x87c>
    for (i = 0; i < N; i++)
    ...
    1250:	66c50513          	add	a0,a0,1644 # 68b8 <malloc+0x87c>
    ...
    12c0:	60450513          	add	a0,a0,1540 # 68c0 <malloc+0x884>
    ...
    12e0:	60450513          	add	a0,a0,1540 # 68e0 <malloc+0x8a4>
    ...
    12fc:	60850513          	add	a0,a0,1544 # 6900 <malloc+0x8c4>
...
000000000000134a <badarg>:
{
    ...
    1368:	e1498993          	add	s3,s3,-492 # 6178 <malloc+0x13c>
        argv[0] = (char *)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
    ...
    13f2:	76a78793          	add	a5,a5,1898 # 7b58 <malloc+0x1b1c>
    ...
    144e:	15678793          	add	a5,a5,342 # 85a0 <malloc+0x2564>
    ...
    1472:	d0a50513          	add	a0,a0,-758 # 6178 <malloc+0x13c>
    ...
    148a:	52250513          	add	a0,a0,1314 # 69a8 <malloc+0x96c>
    ...
    14aa:	47a50513          	add	a0,a0,1146 # 6920 <malloc+0x8e4>
    ...
    14ca:	47a50513          	add	a0,a0,1146 # 6940 <malloc+0x904>
    ...
    14ec:	47850513          	add	a0,a0,1144 # 6960 <malloc+0x924>
    ...
    150c:	48050513          	add	a0,a0,1152 # 6988 <malloc+0x94c>
    ...
    1526:	8e650513          	add	a0,a0,-1818 # 6e08 <malloc+0xdcc>
    ...
    1570:	46450513          	add	a0,a0,1124 # 69d0 <malloc+0x994>
...
0000000000001586 <truncate3>:
{
    ...
    159a:	c3a50513          	add	a0,a0,-966 # 61d0 <malloc+0x194>
    ...
    15cc:	c08a0a13          	add	s4,s4,-1016 # 61d0 <malloc+0x194>
            int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	460a8a93          	add	s5,s5,1120 # 6a30 <malloc+0x9f4>
            int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    164c:	3b850513          	add	a0,a0,952 # 6a00 <malloc+0x9c4>
    ...
    1668:	3b450513          	add	a0,a0,948 # 6a18 <malloc+0x9dc>
    ...
    1686:	3be50513          	add	a0,a0,958 # 6a40 <malloc+0xa04>
    ...
    16ac:	b28a0a13          	add	s4,s4,-1240 # 61d0 <malloc+0x194>
        int n = write(fd, "xxx", 3);
    16b0:	00005a97          	auipc	s5,0x5
    16b4:	3b0a8a93          	add	s5,s5,944 # 6a60 <malloc+0xa24>
        int fd = open("truncfile", O_CREATE | O_WRONLY | O_TRUNC);
    ...
    16fe:	ad650513          	add	a0,a0,-1322 # 61d0 <malloc+0x194>
    ...
    171c:	30050513          	add	a0,a0,768 # 6a18 <malloc+0x9dc>
    ...
    173a:	33250513          	add	a0,a0,818 # 6a68 <malloc+0xa2c>
...
0000000000001750 <exectest>:
{
    ...
    1760:	a1c78793          	add	a5,a5,-1508 # 6178 <malloc+0x13c>
    1764:	fcf43023          	sd	a5,-64(s0)
    1768:	00005797          	auipc	a5,0x5
    176c:	32078793          	add	a5,a5,800 # 6a88 <malloc+0xa4c>
    1770:	fcf43423          	sd	a5,-56(s0)
    1774:	fc043823          	sd	zero,-48(s0)
    unlink("echo-ok");
    1778:	00005517          	auipc	a0,0x5
    177c:	31850513          	add	a0,a0,792 # 6a90 <malloc+0xa54>
    ...
    17ac:	2e850513          	add	a0,a0,744 # 6a90 <malloc+0xa54>
    ...
    17c8:	2ec50513          	add	a0,a0,748 # 6ab0 <malloc+0xa74>
    ...
    17e6:	21e50513          	add	a0,a0,542 # 6a00 <malloc+0x9c4>
    ...
    1802:	29a50513          	add	a0,a0,666 # 6a98 <malloc+0xa5c>
    ...
    1820:	95c50513          	add	a0,a0,-1700 # 6178 <malloc+0x13c>
    ...
    1854:	27050513          	add	a0,a0,624 # 6ac0 <malloc+0xa84>
    ...
    1870:	26c50513          	add	a0,a0,620 # 6ad8 <malloc+0xa9c>
    ...
    1884:	21050513          	add	a0,a0,528 # 6a90 <malloc+0xa54>
    ...
    18ae:	c9e50513          	add	a0,a0,-866 # 6548 <malloc+0x50c>
    ...
    18ca:	15250513          	add	a0,a0,338 # 6a18 <malloc+0x9dc>
    ...
    18e4:	1b050513          	add	a0,a0,432 # 6a90 <malloc+0xa54>
    ...
    190e:	1e650513          	add	a0,a0,486 # 6af0 <malloc+0xab4>
...
000000000000192e <pipe1>:
{
    ...
    19d6:	13650513          	add	a0,a0,310 # 6b08 <malloc+0xacc>
    ...
    1a18:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a64:	0c050513          	add	a0,a0,192 # 6b20 <malloc+0xae4>
    ...
    1a80:	0bc50513          	add	a0,a0,188 # 6b38 <malloc+0xafc>
    ...
    1ab2:	0a250513          	add	a0,a0,162 # 6b50 <malloc+0xb14>
    ...
    1afe:	07650513          	add	a0,a0,118 # 6b70 <malloc+0xb34>
...
0000000000001b14 <exitwait>:
{
    ...
    1b70:	e9450513          	add	a0,a0,-364 # 6a00 <malloc+0x9c4>
    ...
    1ba8:	ffc50513          	add	a0,a0,-4 # 6ba0 <malloc+0xb64>
...
0000000000001bc8 <twochildren>:
{
    ...
    1c20:	de450513          	add	a0,a0,-540 # 6a00 <malloc+0x9c4>
    ...
    1c44:	dc050513          	add	a0,a0,-576 # 6a00 <malloc+0x9c4>
...
0000000000001c62 <forkfork>:
{
    ...
    1cbe:	f0650513          	add	a0,a0,-250 # 6bc0 <malloc+0xb84>
    ...
    1cd0:	f30080e7          	jalr	-208(ra) # 5bfc <exit>
{
    ...
    1d16:	ebe50513          	add	a0,a0,-322 # 6bd0 <malloc+0xb94>
...
0000000000001d2c <reparent2>:
{
    ...
    1d64:	0a850513          	add	a0,a0,168 # 6e08 <malloc+0xdcc>
...
0000000000001d94 <createdelete>:
{
    ...
    1e02:	00a50513          	add	a0,a0,10 # 6e08 <malloc+0xdcc>
    ...
    1e2e:	c6e50513          	add	a0,a0,-914 # 6a98 <malloc+0xa5c>
    ...
    1ea0:	d5450513          	add	a0,a0,-684 # 6bf0 <malloc+0xbb4>
    ...
    1ed4:	d3850513          	add	a0,a0,-712 # 6c08 <malloc+0xbcc>
    ...
    1f36:	cfe50513          	add	a0,a0,-770 # 6c30 <malloc+0xbf4>
...
0000000000001fba <linkunlink>:
{
    ...
    1fda:	21250513          	add	a0,a0,530 # 61e8 <malloc+0x1ac>
    ...
    2016:	1d6b0b13          	add	s6,s6,470 # 61e8 <malloc+0x1ac>
            link("cat", "x");
    201a:	00005c17          	auipc	s8,0x5
    201e:	c3ec0c13          	add	s8,s8,-962 # 6c58 <malloc+0xc1c>
    2022:	a825                	j	205a <linkunlink+0xa0>
        printf("%s: fork failed\n", s);
    2024:	85a6                	mv	a1,s1
    2026:	00005517          	auipc	a0,0x5
    202a:	9da50513          	add	a0,a0,-1574 # 6a00 <malloc+0x9c4>
...
00000000000020be <forktest>:
{
    ...
    20ee:	bbe50513          	add	a0,a0,-1090 # 6ca8 <malloc+0xc6c>
    ...
    2112:	b5250513          	add	a0,a0,-1198 # 6c60 <malloc+0xc24>
    ...
    212e:	b4e50513          	add	a0,a0,-1202 # 6c78 <malloc+0xc3c>
    ...
    214a:	b4a50513          	add	a0,a0,-1206 # 6c90 <malloc+0xc54>
...
0000000000002196 <kernmem>:
{
    ...
    2200:	80450513          	add	a0,a0,-2044 # 6a00 <malloc+0x9c4>
    ...
    2222:	ab250513          	add	a0,a0,-1358 # 6cd0 <malloc+0xc94>
...
0000000000002242 <MAXVAplus>:
{
    ...
    22a4:	76050513          	add	a0,a0,1888 # 6a00 <malloc+0x9c4>
    ...
    22d0:	a2450513          	add	a0,a0,-1500 # 6cf0 <malloc+0xcb4>
...
00000000000022f0 <bigargtest>:
{
    ...
    2300:	a0c50513          	add	a0,a0,-1524 # 6d08 <malloc+0xccc>
    ...
    2332:	9da50513          	add	a0,a0,-1574 # 6d08 <malloc+0xccc>
    ...
    2368:	9b470713          	add	a4,a4,-1612 # 6d18 <malloc+0xcdc>
    ...
    23bc:	a4050513          	add	a0,a0,-1472 # 6df8 <malloc+0xdbc>
    ...
    23e0:	a3c50513          	add	a0,a0,-1476 # 6e18 <malloc+0xddc>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    243e:	9fe50513          	add	a0,a0,-1538 # 6e38 <malloc+0xdfc>
    ...
    245a:	5aa50513          	add	a0,a0,1450 # 6a00 <malloc+0x9c4>
...
000000000000247a <textwrite>:
{
    ...
    24c8:	53c50513          	add	a0,a0,1340 # 6a00 <malloc+0x9c4>
...
00000000000024e8 <manywrites>:
{
    ...
    254c:	8c050513          	add	a0,a0,-1856 # 6e08 <malloc+0xdcc>
    ...
    2602:	86250513          	add	a0,a0,-1950 # 6e60 <malloc+0xe24>
    ...
    2622:	c2a50513          	add	a0,a0,-982 # 6248 <malloc+0x20c>
...
0000000000002640 <copyinstr3>:
{
    ...
    *b = 'x';
    ...
    26ba:	4a278793          	add	a5,a5,1186 # 7b58 <malloc+0x1b1c>
    ...
    26fc:	78050513          	add	a0,a0,1920 # 6e78 <malloc+0xe3c>
    ...
    271a:	20a50513          	add	a0,a0,522 # 6920 <malloc+0x8e4>
    ...
    2738:	20c50513          	add	a0,a0,524 # 6940 <malloc+0x904>
    ...
    2758:	20c50513          	add	a0,a0,524 # 6960 <malloc+0x924>
    ...
    2776:	21650513          	add	a0,a0,534 # 6988 <malloc+0x94c>
...
000000000000278c <rwsbrk>:
{
    ...
    27c2:	6fa50513          	add	a0,a0,1786 # 6eb8 <malloc+0xe7c>
    ...
    27f2:	6ea50513          	add	a0,a0,1770 # 6ed8 <malloc+0xe9c>
    ...
    2810:	67450513          	add	a0,a0,1652 # 6e80 <malloc+0xe44>
    ...
    282c:	67050513          	add	a0,a0,1648 # 6e98 <malloc+0xe5c>
    ...
    2846:	67e50513          	add	a0,a0,1662 # 6ec0 <malloc+0xe84>
    ...
    28a6:	66650513          	add	a0,a0,1638 # 6f08 <malloc+0xecc>
    ...
    28c0:	60450513          	add	a0,a0,1540 # 6ec0 <malloc+0xe84>
...
00000000000028ea <sbrkbasic>:
{
    ...
    2946:	5ee50513          	add	a0,a0,1518 # 6f30 <malloc+0xef4>
    ...
    29aa:	5aa50513          	add	a0,a0,1450 # 6f50 <malloc+0xf14>
    ...
    2a0e:	5a650513          	add	a0,a0,1446 # 6fb0 <malloc+0xf74>
    ...
    2a30:	54450513          	add	a0,a0,1348 # 6f70 <malloc+0xf34>
    ...
    2a4c:	54850513          	add	a0,a0,1352 # 6f90 <malloc+0xf54>
...
0000000000002a88 <sbrkmuch>:
{
    ...
    *lastaddr = 99;
    ...
    2b96:	43e50513          	add	a0,a0,1086 # 6fd0 <malloc+0xf94>
    ...
    2bb2:	46a50513          	add	a0,a0,1130 # 7018 <malloc+0xfdc>
    ...
    2bd2:	46a50513          	add	a0,a0,1130 # 7038 <malloc+0xffc>
    ...
    2bf2:	48a50513          	add	a0,a0,1162 # 7078 <malloc+0x103c>
    ...
    2c0e:	49e50513          	add	a0,a0,1182 # 70a8 <malloc+0x106c>
    ...
    2c2e:	4b650513          	add	a0,a0,1206 # 70e0 <malloc+0x10a4>
...
0000000000002c44 <sbrkarg>:
{
    ...
    2c68:	4a450513          	add	a0,a0,1188 # 7108 <malloc+0x10cc>
    2c6c:	00003097          	auipc	ra,0x3
    2c70:	fd0080e7          	jalr	-48(ra) # 5c3c <open>
    2c74:	84aa                	mv	s1,a0
    unlink("sbrk");
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	49250513          	add	a0,a0,1170 # 7108 <malloc+0x10cc>
    ...
    2cce:	44650513          	add	a0,a0,1094 # 7110 <malloc+0x10d4>
    ...
    2cea:	44250513          	add	a0,a0,1090 # 7128 <malloc+0x10ec>
    ...
    2d06:	e0650513          	add	a0,a0,-506 # 6b08 <malloc+0xacc>
...
0000000000002d1c <argptest>:
{
    ...
    2d30:	41450513          	add	a0,a0,1044 # 7140 <malloc+0x1104>
    ...
    2d78:	ca450513          	add	a0,a0,-860 # 6a18 <malloc+0x9dc>
...
0000000000002d8e <sbrkbugs>:
{
    ...
    2dc6:	04650513          	add	a0,a0,70 # 6e08 <malloc+0xdcc>
    ...
    2e1c:	ff050513          	add	a0,a0,-16 # 6e08 <malloc+0xdcc>
    ...
    2e7c:	f9050513          	add	a0,a0,-112 # 6e08 <malloc+0xdcc>
...
0000000000002fae <execout>:
{
    ...
    2ff0:	e1c50513          	add	a0,a0,-484 # 6e08 <malloc+0xdcc>
    ...
    3044:	13850513          	add	a0,a0,312 # 6178 <malloc+0x13c>
    3048:	faa43c23          	sd	a0,-72(s0)
    304c:	00003797          	auipc	a5,0x3
    3050:	19c78793          	add	a5,a5,412 # 61e8 <malloc+0x1ac>
...
0000000000003072 <fourteen>:
{
    ...
    3082:	29a50513          	add	a0,a0,666 # 7318 <malloc+0x12dc>
    ...
    3094:	0e050513          	add	a0,a0,224 # 7170 <malloc+0x1134>
    ...
    30aa:	12250513          	add	a0,a0,290 # 71c8 <malloc+0x118c>
    ...
    30c8:	17c50513          	add	a0,a0,380 # 7240 <malloc+0x1204>
    ...
    30e4:	1d050513          	add	a0,a0,464 # 72b0 <malloc+0x1274>
    ...
    30f6:	21650513          	add	a0,a0,534 # 7308 <malloc+0x12cc>
    ...
    3174:	fd850513          	add	a0,a0,-40 # 7148 <malloc+0x110c>
    ...
    3190:	00450513          	add	a0,a0,4 # 7190 <malloc+0x1154>
    ...
    31ac:	05050513          	add	a0,a0,80 # 71f8 <malloc+0x11bc>
    ...
    31c8:	0ac50513          	add	a0,a0,172 # 7270 <malloc+0x1234>
    ...
    31e4:	0f050513          	add	a0,a0,240 # 72d0 <malloc+0x1294>
    ...
    3200:	12c50513          	add	a0,a0,300 # 7328 <malloc+0x12ec>
...
0000000000003216 <diskfull>:
{
    ...
    324c:	11850513          	add	a0,a0,280 # 7360 <malloc+0x1324>
    ...
    3276:	0fe50513          	add	a0,a0,254 # 7370 <malloc+0x1334>
    ...
    3306:	05e50513          	add	a0,a0,94 # 7360 <malloc+0x1324>
    ...
    331a:	04a50513          	add	a0,a0,74 # 7360 <malloc+0x1324>
    ...
    3448:	f4c50513          	add	a0,a0,-180 # 7390 <malloc+0x1354>
...
0000000000003456 <iputtest>:
{
    ...
    3466:	f5e50513          	add	a0,a0,-162 # 73c0 <malloc+0x1384>
    ...
    347a:	f4a50513          	add	a0,a0,-182 # 73c0 <malloc+0x1384>
    ...
    348e:	f7650513          	add	a0,a0,-138 # 7400 <malloc+0x13c4>
    ...
    34a2:	f9250513          	add	a0,a0,-110 # 7430 <malloc+0x13f4>
    ...
    34c2:	f0a50513          	add	a0,a0,-246 # 73c8 <malloc+0x138c>
    ...
    34de:	f0650513          	add	a0,a0,-250 # 73e0 <malloc+0x13a4>
    ...
    34fa:	f1a50513          	add	a0,a0,-230 # 7410 <malloc+0x13d4>
    ...
    3516:	f2650513          	add	a0,a0,-218 # 7438 <malloc+0x13fc>
...
000000000000352c <exitiputtest>:
{
    ...
    354a:	e7a50513          	add	a0,a0,-390 # 73c0 <malloc+0x1384>
    ...
    355e:	e6650513          	add	a0,a0,-410 # 73c0 <malloc+0x1384>
    ...
    3572:	e9250513          	add	a0,a0,-366 # 7400 <malloc+0x13c4>
    ...
    3592:	47250513          	add	a0,a0,1138 # 6a00 <malloc+0x9c4>
    ...
    35ae:	e1e50513          	add	a0,a0,-482 # 73c8 <malloc+0x138c>
    ...
    35ca:	e8a50513          	add	a0,a0,-374 # 7450 <malloc+0x1414>
    ...
    35e6:	e2e50513          	add	a0,a0,-466 # 7410 <malloc+0x13d4>
...
0000000000003614 <dirtest>:
{
    ...
    3624:	e4850513          	add	a0,a0,-440 # 7468 <malloc+0x142c>
    ...
    3638:	e3450513          	add	a0,a0,-460 # 7468 <malloc+0x142c>
    ...
    364c:	e4050513          	add	a0,a0,-448 # 7488 <malloc+0x144c>
    ...
    3660:	e0c50513          	add	a0,a0,-500 # 7468 <malloc+0x142c>
    ...
    3680:	d4c50513          	add	a0,a0,-692 # 73c8 <malloc+0x138c>
    ...
    369c:	dd850513          	add	a0,a0,-552 # 7470 <malloc+0x1434>
    ...
    36b8:	ddc50513          	add	a0,a0,-548 # 7490 <malloc+0x1454>
    ...
    36d4:	dd850513          	add	a0,a0,-552 # 74a8 <malloc+0x146c>
...
00000000000036ea <subdir>:
{
    ...
    36fc:	ef850513          	add	a0,a0,-264 # 75f0 <malloc+0x15b4>
    3700:	00002097          	auipc	ra,0x2
    3704:	54c080e7          	jalr	1356(ra) # 5c4c <unlink>
    if (mkdir("dd") != 0)
    3708:	00004517          	auipc	a0,0x4
    370c:	db850513          	add	a0,a0,-584 # 74c0 <malloc+0x1484>
    ...
    3724:	dc050513          	add	a0,a0,-576 # 74e0 <malloc+0x14a4>
    ...
    373c:	eb858593          	add	a1,a1,-328 # 75f0 <malloc+0x15b4>
    ...
    3756:	d6e50513          	add	a0,a0,-658 # 74c0 <malloc+0x1484>
    ...
    376a:	dd250513          	add	a0,a0,-558 # 7538 <malloc+0x14fc>
    ...
    3782:	de250513          	add	a0,a0,-542 # 7560 <malloc+0x1524>
    ...
    379a:	dfa58593          	add	a1,a1,-518 # 7590 <malloc+0x1554>
    ...
    37b6:	de650513          	add	a0,a0,-538 # 7598 <malloc+0x155c>
    ...
    37fe:	dee58593          	add	a1,a1,-530 # 75e8 <malloc+0x15ac>
    3802:	00004517          	auipc	a0,0x4
    3806:	d5e50513          	add	a0,a0,-674 # 7560 <malloc+0x1524>
    ...
    381a:	d4a50513          	add	a0,a0,-694 # 7560 <malloc+0x1524>
    ...
    3830:	d3450513          	add	a0,a0,-716 # 7560 <malloc+0x1524>
    ...
    3844:	c8050513          	add	a0,a0,-896 # 74c0 <malloc+0x1484>
    ...
    3858:	e2c50513          	add	a0,a0,-468 # 7680 <malloc+0x1644>
    ...
    386c:	e4850513          	add	a0,a0,-440 # 76b0 <malloc+0x1674>
    ...
    3880:	e6450513          	add	a0,a0,-412 # 76e0 <malloc+0x16a4>
    ...
    3896:	d5650513          	add	a0,a0,-682 # 75e8 <malloc+0x15ac>
    ...
    38d0:	c9450513          	add	a0,a0,-876 # 7560 <malloc+0x1524>
    ...
    38e8:	e8c50513          	add	a0,a0,-372 # 7770 <malloc+0x1734>
    ...
    3900:	ea450513          	add	a0,a0,-348 # 77a0 <malloc+0x1764>
    ...
    3918:	bac50513          	add	a0,a0,-1108 # 74c0 <malloc+0x1484>
    ...
    392e:	b9650513          	add	a0,a0,-1130 # 74c0 <malloc+0x1484>
    ...
    3944:	b8050513          	add	a0,a0,-1152 # 74c0 <malloc+0x1484>
    ...
    3958:	edc58593          	add	a1,a1,-292 # 7830 <malloc+0x17f4>
    395c:	00004517          	auipc	a0,0x4
    3960:	e1450513          	add	a0,a0,-492 # 7770 <malloc+0x1734>
    ...
    3974:	ec058593          	add	a1,a1,-320 # 7830 <malloc+0x17f4>
    3978:	00004517          	auipc	a0,0x4
    397c:	e2850513          	add	a0,a0,-472 # 77a0 <malloc+0x1764>
    ...
    3990:	c5c58593          	add	a1,a1,-932 # 75e8 <malloc+0x15ac>
    3994:	00004517          	auipc	a0,0x4
    3998:	b4c50513          	add	a0,a0,-1204 # 74e0 <malloc+0x14a4>
    ...
    39ac:	dc850513          	add	a0,a0,-568 # 7770 <malloc+0x1734>
    ...
    39c0:	de450513          	add	a0,a0,-540 # 77a0 <malloc+0x1764>
    ...
    39d4:	c1850513          	add	a0,a0,-1000 # 75e8 <malloc+0x15ac>
    ...
    39e8:	dbc50513          	add	a0,a0,-580 # 77a0 <malloc+0x1764>
    ...
    39fc:	d7850513          	add	a0,a0,-648 # 7770 <malloc+0x1734>
    ...
    3a10:	ad450513          	add	a0,a0,-1324 # 74e0 <malloc+0x14a4>
    ...
    3a24:	f6050513          	add	a0,a0,-160 # 7980 <malloc+0x1944>
    ...
    3a38:	bb450513          	add	a0,a0,-1100 # 75e8 <malloc+0x15ac>
    ...
    3a4c:	a9850513          	add	a0,a0,-1384 # 74e0 <malloc+0x14a4>
    ...
    3a60:	a6450513          	add	a0,a0,-1436 # 74c0 <malloc+0x1484>
    ...
    3a74:	f8050513          	add	a0,a0,-128 # 79f0 <malloc+0x19b4>
    ...
    3a88:	a3c50513          	add	a0,a0,-1476 # 74c0 <malloc+0x1484>
    ...
    3aaa:	a2250513          	add	a0,a0,-1502 # 74c8 <malloc+0x148c>
    ...
    3ac6:	a2650513          	add	a0,a0,-1498 # 74e8 <malloc+0x14ac>
    ...
    3ae2:	a2a50513          	add	a0,a0,-1494 # 7508 <malloc+0x14cc>
    ...
    3afe:	a4650513          	add	a0,a0,-1466 # 7540 <malloc+0x1504>
    ...
    3b1a:	a5a50513          	add	a0,a0,-1446 # 7570 <malloc+0x1534>
    ...
    3b36:	a7650513          	add	a0,a0,-1418 # 75a8 <malloc+0x156c>
    ...
    3b52:	a7a50513          	add	a0,a0,-1414 # 75c8 <malloc+0x158c>
    ...
    3b6e:	a8e50513          	add	a0,a0,-1394 # 75f8 <malloc+0x15bc>
    ...
    3b8a:	a9a50513          	add	a0,a0,-1382 # 7620 <malloc+0x15e4>
    ...
    3ba6:	a9e50513          	add	a0,a0,-1378 # 7640 <malloc+0x1604>
    ...
    3bc2:	aaa50513          	add	a0,a0,-1366 # 7668 <malloc+0x162c>
    ...
    3bde:	ab650513          	add	a0,a0,-1354 # 7690 <malloc+0x1654>
    ...
    3bfa:	aca50513          	add	a0,a0,-1334 # 76c0 <malloc+0x1684>
    ...
    3c16:	ad650513          	add	a0,a0,-1322 # 76e8 <malloc+0x16ac>
    ...
    3c32:	ad250513          	add	a0,a0,-1326 # 7700 <malloc+0x16c4>
    ...
    3c4e:	ad650513          	add	a0,a0,-1322 # 7720 <malloc+0x16e4>
    ...
    3c6a:	ada50513          	add	a0,a0,-1318 # 7740 <malloc+0x1704>
    ...
    3c86:	afe50513          	add	a0,a0,-1282 # 7780 <malloc+0x1744>
    ...
    3ca2:	b1250513          	add	a0,a0,-1262 # 77b0 <malloc+0x1774>
    ...
    3cbe:	b1650513          	add	a0,a0,-1258 # 77d0 <malloc+0x1794>
    ...
    3cda:	b1a50513          	add	a0,a0,-1254 # 77f0 <malloc+0x17b4>
    ...
    3cf6:	b1e50513          	add	a0,a0,-1250 # 7810 <malloc+0x17d4>
    ...
    3d12:	b3250513          	add	a0,a0,-1230 # 7840 <malloc+0x1804>
    ...
    3d2e:	b3e50513          	add	a0,a0,-1218 # 7868 <malloc+0x182c>
    ...
    3d4a:	b4a50513          	add	a0,a0,-1206 # 7890 <malloc+0x1854>
    ...
    3d66:	b5650513          	add	a0,a0,-1194 # 78b8 <malloc+0x187c>
    ...
    3d82:	b5a50513          	add	a0,a0,-1190 # 78d8 <malloc+0x189c>
    ...
    3d9e:	b5e50513          	add	a0,a0,-1186 # 78f8 <malloc+0x18bc>
    ...
    3dba:	b6a50513          	add	a0,a0,-1174 # 7920 <malloc+0x18e4>
    ...
    3dd6:	b6e50513          	add	a0,a0,-1170 # 7940 <malloc+0x1904>
    ...
    3df2:	b7250513          	add	a0,a0,-1166 # 7960 <malloc+0x1924>
    ...
    3e0e:	b7e50513          	add	a0,a0,-1154 # 7988 <malloc+0x194c>
    ...
    3e2a:	7fa50513          	add	a0,a0,2042 # 7620 <malloc+0x15e4>
    ...
    3e46:	b6650513          	add	a0,a0,-1178 # 79a8 <malloc+0x196c>
    ...
    3e62:	b6a50513          	add	a0,a0,-1174 # 79c8 <malloc+0x198c>
    ...
    3e7e:	b7e50513          	add	a0,a0,-1154 # 79f8 <malloc+0x19bc>
    ...
    3e9a:	b8250513          	add	a0,a0,-1150 # 7a18 <malloc+0x19dc>
...
0000000000003eb0 <rmdot>:
{
    ...
    3ec0:	b7450513          	add	a0,a0,-1164 # 7a30 <malloc+0x19f4>
    ...
    3ed2:	b6250513          	add	a0,a0,-1182 # 7a30 <malloc+0x19f4>
    ...
    3ee4:	98050513          	add	a0,a0,-1664 # 6860 <malloc+0x824>
    ...
    3ef6:	59650513          	add	a0,a0,1430 # 7488 <malloc+0x144c>
    ...
    3f08:	52c50513          	add	a0,a0,1324 # 7430 <malloc+0x13f4>
    ...
    3f1a:	b8250513          	add	a0,a0,-1150 # 7a98 <malloc+0x1a5c>
    ...
    3f2c:	b9850513          	add	a0,a0,-1128 # 7ac0 <malloc+0x1a84>
    ...
    3f3e:	af650513          	add	a0,a0,-1290 # 7a30 <malloc+0x19f4>
    ...
    3f5c:	ae050513          	add	a0,a0,-1312 # 7a38 <malloc+0x19fc>
    ...
    3f78:	adc50513          	add	a0,a0,-1316 # 7a50 <malloc+0x1a14>
    ...
    3f94:	ad850513          	add	a0,a0,-1320 # 7a68 <malloc+0x1a2c>
    ...
    3fb0:	ad450513          	add	a0,a0,-1324 # 7a80 <malloc+0x1a44>
    ...
    3fcc:	47050513          	add	a0,a0,1136 # 7438 <malloc+0x13fc>
    ...
    3fe8:	abc50513          	add	a0,a0,-1348 # 7aa0 <malloc+0x1a64>
    ...
    4004:	ac850513          	add	a0,a0,-1336 # 7ac8 <malloc+0x1a8c>
    ...
    4020:	acc50513          	add	a0,a0,-1332 # 7ae8 <malloc+0x1aac>
...
0000000000004036 <dirfile>:
{
    ...
    404c:	ac050513          	add	a0,a0,-1344 # 7b08 <malloc+0x1acc>
    ...
    4068:	aa450513          	add	a0,a0,-1372 # 7b08 <malloc+0x1acc>
    ...
    407c:	ad850513          	add	a0,a0,-1320 # 7b50 <malloc+0x1b14>
    ...
    4094:	ac050513          	add	a0,a0,-1344 # 7b50 <malloc+0x1b14>
    ...
    40a8:	aac50513          	add	a0,a0,-1364 # 7b50 <malloc+0x1b14>
    ...
    40bc:	a9850513          	add	a0,a0,-1384 # 7b50 <malloc+0x1b14>
    ...
    40d0:	a8458593          	add	a1,a1,-1404 # 7b50 <malloc+0x1b14>
    40d4:	00002517          	auipc	a0,0x2
    40d8:	27c50513          	add	a0,a0,636 # 6350 <malloc+0x314>
    ...
    40ec:	a2050513          	add	a0,a0,-1504 # 7b08 <malloc+0x1acc>
    ...
    4102:	76250513          	add	a0,a0,1890 # 6860 <malloc+0x824>
    ...
    4118:	74c50513          	add	a0,a0,1868 # 6860 <malloc+0x824>
    ...
    412c:	0c058593          	add	a1,a1,192 # 61e8 <malloc+0x1ac>
    ...
    4158:	9bc50513          	add	a0,a0,-1604 # 7b10 <malloc+0x1ad4>
    ...
    4174:	9c050513          	add	a0,a0,-1600 # 7b30 <malloc+0x1af4>
    ...
    4190:	9d450513          	add	a0,a0,-1580 # 7b60 <malloc+0x1b24>
    ...
    41ac:	9b850513          	add	a0,a0,-1608 # 7b60 <malloc+0x1b24>
    ...
    41c8:	9c450513          	add	a0,a0,-1596 # 7b88 <malloc+0x1b4c>
    ...
    41e4:	9d050513          	add	a0,a0,-1584 # 7bb0 <malloc+0x1b74>
    ...
    4200:	9dc50513          	add	a0,a0,-1572 # 7bd8 <malloc+0x1b9c>
    ...
    421c:	9e850513          	add	a0,a0,-1560 # 7c00 <malloc+0x1bc4>
    ...
    4238:	9ec50513          	add	a0,a0,-1556 # 7c20 <malloc+0x1be4>
    ...
    4254:	9f850513          	add	a0,a0,-1544 # 7c48 <malloc+0x1c0c>
...
000000000000426a <iref>:
{
    ...
    4288:	9dca0a13          	add	s4,s4,-1572 # 7c60 <malloc+0x1c24>
        mkdir("");
    428c:	00003497          	auipc	s1,0x3
    4290:	4dc48493          	add	s1,s1,1244 # 7768 <malloc+0x172c>
        link("README", "");
    4294:	00002a97          	auipc	s5,0x2
    4298:	0bca8a93          	add	s5,s5,188 # 6350 <malloc+0x314>
        fd = open("xx", O_CREATE);
    429c:	00004997          	auipc	s3,0x4
    42a0:	8bc98993          	add	s3,s3,-1860 # 7b58 <malloc+0x1b1c>
    42a4:	a891                	j	42f8 <iref+0x8e>
            printf("%s: mkdir irefd failed\n", s);
    42a6:	85da                	mv	a1,s6
    42a8:	00004517          	auipc	a0,0x4
    42ac:	9c050513          	add	a0,a0,-1600 # 7c68 <malloc+0x1c2c>
    ...
    42c8:	9bc50513          	add	a0,a0,-1604 # 7c80 <malloc+0x1c44>
    ...
    435c:	13098993          	add	s3,s3,304 # 7488 <malloc+0x144c>
        unlink("irefd");
    4360:	00004917          	auipc	s2,0x4
    4364:	90090913          	add	s2,s2,-1792 # 7c60 <malloc+0x1c24>
        chdir("..");
    4368:	854e                	mv	a0,s3
    ...
    4384:	0b050513          	add	a0,a0,176 # 7430 <malloc+0x13f4>
...
00000000000043a4 <openiputtest>:
{
    ...
    43b4:	8e850513          	add	a0,a0,-1816 # 7c98 <malloc+0x1c5c>
    ...
    43d8:	8c450513          	add	a0,a0,-1852 # 7c98 <malloc+0x1c5c>
    ...
    43ee:	8ce50513          	add	a0,a0,-1842 # 7cb8 <malloc+0x1c7c>
    ...
    440a:	89a50513          	add	a0,a0,-1894 # 7ca0 <malloc+0x1c64>
    ...
    4426:	5de50513          	add	a0,a0,1502 # 6a00 <malloc+0x9c4>
    ...
    4454:	84850513          	add	a0,a0,-1976 # 7c98 <malloc+0x1c5c>
    ...
    4468:	78c50513          	add	a0,a0,1932 # 6bf0 <malloc+0xbb4>
...
0000000000004496 <forkforkfork>:
{
    ...
    44a6:	83e50513          	add	a0,a0,-1986 # 7ce0 <malloc+0x1ca4>
    ...
    44d2:	81250513          	add	a0,a0,-2030 # 7ce0 <malloc+0x1ca4>
    ...
    450a:	6ba50513          	add	a0,a0,1722 # 6bc0 <malloc+0xb84>
    ...
    4524:	7c048493          	add	s1,s1,1984 # 7ce0 <malloc+0x1ca4>
    4528:	4581                	li	a1,0
    452a:	8526                	mv	a0,s1
    ...
    454c:	79850513          	add	a0,a0,1944 # 7ce0 <malloc+0x1ca4>
...
000000000000456c <killstatus>:
{
    ...
    45d2:	43250513          	add	a0,a0,1074 # 6a00 <malloc+0x9c4>
    ...
    45f8:	6fc50513          	add	a0,a0,1788 # 7cf0 <malloc+0x1cb4>
...
000000000000460e <preempt>:
{
    ...
    4638:	58c50513          	add	a0,a0,1420 # 6bc0 <malloc+0xb84>
    ...
    4666:	39e50513          	add	a0,a0,926 # 6a00 <malloc+0x9c4>
    ...
    46aa:	b4258593          	add	a1,a1,-1214 # 61e8 <malloc+0x1ac>
    ...
    46d4:	33050513          	add	a0,a0,816 # 6a00 <malloc+0x9c4>
    ...
    46f0:	62450513          	add	a0,a0,1572 # 7d10 <malloc+0x1cd4>
    ...
    472c:	60050513          	add	a0,a0,1536 # 7d28 <malloc+0x1cec>
    ...
    4758:	5ec50513          	add	a0,a0,1516 # 7d40 <malloc+0x1d04>
    ...
    4786:	5ce50513          	add	a0,a0,1486 # 7d50 <malloc+0x1d14>
...
00000000000047b2 <reparent>:
{
    ...
    4806:	1fe50513          	add	a0,a0,510 # 6a00 <malloc+0x9c4>
    ...
    4822:	36a50513          	add	a0,a0,874 # 6b88 <malloc+0xb4c>
...
0000000000004862 <sbrkfail>:
{
    ...
    4898:	27450513          	add	a0,a0,628 # 6b08 <malloc+0xacc>
    ...
    48cc:	92058593          	add	a1,a1,-1760 # 61e8 <malloc+0x1ac>
    ...
    4990:	3d450513          	add	a0,a0,980 # 7d60 <malloc+0x1d24>
    ...
    49ac:	05850513          	add	a0,a0,88 # 6a00 <malloc+0x9c4>
    ...
    49f8:	38c50513          	add	a0,a0,908 # 7d80 <malloc+0x1d44>
...
0000000000004a18 <mem>:
{
    ...
    4a9c:	31850513          	add	a0,a0,792 # 7db0 <malloc+0x1d74>
...
0000000000004abc <sharedfd>:
{
    ...
    4b5e:	28650513          	add	a0,a0,646 # 7de0 <malloc+0x1da4>
    ...
    4b7a:	29250513          	add	a0,a0,658 # 7e08 <malloc+0x1dcc>
    ...
    4bbe:	21650513          	add	a0,a0,534 # 7dd0 <malloc+0x1d94>
    ...
    4bfe:	22e50513          	add	a0,a0,558 # 7e28 <malloc+0x1dec>
    ...
    4c3a:	19a50513          	add	a0,a0,410 # 7dd0 <malloc+0x1d94>
    ...
    4c60:	1f450513          	add	a0,a0,500 # 7e50 <malloc+0x1e14>
...
0000000000004c80 <fourfiles>:
{
    ...
    4ca4:	1c878793          	add	a5,a5,456 # 7e68 <malloc+0x1e2c>
    4ca8:	f6f43823          	sd	a5,-144(s0)
    4cac:	00003797          	auipc	a5,0x3
    4cb0:	1c478793          	add	a5,a5,452 # 7e70 <malloc+0x1e34>
    4cb4:	f6f43c23          	sd	a5,-136(s0)
    4cb8:	00003797          	auipc	a5,0x3
    4cbc:	1c078793          	add	a5,a5,448 # 7e78 <malloc+0x1e3c>
    4cc0:	f8f43023          	sd	a5,-128(s0)
    4cc4:	00003797          	auipc	a5,0x3
    4cc8:	1bc78793          	add	a5,a5,444 # 7e80 <malloc+0x1e44>
    ...
    4d36:	0d650513          	add	a0,a0,214 # 6e08 <malloc+0xdcc>
    ...
    4db0:	0dc50513          	add	a0,a0,220 # 7e88 <malloc+0x1e4c>
    ...
    4dca:	0d250513          	add	a0,a0,210 # 7e98 <malloc+0x1e5c>
    ...
    4df0:	0c450513          	add	a0,a0,196 # 7eb0 <malloc+0x1e74>
    ...
    4e78:	04c50513          	add	a0,a0,76 # 7ec0 <malloc+0x1e84>
...
0000000000004eac <concreate>:
{
    ...
    4eda:	002b8b93          	add	s7,s7,2 # 7ed8 <malloc+0x1e9c>
    for (i = 0; i < N; i++)
    ...
    4f1c:	fc850513          	add	a0,a0,-56 # 7ee0 <malloc+0x1ea4>
    ...
    4f3a:	fa250513          	add	a0,a0,-94 # 7ed8 <malloc+0x1e9c>
    ...
    4f72:	8f250513          	add	a0,a0,-1806 # 6860 <malloc+0x824>
    ...
    4fea:	f1a50513          	add	a0,a0,-230 # 7f00 <malloc+0x1ec4>
    ...
    500a:	f1a50513          	add	a0,a0,-230 # 7f20 <malloc+0x1ee4>
    ...
    5042:	f0a50513          	add	a0,a0,-246 # 7f48 <malloc+0x1f0c>
    ...
    505e:	9a650513          	add	a0,a0,-1626 # 6a00 <malloc+0x9c4>
...
0000000000005208 <bigfile>:
{
    ...
    5290:	cf450513          	add	a0,a0,-780 # 7f80 <malloc+0x1f44>
    ...
    52f4:	ca050513          	add	a0,a0,-864 # 7f90 <malloc+0x1f54>
    ...
    5310:	ca450513          	add	a0,a0,-860 # 7fb0 <malloc+0x1f74>
    ...
    532c:	ca850513          	add	a0,a0,-856 # 7fd0 <malloc+0x1f94>
    ...
    5348:	cac50513          	add	a0,a0,-852 # 7ff0 <malloc+0x1fb4>
    ...
    5364:	cb050513          	add	a0,a0,-848 # 8010 <malloc+0x1fd4>
    ...
    5380:	cac50513          	add	a0,a0,-852 # 8028 <malloc+0x1fec>
    ...
    53ae:	bd650513          	add	a0,a0,-1066 # 7f80 <malloc+0x1f44>
    ...
    53d2:	c7a50513          	add	a0,a0,-902 # 8048 <malloc+0x200c>
...
00000000000053e8 <fsfull>:
{
    ...
    5408:	c6450513          	add	a0,a0,-924 # 8068 <malloc+0x202c>
    ...
    5428:	c54c8c93          	add	s9,s9,-940 # 8078 <malloc+0x203c>
        name[0] = 'f';
    ...
    5498:	bf450513          	add	a0,a0,-1036 # 8088 <malloc+0x204c>
    ...
    550e:	b9e50513          	add	a0,a0,-1122 # 80a8 <malloc+0x206c>
    ...
    5564:	b3850513          	add	a0,a0,-1224 # 8098 <malloc+0x205c>
...
int run(void f(char *), char *s)
{
    ...
    5596:	b2e50513          	add	a0,a0,-1234 # 80c0 <malloc+0x2084>
    ...
    55c6:	b2650513          	add	a0,a0,-1242 # 80e8 <malloc+0x20ac>
    ...
    55ea:	aea50513          	add	a0,a0,-1302 # 80d0 <malloc+0x2094>
    ...
    5612:	ae250513          	add	a0,a0,-1310 # 80f0 <malloc+0x20b4>
...
int runtests(struct test *tests, char *justone)
{
    ...
    5662:	a9a50513          	add	a0,a0,-1382 # 80f8 <malloc+0x20bc>
...
int countfree()
{
    ...
    56bc:	b3098993          	add	s3,s3,-1232 # 61e8 <malloc+0x1ac>
            uint64 a = (uint64)sbrk(4096);
    ...
    56ee:	a6650513          	add	a0,a0,-1434 # 8150 <malloc+0x2114>
    ...
    570e:	a0650513          	add	a0,a0,-1530 # 8110 <malloc+0x20d4>
    ...
    572e:	a0650513          	add	a0,a0,-1530 # 8130 <malloc+0x20f4>
    ...
    5782:	9f250513          	add	a0,a0,-1550 # 8170 <malloc+0x2134>
...
int drivetests(int quick, int continuous, char *justone)
{
    ...
    57e0:	9b4b8b93          	add	s7,s7,-1612 # 8190 <malloc+0x2154>
        int free0 = countfree();
        int free1 = 0;
    ...
    57fa:	9b2d0d13          	add	s10,s10,-1614 # 81a8 <malloc+0x216c>
                }
            }
        }
    ...
    5802:	9cac8c93          	add	s9,s9,-1590 # 81c8 <malloc+0x218c>
...
int main(int argc, char *argv[])
{
    ...
    58da:	92258593          	add	a1,a1,-1758 # 81f8 <malloc+0x21bc>
    ...
    58f8:	90c58593          	add	a1,a1,-1780 # 8200 <malloc+0x21c4>
    ...
    590e:	94658593          	add	a1,a1,-1722 # 8250 <malloc+0x2214>
    ...
    593a:	8d250513          	add	a0,a0,-1838 # 8208 <malloc+0x21cc>
    ...
    5960:	8dc50513          	add	a0,a0,-1828 # 8238 <malloc+0x21fc>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5d00:	91c50513          	add	a0,a0,-1764 # 8618 <digits>
    5d04:	883a                	mv	a6,a4
    5d06:	2705                	addw	a4,a4,1
    5d08:	02c5f7bb          	remuw	a5,a1,a2
    5d0c:	1782                	sll	a5,a5,0x20
    5d0e:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5e06:	7be70713          	add	a4,a4,1982 # 85c0 <malloc+0x2584>
  ...
  putc(fd, 'x');
    ...
    5e92:	78ab8b93          	add	s7,s7,1930 # 8618 <digits>
    5e96:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5eaa:	0992                	sll	s3,s3,0x4
    5eac:	397d                	addw	s2,s2,-1
    ...
    5ee8:	6b490913          	add	s2,s2,1716 # 8598 <malloc+0x255c>
        while(*s != 0){
    5eec:	02800593          	li	a1,40
    5ef0:	bff1                	j	5ecc <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5ef2:	008b8913          	add	s2,s7,8
...
{
    5f56:	715d                	add	sp,sp,-80
    5f58:	ec06                	sd	ra,24(sp)
    5f5a:	e822                	sd	s0,16(sp)
    5f5c:	1000                	add	s0,sp,32
...
{
    5f84:	711d                	add	sp,sp,-96
    5f86:	ec06                	sd	ra,24(sp)
    5f88:	e822                	sd	s0,16(sp)
    5f8a:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5fba:	1141                	add	sp,sp,-16
    5fbc:	e422                	sd	s0,8(sp)
    5fbe:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fc0:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fc4:	00003797          	auipc	a5,0x3
    5fc8:	48c7b783          	ld	a5,1164(a5) # 9450 <freep>
    ...
    5ff0:	00e6ea63          	bltu	a3,a4,6004 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    600a:	02059813          	sll	a6,a1,0x20
    600e:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    601e:	02061593          	sll	a1,a2,0x20
    6022:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    603c:	7139                	add	sp,sp,-64
    603e:	fc06                	sd	ra,56(sp)
    6040:	f822                	sd	s0,48(sp)
    6042:	f426                	sd	s1,40(sp)
    6044:	ec4e                	sd	s3,24(sp)
    6046:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6048:	02051493          	sll	s1,a0,0x20
    604c:	9081                	srl	s1,s1,0x20
    604e:	04bd                	add	s1,s1,15
    6050:	8091                	srl	s1,s1,0x4
    6052:	0014899b          	addw	s3,s1,1
    6056:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    608c:	3c890913          	add	s2,s2,968 # 9450 <freep>
  if(p == (char*)-1)
    6090:	5afd                	li	s5,-1
    ...
    60a0:	bdc78793          	add	a5,a5,-1060 # fc78 <base>
  ...
  if(p == (char*)-1)
    ...
    610a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    610c:	02071693          	sll	a3,a4,0x20
    6110:	01c6d713          	srl	a4,a3,0x1c
    6114:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    6116:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    611a:	00003717          	auipc	a4,0x3
    611e:	32a73b23          	sd	a0,822(a4) # 9450 <freep>
      return (void*)(p + 1);
    6122:	01078513          	add	a0,a5,16
  }
}
