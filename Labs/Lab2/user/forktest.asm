...
forktest(void)
{
  ...
  3e:	42650513          	add	a0,a0,1062 # 460 <yield+0xc>
  ...
  68:	44c50513          	add	a0,a0,1100 # 4b0 <yield+0x5c>
  ...
  8a:	3ea50513          	add	a0,a0,1002 # 470 <yield+0x1c>
  ...
  a4:	3e850513          	add	a0,a0,1000 # 488 <yield+0x34>
  ...
  e4:	3c050513          	add	a0,a0,960 # 4a0 <yield+0x4c>
