...
go(int which_child)
{
  ...
  chdir("/");
      ...
      e2:	2d250513          	add	a0,a0,722 # 13b0 <malloc+0x130>
      e6:	00001097          	auipc	ra,0x1
      ea:	dca080e7          	jalr	-566(ra) # eb0 <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	2d298993          	add	s3,s3,722 # 13c0 <malloc+0x140>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	2c098993          	add	s3,s3,704 # 13b8 <malloc+0x138>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	58c90913          	add	s2,s2,1420 # 1690 <malloc+0x410>
    ...
    if(what == 1){
     ...
     116:	2b650513          	add	a0,a0,694 # 13c8 <malloc+0x148>
    ...
    int what = rand() % 23;
     ...
     174:	26850513          	add	a0,a0,616 # 13d8 <malloc+0x158>
     ...
     18e:	23e50513          	add	a0,a0,574 # 13c8 <malloc+0x148>
     ...
     1b2:	24250513          	add	a0,a0,578 # 13f0 <malloc+0x170>
     1b6:	00001097          	auipc	ra,0x1
     1ba:	cda080e7          	jalr	-806(ra) # e90 <unlink>
      chdir("/");
     1be:	00001517          	auipc	a0,0x1
     1c2:	1f250513          	add	a0,a0,498 # 13b0 <malloc+0x130>
     ...
     1fc:	20050513          	add	a0,a0,512 # 13f8 <malloc+0x178>
     ...
     21e:	1ee50513          	add	a0,a0,494 # 1408 <malloc+0x188>
     ...
     28e:	1a650513          	add	a0,a0,422 # 1430 <malloc+0x1b0>
     ...
     2cc:	18850513          	add	a0,a0,392 # 1450 <malloc+0x1d0>
     ...
     2de:	17e50513          	add	a0,a0,382 # 1458 <malloc+0x1d8>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	bae080e7          	jalr	-1106(ra) # e90 <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	10658593          	add	a1,a1,262 # 13f0 <malloc+0x170>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	16e50513          	add	a0,a0,366 # 1460 <malloc+0x1e0>
     ...
     308:	17450513          	add	a0,a0,372 # 1478 <malloc+0x1f8>
     30c:	00001097          	auipc	ra,0x1
     310:	b84080e7          	jalr	-1148(ra) # e90 <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	0e458593          	add	a1,a1,228 # 13f8 <malloc+0x178>
     31c:	00001517          	auipc	a0,0x1
     320:	16c50513          	add	a0,a0,364 # 1488 <malloc+0x208>
     ...
     354:	14050513          	add	a0,a0,320 # 1490 <malloc+0x210>
     ...
     3a2:	0f250513          	add	a0,a0,242 # 1490 <malloc+0x210>
     ...
     3b4:	a90080e7          	jalr	-1392(ra) # e40 <exit>
      ...
      sbrk(6011);
     3b8:	6505                	lui	a0,0x1
     3ba:	77b50513          	add	a0,a0,1915 # 177b <digits+0x33>
     ...
     402:	0b250513          	add	a0,a0,178 # 14b0 <malloc+0x230>
     ...
     42e:	07e50513          	add	a0,a0,126 # 14a8 <malloc+0x228>
     ...
     450:	04450513          	add	a0,a0,68 # 1490 <malloc+0x210>
     ...
     46a:	05a50513          	add	a0,a0,90 # 14c0 <malloc+0x240>
     ...
     4b8:	fdc50513          	add	a0,a0,-36 # 1490 <malloc+0x210>
     ...
     514:	fc850513          	add	a0,a0,-56 # 14d8 <malloc+0x258>
     ...
     540:	fb458593          	add	a1,a1,-76 # 14f0 <malloc+0x270>
     ...
     642:	e5250513          	add	a0,a0,-430 # 1490 <malloc+0x210>
     ...
     65c:	ee850513          	add	a0,a0,-280 # 1540 <malloc+0x2c0>
     ...
     670:	ed450513          	add	a0,a0,-300 # 1540 <malloc+0x2c0>
     ...
     688:	e6c58593          	add	a1,a1,-404 # 14f0 <malloc+0x270>
     ...
     6ce:	e7650513          	add	a0,a0,-394 # 1540 <malloc+0x2c0>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	7be080e7          	jalr	1982(ra) # e90 <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e6c50513          	add	a0,a0,-404 # 1548 <malloc+0x2c8>
     ...
     6fa:	e6a50513          	add	a0,a0,-406 # 1560 <malloc+0x2e0>
     ...
     714:	e6850513          	add	a0,a0,-408 # 1578 <malloc+0x2f8>
     ...
     730:	e6450513          	add	a0,a0,-412 # 1590 <malloc+0x310>
     ...
     74a:	e7250513          	add	a0,a0,-398 # 15b8 <malloc+0x338>
     ...
     832:	e2a58593          	add	a1,a1,-470 # 1658 <malloc+0x3d8>
     ...
     856:	e0e50513          	add	a0,a0,-498 # 1660 <malloc+0x3e0>
     ...
     870:	c6c58593          	add	a1,a1,-916 # 14d8 <malloc+0x258>
     874:	4509                	li	a0,2
     ...
     88c:	c5058593          	add	a1,a1,-944 # 14d8 <malloc+0x258>
     890:	4509                	li	a0,2
     ...
     8e8:	cfc58593          	add	a1,a1,-772 # 15e0 <malloc+0x360>
     8ec:	4509                	li	a0,2
     ...
     95c:	b3858593          	add	a1,a1,-1224 # 1490 <malloc+0x210>
     960:	4509                	li	a0,2
     ...
     9a8:	c3c58593          	add	a1,a1,-964 # 15e0 <malloc+0x360>
     9ac:	4509                	li	a0,2
     ...
     9ec:	bf858593          	add	a1,a1,-1032 # 15e0 <malloc+0x360>
     9f0:	4509                	li	a0,2
     ...
     a54:	a4058593          	add	a1,a1,-1472 # 1490 <malloc+0x210>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	a3450513          	add	a0,a0,-1484 # 14a8 <malloc+0x228>
     a7c:	00000097          	auipc	ra,0x0
     a80:	414080e7          	jalr	1044(ra) # e90 <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	9d450513          	add	a0,a0,-1580 # 1458 <malloc+0x1d8>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aca:	9ca50513          	add	a0,a0,-1590 # 1490 <malloc+0x210>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     afa:	629c                	ld	a5,0(a3)
     afc:	6709                	lui	a4,0x2
     afe:	c0970713          	add	a4,a4,-1015 # 1c09 <digits+0x4c1>
    ...
    printf("grind: fork failed\n");
     ...
     b14:	98050513          	add	a0,a0,-1664 # 1490 <malloc+0x210>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f44:	80850513          	add	a0,a0,-2040 # 1748 <digits>
     f48:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    104a:	6aa70713          	add	a4,a4,1706 # 16f0 <malloc+0x470>
  ...
  putc(fd, 'x');
    ...
    10d6:	676b8b93          	add	s7,s7,1654 # 1748 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    112c:	56090913          	add	s2,s2,1376 # 1688 <malloc+0x408>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12d0:	d4490913          	add	s2,s2,-700 # 2010 <freep>
  if(p == (char*)-1)
    12d4:	5afd                	li	s5,-1
    ...
    12e4:	12878793          	add	a5,a5,296 # 2408 <base>
