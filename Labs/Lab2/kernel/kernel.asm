...
0000000080000000 <_entry>:
    ...
    80000004:	b5010113          	add	sp,sp,-1200 # 80008b50 <stack0>
...
r_mhartid()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    80000054:	9c070713          	add	a4,a4,-1600 # 80008a10 <timer_scratch>
...
w_mscratch(uint64 x)
{
  ...
  asm volatile("csrw mtvec, %0" : : "r" (x));
    ...
    80000066:	24e78793          	add	a5,a5,590 # 800062b0 <timervec>
...
000000008000008c <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000009a:	7ff70713          	add	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdc77f>
...
int consolewrite(int user_src, uint64 src, int n)
{
    ...
    8000012e:	7bc080e7          	jalr	1980(ra) # 800028e6 <either_copyin>
...
int consoleread(int user_dst, uint64 dst, int n)
{
    ...
    80000190:	9c450513          	add	a0,a0,-1596 # 80010b50 <cons>
    ...
    800001a0:	9b448493          	add	s1,s1,-1612 # 80010b50 <cons>
            if (killed(myproc()))
            {
                release(&cons.lock);
                return -1;
    ...
    800001a8:	a4490913          	add	s2,s2,-1468 # 80010be8 <cons+0x98>
    while (n > 0)
    ...
    800001c0:	b1a080e7          	jalr	-1254(ra) # 80001cd6 <myproc>
    800001c4:	00002097          	auipc	ra,0x2
    800001c8:	56c080e7          	jalr	1388(ra) # 80002730 <killed>
    800001cc:	e52d                	bnez	a0,80000236 <consoleread+0xc8>
            sleep(&cons.r, &cons.lock);
    800001ce:	85a6                	mv	a1,s1
    800001d0:	854a                	mv	a0,s2
    800001d2:	00002097          	auipc	ra,0x2
    800001d6:	2b6080e7          	jalr	694(ra) # 80002488 <sleep>
        while (cons.r == cons.w)
    ...
    800001ec:	96870713          	add	a4,a4,-1688 # 80010b50 <cons>
    ...
    8000021e:	676080e7          	jalr	1654(ra) # 80002890 <either_copyout>
    ...
    8000023a:	91a50513          	add	a0,a0,-1766 # 80010b50 <cons>
    ...
    80000268:	98f72223          	sw	a5,-1660(a4) # 80010be8 <cons+0x98>
    ...
    8000027e:	8d650513          	add	a0,a0,-1834 # 80010b50 <cons>
...
void consoleintr(int c)
{
    ...
    800002e6:	86e50513          	add	a0,a0,-1938 # 80010b50 <cons>
    ...
    8000030c:	634080e7          	jalr	1588(ra) # 8000293c <procdump>
            }
        }
        break;
    }
    ...
    80000314:	84050513          	add	a0,a0,-1984 # 80010b50 <cons>
    ...
    80000336:	81e70713          	add	a4,a4,-2018 # 80010b50 <cons>
    ...
    80000360:	7f478793          	add	a5,a5,2036 # 80010b50 <cons>
    ...
    8000038e:	85e7a783          	lw	a5,-1954(a5) # 80010be8 <cons+0x98>
    ...
    800003fa:	75a70713          	add	a4,a4,1882 # 80010b50 <cons>
    ...
    80000410:	7ef72223          	sw	a5,2020(a4) # 80010bf0 <cons+0xa0>
            consputc(BACKSPACE);
    ...
    80000436:	71e78793          	add	a5,a5,1822 # 80010b50 <cons>
    ...
    8000045a:	78c7ab23          	sw	a2,1942(a5) # 80010bec <cons+0x9c>
                wakeup(&cons.r);
    8000045e:	00010517          	auipc	a0,0x10
    80000462:	78a50513          	add	a0,a0,1930 # 80010be8 <cons+0x98>
    80000466:	00002097          	auipc	ra,0x2
    8000046a:	086080e7          	jalr	134(ra) # 800024ec <wakeup>
...
void consoleinit(void)
{
    ...
    80000484:	6d050513          	add	a0,a0,1744 # 80010b50 <cons>
    ...
    8000049c:	a5078793          	add	a5,a5,-1456 # 80020ee8 <devsw>
...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    800004da:	32260613          	add	a2,a2,802 # 800087f8 <digits>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    80000570:	6a07a223          	sw	zero,1700(a5) # 80010c10 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    800005a4:	42f72823          	sw	a5,1072(a4) # 800089d0 <panicked>
  for(;;)
...
00000000800005aa <printf>:
{
  ...
  locking = pr.locking;
    ...
    800005ce:	646d2d03          	lw	s10,1606(s10) # 80010c10 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    8000060c:	1f0a8a93          	add	s5,s5,496 # 800087f8 <digits>
    switch(c){
    ...
    8000061e:	5de50513          	add	a0,a0,1502 # 80010bf8 <pr>
  ...
  if(locking)
    ...
    800007a4:	45850513          	add	a0,a0,1112 # 80010bf8 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    800007c0:	43c48493          	add	s1,s1,1084 # 80010bf8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    8000082c:	3f050513          	add	a0,a0,1008 # 80010c18 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80000858:	17c7a783          	lw	a5,380(a5) # 800089d0 <panicked>
...
uartstart()
{
  while(1){
    ...
    80000892:	14a7b783          	ld	a5,330(a5) # 800089d8 <uart_tx_r>
    80000896:	00008717          	auipc	a4,0x8
    8000089a:	14a73703          	ld	a4,330(a4) # 800089e0 <uart_tx_w>
    8000089e:	06f70f63          	beq	a4,a5,8000091c <uartstart+0x8e>
{
    ...
    800008c0:	35ca8a93          	add	s5,s5,860 # 80010c18 <uart_tx_lock>
    uart_tx_r += 1;
    800008c4:	00008497          	auipc	s1,0x8
    800008c8:	11448493          	add	s1,s1,276 # 800089d8 <uart_tx_r>
    ...
    800008d4:	11098993          	add	s3,s3,272 # 800089e0 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
000000008000091e <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000934:	2e850513          	add	a0,a0,744 # 80010c18 <uart_tx_lock>
    80000938:	00000097          	auipc	ra,0x0
    8000093c:	300080e7          	jalr	768(ra) # 80000c38 <acquire>
  if(panicked){
    80000940:	00008797          	auipc	a5,0x8
    80000944:	0907a783          	lw	a5,144(a5) # 800089d0 <panicked>
    80000948:	e7c9                	bnez	a5,800009d2 <uartputc+0xb4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000094a:	00008717          	auipc	a4,0x8
    8000094e:	09673703          	ld	a4,150(a4) # 800089e0 <uart_tx_w>
    80000952:	00008797          	auipc	a5,0x8
    80000956:	0867b783          	ld	a5,134(a5) # 800089d8 <uart_tx_r>
    8000095a:	02078793          	add	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    8000095e:	00010997          	auipc	s3,0x10
    80000962:	2ba98993          	add	s3,s3,698 # 80010c18 <uart_tx_lock>
    80000966:	00008497          	auipc	s1,0x8
    8000096a:	07248493          	add	s1,s1,114 # 800089d8 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000096e:	00008917          	auipc	s2,0x8
    80000972:	07290913          	add	s2,s2,114 # 800089e0 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    80000998:	28448493          	add	s1,s1,644 # 80010c18 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    800009ac:	02e7bc23          	sd	a4,56(a5) # 800089e0 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000a20:	1fc48493          	add	s1,s1,508 # 80010c18 <uart_tx_lock>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a62:	62278793          	add	a5,a5,1570 # 80022080 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000a82:	1d290913          	add	s2,s2,466 # 80010c50 <kmem>
...
0000000080000b0c <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000b20:	13450513          	add	a0,a0,308 # 80010c50 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000b34:	55050513          	add	a0,a0,1360 # 80022080 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000b56:	0fe48493          	add	s1,s1,254 # 80010c50 <kmem>
  ...
  if(r)
    ...
    80000b6e:	0e650513          	add	a0,a0,230 # 80010c50 <kmem>
  ...
  release(&kmem.lock);
    ...
    80000b9a:	0ba50513          	add	a0,a0,186 # 80010c50 <kmem>
    ...
    80000bc4:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    ...
    80000bd6:	0e8080e7          	jalr	232(ra) # 80001cba <mycpu>
...
push_off(void)
{
  ...
  mycpu()->noff += 1;
    ...
    80000c2c:	092080e7          	jalr	146(ra) # 80001cba <mycpu>
...
0000000080000c38 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    80000c6c:	052080e7          	jalr	82(ra) # 80001cba <mycpu>
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80000c98:	026080e7          	jalr	38(ra) # 80001cba <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    ...
    80000da0:	00c587b3          	add	a5,a1,a2
{
    ...
    80000da8:	0705                	add	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffdcf81>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ede:	dd0080e7          	jalr	-560(ra) # 80001caa <cpuid>
    ...
    80000ee6:	b0670713          	add	a4,a4,-1274 # 800089e8 <started>
  if(cpuid() == 0){
    ...
    80000efa:	db4080e7          	jalr	-588(ra) # 80001caa <cpuid>
    ...
    80000f1c:	cac080e7          	jalr	-852(ra) # 80002bc4 <trapinithart>
  ...
  scheduler();        
    ...
    80000f2c:	43e080e7          	jalr	1086(ra) # 80002366 <scheduler>
    consoleinit();
    ...
    80000f8c:	c3c080e7          	jalr	-964(ra) # 80001bc4 <procinit>
    trapinit();      // trap vectors
    80000f90:	00002097          	auipc	ra,0x2
    80000f94:	c0c080e7          	jalr	-1012(ra) # 80002b9c <trapinit>
    trapinithart();  // install kernel trap vector
    80000f98:	00002097          	auipc	ra,0x2
    80000f9c:	c2c080e7          	jalr	-980(ra) # 80002bc4 <trapinithart>
    ...
    80000fd4:	fde080e7          	jalr	-34(ra) # 80001fae <userinit>
    __sync_synchronize();
    80000fd8:	0ff0000f          	fence
    started = 1;
    80000fdc:	4785                	li	a5,1
    80000fde:	00008717          	auipc	a4,0x8
    80000fe2:	a0f72523          	sw	a5,-1526(a4) # 800089e8 <started>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80000ff6:	9fe7b783          	ld	a5,-1538(a5) # 800089f0 <kernel_pagetable>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80001070:	3a5d                	addw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffdcf77>
...
00000000800011c8 <kvmmake>:
{
  ...
  proc_mapstacks(kpgtbl);
    ...
    8000128c:	898080e7          	jalr	-1896(ra) # 80001b20 <proc_mapstacks>
}
...
000000008000129e <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    800012b2:	74a7b123          	sd	a0,1858(a5) # 800089f0 <kernel_pagetable>
}
    ...
    80001852:	04e58663          	beq	a1,a4,8000189e <copyinstr+0xa2>
{
    ...
    8000188c:	00074703          	lbu	a4,0(a4) # fffffffffffff000 <end+0xffffffff7ffdcf80>
...
void rr_scheduler(void)
{
  ...
  asm volatile("mv %0, tp" : "=r" (x) );
    ...
    c->proc = 0;
    800018d0:	0000fa97          	auipc	s5,0xf
    800018d4:	3a0a8a93          	add	s5,s5,928 # 80010c70 <cpus>
    800018d8:	00779713          	sll	a4,a5,0x7
    800018dc:	00ea86b3          	add	a3,s5,a4
    800018e0:	0006b023          	sd	zero,0(a3) # fffffffffffff000 <end+0xffffffff7ffdcf80>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800018e4:	100026f3          	csrr	a3,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800018e8:	0026e693          	or	a3,a3,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800018f0:	0721                	add	a4,a4,8
    800018f2:	9aba                	add	s5,s5,a4
    for (p = proc; p < &proc[NPROC]; p++)
    800018f4:	0000f497          	auipc	s1,0xf
    800018f8:	7ac48493          	add	s1,s1,1964 # 800110a0 <proc>
        if (p->state == RUNNABLE)
    800018fc:	498d                	li	s3,3
            p->state = RUNNING;
    800018fe:	4b11                	li	s6,4
            c->proc = p;
    80001900:	079e                	sll	a5,a5,0x7
    80001902:	0000fa17          	auipc	s4,0xf
    80001906:	36ea0a13          	add	s4,s4,878 # 80010c70 <cpus>
    8000190a:	9a3e                	add	s4,s4,a5
    for (p = proc; p < &proc[NPROC]; p++)
    8000190c:	00015917          	auipc	s2,0x15
    80001910:	39490913          	add	s2,s2,916 # 80016ca0 <tickslock>
    ...
    for (p = proc; p < &proc[NPROC]; p++)
    80001920:	17048493          	add	s1,s1,368
    ...
    8000193c:	009a3023          	sd	s1,0(s4)
            swtch(&c->context, &p->context);
    80001940:	06848593          	add	a1,s1,104
    80001944:	8556                	mv	a0,s5
    80001946:	00001097          	auipc	ra,0x1
    8000194a:	1ec080e7          	jalr	492(ra) # 80002b32 <swtch>
            c->proc = 0;
...
{
    80001968:	711d                	add	sp,sp,-96
    8000196a:	ec86                	sd	ra,88(sp)
    8000196c:	e8a2                	sd	s0,80(sp)
    8000196e:	e4a6                	sd	s1,72(sp)
    80001970:	e0ca                	sd	s2,64(sp)
    80001972:	fc4e                	sd	s3,56(sp)
    80001974:	f852                	sd	s4,48(sp)
    80001976:	f456                	sd	s5,40(sp)
    80001978:	f05a                	sd	s6,32(sp)
    8000197a:	ec5e                	sd	s7,24(sp)
    8000197c:	e862                	sd	s8,16(sp)
    8000197e:	e466                	sd	s9,8(sp)
    80001980:	e06a                	sd	s10,0(sp)
    80001982:	1080                	add	s0,sp,96
  asm volatile("mv %0, tp" : "=r" (x) );
    80001984:	8b92                	mv	s7,tp
    int id = r_tp();
    80001986:	2b81                	sext.w	s7,s7
    struct proc *p; 
    struct cpu *c = mycpu();
    c->proc = 0; 
    80001988:	0000fa97          	auipc	s5,0xf
    8000198c:	2e8a8a93          	add	s5,s5,744 # 80010c70 <cpus>
    80001990:	007b9793          	sll	a5,s7,0x7
    80001994:	00fa8733          	add	a4,s5,a5
    80001998:	00073023          	sd	zero,0(a4)
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    8000199c:	10002773          	csrr	a4,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800019a0:	00276713          	or	a4,a4,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800019a4:	10071073          	csrw	sstatus,a4
    for (p = proc; p < &proc[NPROC] && !hasRun; p++) {
        acquire(&p->lock);
        if (p->state == RUNNABLE && p->queue == 0) { // if process is runnable and in the highest priority queue
            p->state = RUNNING; 
            c->proc = p; // assign process to cpu
            swtch(&c->context, &p->context); // context switch to the selected process
    800019a8:	07a1                	add	a5,a5,8
    800019aa:	9abe                	add	s5,s5,a5
    for (p = proc; p < &proc[NPROC] && !hasRun; p++) {
    800019ac:	0000f497          	auipc	s1,0xf
    800019b0:	6f448493          	add	s1,s1,1780 # 800110a0 <proc>
        if (p->state == RUNNABLE && p->queue == 0) { // if process is runnable and in the highest priority queue
    800019b4:	4a0d                	li	s4,3
    800019b6:	4981                	li	s3,0
    for (p = proc; p < &proc[NPROC] && !hasRun; p++) {
    800019b8:	00015b17          	auipc	s6,0x15
    800019bc:	2e8b0b13          	add	s6,s6,744 # 80016ca0 <tickslock>
            p->state = RUNNING; 
    800019c0:	4d11                	li	s10,4
            c->proc = p; // assign process to cpu
    800019c2:	007b9793          	sll	a5,s7,0x7
    800019c6:	0000fc17          	auipc	s8,0xf
    800019ca:	2aac0c13          	add	s8,s8,682 # 80010c70 <cpus>
    800019ce:	9c3e                	add	s8,s8,a5
            // downgrade the process if it exceeds time slice
            if (ticks - p->lastRun > 10) p->queue = 1;
    800019d0:	00007c97          	auipc	s9,0x7
    800019d4:	038c8c93          	add	s9,s9,56 # 80008a08 <ticks>
    800019d8:	a099                	j	80001a1e <MLFQ_scheduler+0xb6>
            p->state = RUNNING; 
    800019da:	01a4ac23          	sw	s10,24(s1)
            c->proc = p; // assign process to cpu
    800019de:	009c3023          	sd	s1,0(s8)
            swtch(&c->context, &p->context); // context switch to the selected process
    800019e2:	06848593          	add	a1,s1,104
    800019e6:	8556                	mv	a0,s5
    800019e8:	00001097          	auipc	ra,0x1
    800019ec:	14a080e7          	jalr	330(ra) # 80002b32 <swtch>
            if (ticks - p->lastRun > 10) p->queue = 1;
    800019f0:	000ca783          	lw	a5,0(s9)
    800019f4:	58d8                	lw	a4,52(s1)
    800019f6:	9f99                	subw	a5,a5,a4
    800019f8:	4729                	li	a4,10
    800019fa:	00f77463          	bgeu	a4,a5,80001a02 <MLFQ_scheduler+0x9a>
    800019fe:	4785                	li	a5,1
    80001a00:	dc9c                	sw	a5,56(s1)
            c->proc = 0; // reset cpu
    80001a02:	000c3023          	sd	zero,0(s8)
            hasRun = 1; // mark that a process has run
    80001a06:	4905                	li	s2,1
        }
        release(&p->lock); 
    80001a08:	8526                	mv	a0,s1
    80001a0a:	fffff097          	auipc	ra,0xfffff
    80001a0e:	2e2080e7          	jalr	738(ra) # 80000cec <release>
    for (p = proc; p < &proc[NPROC] && !hasRun; p++) {
    80001a12:	17048493          	add	s1,s1,368
    80001a16:	03648963          	beq	s1,s6,80001a48 <MLFQ_scheduler+0xe0>
    80001a1a:	08091d63          	bnez	s2,80001ab4 <MLFQ_scheduler+0x14c>
        acquire(&p->lock);
    80001a1e:	8526                	mv	a0,s1
    80001a20:	fffff097          	auipc	ra,0xfffff
    80001a24:	218080e7          	jalr	536(ra) # 80000c38 <acquire>
        if (p->state == RUNNABLE && p->queue == 0) { // if process is runnable and in the highest priority queue
    80001a28:	4c9c                	lw	a5,24(s1)
    80001a2a:	894e                	mv	s2,s3
    80001a2c:	fd479ee3          	bne	a5,s4,80001a08 <MLFQ_scheduler+0xa0>
    80001a30:	5c9c                	lw	a5,56(s1)
    80001a32:	d7c5                	beqz	a5,800019da <MLFQ_scheduler+0x72>
        release(&p->lock); 
    80001a34:	8526                	mv	a0,s1
    80001a36:	fffff097          	auipc	ra,0xfffff
    80001a3a:	2b6080e7          	jalr	694(ra) # 80000cec <release>
    for (p = proc; p < &proc[NPROC] && !hasRun; p++) {
    80001a3e:	17048493          	add	s1,s1,368
    80001a42:	fd649ee3          	bne	s1,s6,80001a1e <MLFQ_scheduler+0xb6>
    80001a46:	4901                	li	s2,0
    }
    // if no process was scheduled from the highest priority queue, try the next priority queue
    if (!hasRun) {
    80001a48:	06091663          	bnez	s2,80001ab4 <MLFQ_scheduler+0x14c>
        for (p = proc; p < &proc[NPROC]; p++) {
    80001a4c:	0000f497          	auipc	s1,0xf
    80001a50:	65448493          	add	s1,s1,1620 # 800110a0 <proc>
            acquire(&p->lock);
            if (p->state == RUNNABLE && p->queue == 1) {
    80001a54:	498d                	li	s3,3
    80001a56:	4a05                	li	s4,1
                p->state = RUNNING;
    80001a58:	4c11                	li	s8,4
                c->proc = p;
    80001a5a:	0b9e                	sll	s7,s7,0x7
    80001a5c:	0000fb17          	auipc	s6,0xf
    80001a60:	214b0b13          	add	s6,s6,532 # 80010c70 <cpus>
    80001a64:	9b5e                	add	s6,s6,s7
        for (p = proc; p < &proc[NPROC]; p++) {
    80001a66:	00015917          	auipc	s2,0x15
    80001a6a:	23a90913          	add	s2,s2,570 # 80016ca0 <tickslock>
    80001a6e:	a811                	j	80001a82 <MLFQ_scheduler+0x11a>
                swtch(&c->context, &p->context);
                c->proc = 0;
            }
            release(&p->lock);
    ...
    80001a76:	27a080e7          	jalr	634(ra) # 80000cec <release>
        for (p = proc; p < &proc[NPROC]; p++) {
    80001a7a:	17048493          	add	s1,s1,368
    80001a7e:	03248b63          	beq	s1,s2,80001ab4 <MLFQ_scheduler+0x14c>
            acquire(&p->lock);
    80001a82:	8526                	mv	a0,s1
    80001a84:	fffff097          	auipc	ra,0xfffff
    80001a88:	1b4080e7          	jalr	436(ra) # 80000c38 <acquire>
            if (p->state == RUNNABLE && p->queue == 1) {
    80001a8c:	4c9c                	lw	a5,24(s1)
    80001a8e:	ff3791e3          	bne	a5,s3,80001a70 <MLFQ_scheduler+0x108>
    80001a92:	5c9c                	lw	a5,56(s1)
    80001a94:	fd479ee3          	bne	a5,s4,80001a70 <MLFQ_scheduler+0x108>
                p->state = RUNNING;
    80001a98:	0184ac23          	sw	s8,24(s1)
                c->proc = p;
    80001a9c:	009b3023          	sd	s1,0(s6)
                swtch(&c->context, &p->context);
    80001aa0:	06848593          	add	a1,s1,104
    80001aa4:	8556                	mv	a0,s5
    80001aa6:	00001097          	auipc	ra,0x1
    80001aaa:	08c080e7          	jalr	140(ra) # 80002b32 <swtch>
                c->proc = 0;
    80001aae:	000b3023          	sd	zero,0(s6)
    80001ab2:	bf7d                	j	80001a70 <MLFQ_scheduler+0x108>
        }

    }
    // periodically boost the priority of all processes to prevent starvation
    if (ticks % 10 == 0) {
    80001ab4:	00007797          	auipc	a5,0x7
    80001ab8:	f547a783          	lw	a5,-172(a5) # 80008a08 <ticks>
    80001abc:	4729                	li	a4,10
    80001abe:	02e7f7bb          	remuw	a5,a5,a4
    80001ac2:	2781                	sext.w	a5,a5
    80001ac4:	e3a1                	bnez	a5,80001b04 <MLFQ_scheduler+0x19c>
        for (p = proc; p < &proc[NPROC]; p++) {
    80001ac6:	0000f497          	auipc	s1,0xf
    80001aca:	5da48493          	add	s1,s1,1498 # 800110a0 <proc>
            acquire(&p->lock);
            if (p->state == RUNNABLE || p->state == SLEEPING) p->queue = 0;
    80001ace:	4985                	li	s3,1
        for (p = proc; p < &proc[NPROC]; p++) {
    80001ad0:	00015917          	auipc	s2,0x15
    80001ad4:	1d090913          	add	s2,s2,464 # 80016ca0 <tickslock>
    80001ad8:	a811                	j	80001aec <MLFQ_scheduler+0x184>
            // reset the queue for processses that are runnable or slepping
            release(&p->lock);
    80001ada:	8526                	mv	a0,s1
    80001adc:	fffff097          	auipc	ra,0xfffff
    80001ae0:	210080e7          	jalr	528(ra) # 80000cec <release>
        for (p = proc; p < &proc[NPROC]; p++) {
    80001ae4:	17048493          	add	s1,s1,368
    80001ae8:	01248e63          	beq	s1,s2,80001b04 <MLFQ_scheduler+0x19c>
            acquire(&p->lock);
    80001aec:	8526                	mv	a0,s1
    80001aee:	fffff097          	auipc	ra,0xfffff
    80001af2:	14a080e7          	jalr	330(ra) # 80000c38 <acquire>
            if (p->state == RUNNABLE || p->state == SLEEPING) p->queue = 0;
    80001af6:	4c9c                	lw	a5,24(s1)
    80001af8:	37f9                	addw	a5,a5,-2
    80001afa:	fef9e0e3          	bltu	s3,a5,80001ada <MLFQ_scheduler+0x172>
    80001afe:	0204ac23          	sw	zero,56(s1)
    80001b02:	bfe1                	j	80001ada <MLFQ_scheduler+0x172>
        }
    }

}
    80001b04:	60e6                	ld	ra,88(sp)
    80001b06:	6446                	ld	s0,80(sp)
    80001b08:	64a6                	ld	s1,72(sp)
    80001b0a:	6906                	ld	s2,64(sp)
    80001b0c:	79e2                	ld	s3,56(sp)
    80001b0e:	7a42                	ld	s4,48(sp)
    80001b10:	7aa2                	ld	s5,40(sp)
    80001b12:	7b02                	ld	s6,32(sp)
    80001b14:	6be2                	ld	s7,24(sp)
    80001b16:	6c42                	ld	s8,16(sp)
    80001b18:	6ca2                	ld	s9,8(sp)
    80001b1a:	6d02                	ld	s10,0(sp)
    80001b1c:	6125                	add	sp,sp,96
    80001b1e:	8082                	ret

0000000080001b20 <proc_mapstacks>:
{
    80001b20:	7139                	add	sp,sp,-64
    80001b22:	fc06                	sd	ra,56(sp)
    80001b24:	f822                	sd	s0,48(sp)
    80001b26:	f426                	sd	s1,40(sp)
    80001b28:	f04a                	sd	s2,32(sp)
    80001b2a:	ec4e                	sd	s3,24(sp)
    80001b2c:	e852                	sd	s4,16(sp)
    80001b2e:	e456                	sd	s5,8(sp)
    80001b30:	e05a                	sd	s6,0(sp)
    80001b32:	0080                	add	s0,sp,64
    80001b34:	8a2a                	mv	s4,a0
    for (p = proc; p < &proc[NPROC]; p++)
    80001b36:	0000f497          	auipc	s1,0xf
    80001b3a:	56a48493          	add	s1,s1,1386 # 800110a0 <proc>
        uint64 va = KSTACK((int)(p - proc));
    80001b3e:	8b26                	mv	s6,s1
    80001b40:	ff4df937          	lui	s2,0xff4df
    80001b44:	9bd90913          	add	s2,s2,-1603 # ffffffffff4de9bd <end+0xffffffff7f4bc93d>
    80001b48:	0936                	sll	s2,s2,0xd
    80001b4a:	6f590913          	add	s2,s2,1781
    80001b4e:	0936                	sll	s2,s2,0xd
    80001b50:	bd390913          	add	s2,s2,-1069
    80001b54:	0932                	sll	s2,s2,0xc
    80001b56:	7a790913          	add	s2,s2,1959
    80001b5a:	040009b7          	lui	s3,0x4000
    80001b5e:	19fd                	add	s3,s3,-1 # 3ffffff <_entry-0x7c000001>
    80001b60:	09b2                	sll	s3,s3,0xc
    for (p = proc; p < &proc[NPROC]; p++)
    80001b62:	00015a97          	auipc	s5,0x15
    80001b66:	13ea8a93          	add	s5,s5,318 # 80016ca0 <tickslock>
        char *pa = kalloc();
    80001b6a:	fffff097          	auipc	ra,0xfffff
    80001b6e:	fde080e7          	jalr	-34(ra) # 80000b48 <kalloc>
    80001b72:	862a                	mv	a2,a0
        if (pa == 0)
    80001b74:	c121                	beqz	a0,80001bb4 <proc_mapstacks+0x94>
        uint64 va = KSTACK((int)(p - proc));
    80001b76:	416485b3          	sub	a1,s1,s6
    80001b7a:	8591                	sra	a1,a1,0x4
    80001b7c:	032585b3          	mul	a1,a1,s2
    80001b80:	2585                	addw	a1,a1,1
    80001b82:	00d5959b          	sllw	a1,a1,0xd
        kvmmap(kpgtbl, va, (uint64)pa, PGSIZE, PTE_R | PTE_W);
    80001b86:	4719                	li	a4,6
    80001b88:	6685                	lui	a3,0x1
    80001b8a:	40b985b3          	sub	a1,s3,a1
    80001b8e:	8552                	mv	a0,s4
    80001b90:	fffff097          	auipc	ra,0xfffff
    80001b94:	608080e7          	jalr	1544(ra) # 80001198 <kvmmap>
    for (p = proc; p < &proc[NPROC]; p++)
    80001b98:	17048493          	add	s1,s1,368
    80001b9c:	fd5497e3          	bne	s1,s5,80001b6a <proc_mapstacks+0x4a>
}
    ...
    80001bb0:	6121                	add	sp,sp,64
    80001bb2:	8082                	ret
            panic("kalloc");
    80001bb4:	00006517          	auipc	a0,0x6
    80001bb8:	60450513          	add	a0,a0,1540 # 800081b8 <etext+0x1b8>
    80001bbc:	fffff097          	auipc	ra,0xfffff
    80001bc0:	9a4080e7          	jalr	-1628(ra) # 80000560 <panic>

0000000080001bc4 <procinit>:
{
    80001bc4:	7139                	add	sp,sp,-64
    ...
    80001bd6:	0080                	add	s0,sp,64
    initlock(&pid_lock, "nextpid");
    80001bd8:	00006597          	auipc	a1,0x6
    80001bdc:	5e858593          	add	a1,a1,1512 # 800081c0 <etext+0x1c0>
    80001be0:	0000f517          	auipc	a0,0xf
    80001be4:	49050513          	add	a0,a0,1168 # 80011070 <pid_lock>
    80001be8:	fffff097          	auipc	ra,0xfffff
    80001bec:	fc0080e7          	jalr	-64(ra) # 80000ba8 <initlock>
    initlock(&wait_lock, "wait_lock");
    80001bf0:	00006597          	auipc	a1,0x6
    80001bf4:	5d858593          	add	a1,a1,1496 # 800081c8 <etext+0x1c8>
    80001bf8:	0000f517          	auipc	a0,0xf
    80001bfc:	49050513          	add	a0,a0,1168 # 80011088 <wait_lock>
    80001c00:	fffff097          	auipc	ra,0xfffff
    80001c04:	fa8080e7          	jalr	-88(ra) # 80000ba8 <initlock>
    for (p = proc; p < &proc[NPROC]; p++)
    80001c08:	0000f497          	auipc	s1,0xf
    80001c0c:	49848493          	add	s1,s1,1176 # 800110a0 <proc>
        initlock(&p->lock, "proc");
    80001c10:	00006b17          	auipc	s6,0x6
    80001c14:	5c8b0b13          	add	s6,s6,1480 # 800081d8 <etext+0x1d8>
        p->kstack = KSTACK((int)(p - proc));
    80001c18:	8aa6                	mv	s5,s1
    80001c1a:	ff4df937          	lui	s2,0xff4df
    80001c1e:	9bd90913          	add	s2,s2,-1603 # ffffffffff4de9bd <end+0xffffffff7f4bc93d>
    80001c22:	0936                	sll	s2,s2,0xd
    80001c24:	6f590913          	add	s2,s2,1781
    80001c28:	0936                	sll	s2,s2,0xd
    80001c2a:	bd390913          	add	s2,s2,-1069
    80001c2e:	0932                	sll	s2,s2,0xc
    80001c30:	7a790913          	add	s2,s2,1959
    80001c34:	040009b7          	lui	s3,0x4000
    80001c38:	19fd                	add	s3,s3,-1 # 3ffffff <_entry-0x7c000001>
    80001c3a:	09b2                	sll	s3,s3,0xc
    for (p = proc; p < &proc[NPROC]; p++)
    80001c3c:	00015a17          	auipc	s4,0x15
    80001c40:	064a0a13          	add	s4,s4,100 # 80016ca0 <tickslock>
        initlock(&p->lock, "proc");
    80001c44:	85da                	mv	a1,s6
    80001c46:	8526                	mv	a0,s1
    80001c48:	fffff097          	auipc	ra,0xfffff
    80001c4c:	f60080e7          	jalr	-160(ra) # 80000ba8 <initlock>
        p->state = UNUSED;
    80001c50:	0004ac23          	sw	zero,24(s1)
        p->kstack = KSTACK((int)(p - proc));
    80001c54:	415487b3          	sub	a5,s1,s5
    80001c58:	8791                	sra	a5,a5,0x4
    80001c5a:	032787b3          	mul	a5,a5,s2
    80001c5e:	2785                	addw	a5,a5,1
    80001c60:	00d7979b          	sllw	a5,a5,0xd
    80001c64:	40f987b3          	sub	a5,s3,a5
    80001c68:	e4bc                	sd	a5,72(s1)
    for (p = proc; p < &proc[NPROC]; p++)
    80001c6a:	17048493          	add	s1,s1,368
    80001c6e:	fd449be3          	bne	s1,s4,80001c44 <procinit+0x80>
}
    80001c72:	70e2                	ld	ra,56(sp)
    80001c74:	7442                	ld	s0,48(sp)
    80001c76:	74a2                	ld	s1,40(sp)
    80001c78:	7902                	ld	s2,32(sp)
    80001c7a:	69e2                	ld	s3,24(sp)
    80001c7c:	6a42                	ld	s4,16(sp)
    80001c7e:	6aa2                	ld	s5,8(sp)
    80001c80:	6b02                	ld	s6,0(sp)
    80001c82:	6121                	add	sp,sp,64
    80001c84:	8082                	ret

0000000080001c86 <copy_array>:
{
    80001c86:	1141                	add	sp,sp,-16
    80001c88:	e422                	sd	s0,8(sp)
    80001c8a:	0800                	add	s0,sp,16
    for (int i = 0; i < len; i++)
    80001c8c:	00c05c63          	blez	a2,80001ca4 <copy_array+0x1e>
    80001c90:	87aa                	mv	a5,a0
    80001c92:	9532                	add	a0,a0,a2
        dst[i] = src[i];
    80001c94:	0007c703          	lbu	a4,0(a5)
    80001c98:	00e58023          	sb	a4,0(a1)
    for (int i = 0; i < len; i++)
    80001c9c:	0785                	add	a5,a5,1
    80001c9e:	0585                	add	a1,a1,1
    80001ca0:	fea79ae3          	bne	a5,a0,80001c94 <copy_array+0xe>
}
    80001ca4:	6422                	ld	s0,8(sp)
    80001ca6:	0141                	add	sp,sp,16
    80001ca8:	8082                	ret

0000000080001caa <cpuid>:
{
    80001caa:	1141                	add	sp,sp,-16
    80001cac:	e422                	sd	s0,8(sp)
    80001cae:	0800                	add	s0,sp,16
  asm volatile("mv %0, tp" : "=r" (x) );
    80001cb0:	8512                	mv	a0,tp
}
    80001cb2:	2501                	sext.w	a0,a0
    80001cb4:	6422                	ld	s0,8(sp)
    80001cb6:	0141                	add	sp,sp,16
    80001cb8:	8082                	ret

0000000080001cba <mycpu>:
{
    80001cba:	1141                	add	sp,sp,-16
    80001cbc:	e422                	sd	s0,8(sp)
    80001cbe:	0800                	add	s0,sp,16
    80001cc0:	8792                	mv	a5,tp
    struct cpu *c = &cpus[id];
    80001cc2:	2781                	sext.w	a5,a5
    80001cc4:	079e                	sll	a5,a5,0x7
}
    80001cc6:	0000f517          	auipc	a0,0xf
    80001cca:	faa50513          	add	a0,a0,-86 # 80010c70 <cpus>
    80001cce:	953e                	add	a0,a0,a5
    80001cd0:	6422                	ld	s0,8(sp)
    80001cd2:	0141                	add	sp,sp,16
    80001cd4:	8082                	ret

0000000080001cd6 <myproc>:
{
    ...
    80001ce4:	f0c080e7          	jalr	-244(ra) # 80000bec <push_off>
    80001ce8:	8792                	mv	a5,tp
    struct proc *p = c->proc;
    80001cea:	2781                	sext.w	a5,a5
    80001cec:	079e                	sll	a5,a5,0x7
    80001cee:	0000f717          	auipc	a4,0xf
    80001cf2:	f8270713          	add	a4,a4,-126 # 80010c70 <cpus>
    80001cf6:	97ba                	add	a5,a5,a4
    80001cf8:	6384                	ld	s1,0(a5)
    pop_off();
    80001cfa:	fffff097          	auipc	ra,0xfffff
    80001cfe:	f92080e7          	jalr	-110(ra) # 80000c8c <pop_off>
}
    80001d02:	8526                	mv	a0,s1
    80001d04:	60e2                	ld	ra,24(sp)
    80001d06:	6442                	ld	s0,16(sp)
    80001d08:	64a2                	ld	s1,8(sp)
    80001d0a:	6105                	add	sp,sp,32
    80001d0c:	8082                	ret
...
void forkret(void)
{
    ...
    80001d34:	eac080e7          	jalr	-340(ra) # 80002bdc <usertrapret>
}
    80001d38:	60a2                	ld	ra,8(sp)
    80001d3a:	6402                	ld	s0,0(sp)
    80001d3c:	0141                	add	sp,sp,16
    80001d3e:	8082                	ret
        first = 0;
    80001d40:	00007797          	auipc	a5,0x7
    80001d44:	be07a823          	sw	zero,-1040(a5) # 80008930 <first.1>
        fsinit(ROOTDEV);
    80001d48:	4505                	li	a0,1
    80001d4a:	00002097          	auipc	ra,0x2
    80001d4e:	cb0080e7          	jalr	-848(ra) # 800039fa <fsinit>
    80001d52:	bff9                	j	80001d30 <forkret+0x22>

0000000080001d54 <allocpid>:
{
    80001d54:	1101                	add	sp,sp,-32
    80001d56:	ec06                	sd	ra,24(sp)
    80001d58:	e822                	sd	s0,16(sp)
    80001d5a:	e426                	sd	s1,8(sp)
    80001d5c:	e04a                	sd	s2,0(sp)
    80001d5e:	1000                	add	s0,sp,32
    acquire(&pid_lock);
    80001d60:	0000f917          	auipc	s2,0xf
    80001d64:	31090913          	add	s2,s2,784 # 80011070 <pid_lock>
    80001d68:	854a                	mv	a0,s2
    80001d6a:	fffff097          	auipc	ra,0xfffff
    80001d6e:	ece080e7          	jalr	-306(ra) # 80000c38 <acquire>
    pid = nextpid;
    80001d72:	00007797          	auipc	a5,0x7
    80001d76:	bd678793          	add	a5,a5,-1066 # 80008948 <nextpid>
    80001d7a:	4384                	lw	s1,0(a5)
    nextpid = nextpid + 1;
    80001d7c:	0014871b          	addw	a4,s1,1
    80001d80:	c398                	sw	a4,0(a5)
    release(&pid_lock);
...
0000000080001d9a <proc_pagetable>:
{
    80001d9a:	1101                	add	sp,sp,-32
    ...
    80001dac:	5ea080e7          	jalr	1514(ra) # 80001392 <uvmcreate>
    80001db0:	84aa                	mv	s1,a0
    if (pagetable == 0)
    80001db2:	c121                	beqz	a0,80001df2 <proc_pagetable+0x58>
    if (mappages(pagetable, TRAMPOLINE, PGSIZE,
    80001db4:	4729                	li	a4,10
    80001db6:	00005697          	auipc	a3,0x5
    80001dba:	24a68693          	add	a3,a3,586 # 80007000 <_trampoline>
    80001dbe:	6605                	lui	a2,0x1
    80001dc0:	040005b7          	lui	a1,0x4000
    80001dc4:	15fd                	add	a1,a1,-1 # 3ffffff <_entry-0x7c000001>
    80001dc6:	05b2                	sll	a1,a1,0xc
    80001dc8:	fffff097          	auipc	ra,0xfffff
    80001dcc:	330080e7          	jalr	816(ra) # 800010f8 <mappages>
    80001dd0:	02054863          	bltz	a0,80001e00 <proc_pagetable+0x66>
    if (mappages(pagetable, TRAPFRAME, PGSIZE,
    80001dd4:	4719                	li	a4,6
    80001dd6:	06093683          	ld	a3,96(s2)
    80001dda:	6605                	lui	a2,0x1
    80001ddc:	020005b7          	lui	a1,0x2000
    80001de0:	15fd                	add	a1,a1,-1 # 1ffffff <_entry-0x7e000001>
    80001de2:	05b6                	sll	a1,a1,0xd
    80001de4:	8526                	mv	a0,s1
    80001de6:	fffff097          	auipc	ra,0xfffff
    80001dea:	312080e7          	jalr	786(ra) # 800010f8 <mappages>
    80001dee:	02054163          	bltz	a0,80001e10 <proc_pagetable+0x76>
}
    ...
    80001dfc:	6105                	add	sp,sp,32
    80001dfe:	8082                	ret
        uvmfree(pagetable, 0);
    80001e00:	4581                	li	a1,0
    80001e02:	8526                	mv	a0,s1
    80001e04:	fffff097          	auipc	ra,0xfffff
    80001e08:	7a0080e7          	jalr	1952(ra) # 800015a4 <uvmfree>
        return 0;
    80001e0c:	4481                	li	s1,0
    80001e0e:	b7d5                	j	80001df2 <proc_pagetable+0x58>
        uvmunmap(pagetable, TRAMPOLINE, 1, 0);
    80001e10:	4681                	li	a3,0
    80001e12:	4605                	li	a2,1
    80001e14:	040005b7          	lui	a1,0x4000
    80001e18:	15fd                	add	a1,a1,-1 # 3ffffff <_entry-0x7c000001>
    80001e1a:	05b2                	sll	a1,a1,0xc
    80001e1c:	8526                	mv	a0,s1
    80001e1e:	fffff097          	auipc	ra,0xfffff
    80001e22:	4a0080e7          	jalr	1184(ra) # 800012be <uvmunmap>
        uvmfree(pagetable, 0);
    80001e26:	4581                	li	a1,0
    80001e28:	8526                	mv	a0,s1
    80001e2a:	fffff097          	auipc	ra,0xfffff
    80001e2e:	77a080e7          	jalr	1914(ra) # 800015a4 <uvmfree>
        return 0;
    80001e32:	4481                	li	s1,0
    80001e34:	bf7d                	j	80001df2 <proc_pagetable+0x58>

0000000080001e36 <proc_freepagetable>:
{
    80001e36:	1101                	add	sp,sp,-32
    80001e38:	ec06                	sd	ra,24(sp)
    80001e3a:	e822                	sd	s0,16(sp)
    80001e3c:	e426                	sd	s1,8(sp)
    80001e3e:	e04a                	sd	s2,0(sp)
    80001e40:	1000                	add	s0,sp,32
    80001e42:	84aa                	mv	s1,a0
    80001e44:	892e                	mv	s2,a1
    uvmunmap(pagetable, TRAMPOLINE, 1, 0);
    80001e46:	4681                	li	a3,0
    80001e48:	4605                	li	a2,1
    80001e4a:	040005b7          	lui	a1,0x4000
    80001e4e:	15fd                	add	a1,a1,-1 # 3ffffff <_entry-0x7c000001>
    80001e50:	05b2                	sll	a1,a1,0xc
    80001e52:	fffff097          	auipc	ra,0xfffff
    80001e56:	46c080e7          	jalr	1132(ra) # 800012be <uvmunmap>
    uvmunmap(pagetable, TRAPFRAME, 1, 0);
    80001e5a:	4681                	li	a3,0
    80001e5c:	4605                	li	a2,1
    80001e5e:	020005b7          	lui	a1,0x2000
    80001e62:	15fd                	add	a1,a1,-1 # 1ffffff <_entry-0x7e000001>
    80001e64:	05b6                	sll	a1,a1,0xd
    80001e66:	8526                	mv	a0,s1
    80001e68:	fffff097          	auipc	ra,0xfffff
    80001e6c:	456080e7          	jalr	1110(ra) # 800012be <uvmunmap>
    uvmfree(pagetable, sz);
    80001e70:	85ca                	mv	a1,s2
    80001e72:	8526                	mv	a0,s1
    80001e74:	fffff097          	auipc	ra,0xfffff
    80001e78:	730080e7          	jalr	1840(ra) # 800015a4 <uvmfree>
}
...
0000000080001e88 <freeproc>:
{
    80001e88:	1101                	add	sp,sp,-32
    80001e8a:	ec06                	sd	ra,24(sp)
    80001e8c:	e822                	sd	s0,16(sp)
    80001e8e:	e426                	sd	s1,8(sp)
    80001e90:	1000                	add	s0,sp,32
    80001e92:	84aa                	mv	s1,a0
    if (p->trapframe)
    80001e94:	7128                	ld	a0,96(a0)
    80001e96:	c509                	beqz	a0,80001ea0 <freeproc+0x18>
        kfree((void *)p->trapframe);
    80001e98:	fffff097          	auipc	ra,0xfffff
    80001e9c:	bb2080e7          	jalr	-1102(ra) # 80000a4a <kfree>
    p->trapframe = 0;
    80001ea0:	0604b023          	sd	zero,96(s1)
    if (p->pagetable)
    80001ea4:	6ca8                	ld	a0,88(s1)
    80001ea6:	c511                	beqz	a0,80001eb2 <freeproc+0x2a>
        proc_freepagetable(p->pagetable, p->sz);
    80001ea8:	68ac                	ld	a1,80(s1)
    80001eaa:	00000097          	auipc	ra,0x0
    80001eae:	f8c080e7          	jalr	-116(ra) # 80001e36 <proc_freepagetable>
    p->pagetable = 0;
    80001eb2:	0404bc23          	sd	zero,88(s1)
    p->sz = 0;
    80001eb6:	0404b823          	sd	zero,80(s1)
    p->pid = 0;
    80001eba:	0204a823          	sw	zero,48(s1)
    p->parent = 0;
    80001ebe:	0404b023          	sd	zero,64(s1)
    p->name[0] = 0;
    80001ec2:	16048023          	sb	zero,352(s1)
    p->chan = 0;
    80001ec6:	0204b023          	sd	zero,32(s1)
    p->killed = 0;
    80001eca:	0204a423          	sw	zero,40(s1)
    p->xstate = 0;
    80001ece:	0204a623          	sw	zero,44(s1)
    p->state = UNUSED;
    80001ed2:	0004ac23          	sw	zero,24(s1)
}
...
0000000080001ee0 <allocproc>:
{
    ...
    80001ef0:	1b448493          	add	s1,s1,436 # 800110a0 <proc>
    80001ef4:	00015917          	auipc	s2,0x15
    80001ef8:	dac90913          	add	s2,s2,-596 # 80016ca0 <tickslock>
        acquire(&p->lock);
    ...
    80001f08:	cf81                	beqz	a5,80001f20 <allocproc+0x40>
            release(&p->lock);
    80001f0a:	8526                	mv	a0,s1
    80001f0c:	fffff097          	auipc	ra,0xfffff
    80001f10:	de0080e7          	jalr	-544(ra) # 80000cec <release>
    for (p = proc; p < &proc[NPROC]; p++)
    80001f14:	17048493          	add	s1,s1,368
    80001f18:	ff2492e3          	bne	s1,s2,80001efc <allocproc+0x1c>
    return 0;
    80001f1c:	4481                	li	s1,0
    80001f1e:	a889                	j	80001f70 <allocproc+0x90>
    p->pid = allocpid();
    80001f20:	00000097          	auipc	ra,0x0
    80001f24:	e34080e7          	jalr	-460(ra) # 80001d54 <allocpid>
    80001f28:	d888                	sw	a0,48(s1)
    p->state = USED;
    80001f2a:	4785                	li	a5,1
    80001f2c:	cc9c                	sw	a5,24(s1)
    if ((p->trapframe = (struct trapframe *)kalloc()) == 0)
    80001f2e:	fffff097          	auipc	ra,0xfffff
    80001f32:	c1a080e7          	jalr	-998(ra) # 80000b48 <kalloc>
    80001f36:	892a                	mv	s2,a0
    80001f38:	f0a8                	sd	a0,96(s1)
    80001f3a:	c131                	beqz	a0,80001f7e <allocproc+0x9e>
    p->pagetable = proc_pagetable(p);
    80001f3c:	8526                	mv	a0,s1
    80001f3e:	00000097          	auipc	ra,0x0
    80001f42:	e5c080e7          	jalr	-420(ra) # 80001d9a <proc_pagetable>
    80001f46:	892a                	mv	s2,a0
    80001f48:	eca8                	sd	a0,88(s1)
    if (p->pagetable == 0)
    80001f4a:	c531                	beqz	a0,80001f96 <allocproc+0xb6>
    memset(&p->context, 0, sizeof(p->context));
    80001f4c:	07000613          	li	a2,112
    80001f50:	4581                	li	a1,0
    80001f52:	06848513          	add	a0,s1,104
    80001f56:	fffff097          	auipc	ra,0xfffff
    80001f5a:	dde080e7          	jalr	-546(ra) # 80000d34 <memset>
    p->context.ra = (uint64)forkret;
    80001f5e:	00000797          	auipc	a5,0x0
    80001f62:	db078793          	add	a5,a5,-592 # 80001d0e <forkret>
    80001f66:	f4bc                	sd	a5,104(s1)
    p->context.sp = p->kstack + PGSIZE;
    80001f68:	64bc                	ld	a5,72(s1)
    80001f6a:	6705                	lui	a4,0x1
    80001f6c:	97ba                	add	a5,a5,a4
    80001f6e:	f8bc                	sd	a5,112(s1)
}
    ...
    80001f7a:	6105                	add	sp,sp,32
    80001f7c:	8082                	ret
        freeproc(p);
    80001f7e:	8526                	mv	a0,s1
    80001f80:	00000097          	auipc	ra,0x0
    80001f84:	f08080e7          	jalr	-248(ra) # 80001e88 <freeproc>
        release(&p->lock);
    80001f88:	8526                	mv	a0,s1
    80001f8a:	fffff097          	auipc	ra,0xfffff
    80001f8e:	d62080e7          	jalr	-670(ra) # 80000cec <release>
        return 0;
    80001f92:	84ca                	mv	s1,s2
    80001f94:	bff1                	j	80001f70 <allocproc+0x90>
        freeproc(p);
    80001f96:	8526                	mv	a0,s1
    80001f98:	00000097          	auipc	ra,0x0
    80001f9c:	ef0080e7          	jalr	-272(ra) # 80001e88 <freeproc>
        release(&p->lock);
    80001fa0:	8526                	mv	a0,s1
    80001fa2:	fffff097          	auipc	ra,0xfffff
    80001fa6:	d4a080e7          	jalr	-694(ra) # 80000cec <release>
        return 0;
    80001faa:	84ca                	mv	s1,s2
    80001fac:	b7d1                	j	80001f70 <allocproc+0x90>

0000000080001fae <userinit>:
{
    80001fae:	1101                	add	sp,sp,-32
    ...
    80001fbc:	f28080e7          	jalr	-216(ra) # 80001ee0 <allocproc>
    80001fc0:	84aa                	mv	s1,a0
    initproc = p;
    80001fc2:	00007797          	auipc	a5,0x7
    80001fc6:	a2a7bf23          	sd	a0,-1474(a5) # 80008a00 <initproc>
    uvmfirst(p->pagetable, initcode, sizeof(initcode));
    80001fca:	03400613          	li	a2,52
    80001fce:	00007597          	auipc	a1,0x7
    80001fd2:	98258593          	add	a1,a1,-1662 # 80008950 <initcode>
    80001fd6:	6d28                	ld	a0,88(a0)
    80001fd8:	fffff097          	auipc	ra,0xfffff
    80001fdc:	3e8080e7          	jalr	1000(ra) # 800013c0 <uvmfirst>
    p->sz = PGSIZE;
    80001fe0:	6785                	lui	a5,0x1
    80001fe2:	e8bc                	sd	a5,80(s1)
    p->trapframe->epc = 0;     // user program counter
    80001fe4:	70b8                	ld	a4,96(s1)
    80001fe6:	00073c23          	sd	zero,24(a4) # 1018 <_entry-0x7fffefe8>
    p->trapframe->sp = PGSIZE; // user stack pointer
    80001fea:	70b8                	ld	a4,96(s1)
    80001fec:	fb1c                	sd	a5,48(a4)
    safestrcpy(p->name, "initcode", sizeof(p->name));
    80001fee:	4641                	li	a2,16
    80001ff0:	00006597          	auipc	a1,0x6
    80001ff4:	1f058593          	add	a1,a1,496 # 800081e0 <etext+0x1e0>
    80001ff8:	16048513          	add	a0,s1,352
    80001ffc:	fffff097          	auipc	ra,0xfffff
    80002000:	e7a080e7          	jalr	-390(ra) # 80000e76 <safestrcpy>
    p->cwd = namei("/");
    80002004:	00006517          	auipc	a0,0x6
    80002008:	1ec50513          	add	a0,a0,492 # 800081f0 <etext+0x1f0>
    8000200c:	00002097          	auipc	ra,0x2
    80002010:	440080e7          	jalr	1088(ra) # 8000444c <namei>
...
0000000080002030 <growproc>:
{
    ...
    80002042:	c98080e7          	jalr	-872(ra) # 80001cd6 <myproc>
    80002046:	84aa                	mv	s1,a0
    sz = p->sz;
    80002048:	692c                	ld	a1,80(a0)
    if (n > 0)
    8000204a:	01204c63          	bgtz	s2,80002062 <growproc+0x32>
    else if (n < 0)
    8000204e:	02094663          	bltz	s2,8000207a <growproc+0x4a>
    p->sz = sz;
    80002052:	e8ac                	sd	a1,80(s1)
    return 0;
    ...
    80002062:	4691                	li	a3,4
    80002064:	00b90633          	add	a2,s2,a1
    80002068:	6d28                	ld	a0,88(a0)
    8000206a:	fffff097          	auipc	ra,0xfffff
    8000206e:	410080e7          	jalr	1040(ra) # 8000147a <uvmalloc>
    80002072:	85aa                	mv	a1,a0
    80002074:	fd79                	bnez	a0,80002052 <growproc+0x22>
            return -1;
    80002076:	557d                	li	a0,-1
    80002078:	bff9                	j	80002056 <growproc+0x26>
        sz = uvmdealloc(p->pagetable, sz, sz + n);
    8000207a:	00b90633          	add	a2,s2,a1
    8000207e:	6d28                	ld	a0,88(a0)
    80002080:	fffff097          	auipc	ra,0xfffff
    80002084:	3b2080e7          	jalr	946(ra) # 80001432 <uvmdealloc>
    80002088:	85aa                	mv	a1,a0
    8000208a:	b7e1                	j	80002052 <growproc+0x22>

000000008000208c <ps>:
{
    8000208c:	715d                	add	sp,sp,-80
    8000208e:	e486                	sd	ra,72(sp)
    80002090:	e0a2                	sd	s0,64(sp)
    80002092:	fc26                	sd	s1,56(sp)
    80002094:	f84a                	sd	s2,48(sp)
    80002096:	f44e                	sd	s3,40(sp)
    80002098:	f052                	sd	s4,32(sp)
    8000209a:	ec56                	sd	s5,24(sp)
    8000209c:	e85a                	sd	s6,16(sp)
    8000209e:	e45e                	sd	s7,8(sp)
    800020a0:	e062                	sd	s8,0(sp)
    800020a2:	0880                	add	s0,sp,80
    800020a4:	84aa                	mv	s1,a0
    800020a6:	8bae                	mv	s7,a1
    void *result = (void *)myproc()->sz;
    800020a8:	00000097          	auipc	ra,0x0
    800020ac:	c2e080e7          	jalr	-978(ra) # 80001cd6 <myproc>
        return result;
    800020b0:	4901                	li	s2,0
    if (count == 0)
    800020b2:	0c0b8663          	beqz	s7,8000217e <ps+0xf2>
    void *result = (void *)myproc()->sz;
    800020b6:	05053b03          	ld	s6,80(a0)
    if (growproc(count * sizeof(struct user_proc)) < 0)
    800020ba:	003b951b          	sllw	a0,s7,0x3
    800020be:	0175053b          	addw	a0,a0,s7
    800020c2:	0025151b          	sllw	a0,a0,0x2
    800020c6:	2501                	sext.w	a0,a0
    800020c8:	00000097          	auipc	ra,0x0
    800020cc:	f68080e7          	jalr	-152(ra) # 80002030 <growproc>
    800020d0:	12054f63          	bltz	a0,8000220e <ps+0x182>
    struct user_proc loc_result[count];
    800020d4:	003b9a13          	sll	s4,s7,0x3
    800020d8:	9a5e                	add	s4,s4,s7
    800020da:	0a0a                	sll	s4,s4,0x2
    800020dc:	00fa0793          	add	a5,s4,15
    800020e0:	8391                	srl	a5,a5,0x4
    800020e2:	0792                	sll	a5,a5,0x4
    800020e4:	40f10133          	sub	sp,sp,a5
    800020e8:	8a8a                	mv	s5,sp
    struct proc *p = proc + start;
    800020ea:	17000793          	li	a5,368
    800020ee:	02f484b3          	mul	s1,s1,a5
    800020f2:	0000f797          	auipc	a5,0xf
    800020f6:	fae78793          	add	a5,a5,-82 # 800110a0 <proc>
    800020fa:	94be                	add	s1,s1,a5
    if (p >= &proc[NPROC])
    800020fc:	00015797          	auipc	a5,0x15
    80002100:	ba478793          	add	a5,a5,-1116 # 80016ca0 <tickslock>
        return result;
    80002104:	4901                	li	s2,0
    if (p >= &proc[NPROC])
    80002106:	06f4fc63          	bgeu	s1,a5,8000217e <ps+0xf2>
    acquire(&wait_lock);
    8000210a:	0000f517          	auipc	a0,0xf
    8000210e:	f7e50513          	add	a0,a0,-130 # 80011088 <wait_lock>
    80002112:	fffff097          	auipc	ra,0xfffff
    80002116:	b26080e7          	jalr	-1242(ra) # 80000c38 <acquire>
        if (localCount == count)
    8000211a:	014a8913          	add	s2,s5,20
    uint8 localCount = 0;
    8000211e:	4981                	li	s3,0
    for (; p < &proc[NPROC]; p++)
    80002120:	00015c17          	auipc	s8,0x15
    80002124:	b80c0c13          	add	s8,s8,-1152 # 80016ca0 <tickslock>
    80002128:	a851                	j	800021bc <ps+0x130>
            loc_result[localCount].state = UNUSED;
    8000212a:	00399793          	sll	a5,s3,0x3
    8000212e:	97ce                	add	a5,a5,s3
    80002130:	078a                	sll	a5,a5,0x2
    80002132:	97d6                	add	a5,a5,s5
    80002134:	0007a023          	sw	zero,0(a5)
            release(&p->lock);
    80002138:	8526                	mv	a0,s1
    8000213a:	fffff097          	auipc	ra,0xfffff
    8000213e:	bb2080e7          	jalr	-1102(ra) # 80000cec <release>
    release(&wait_lock);
    80002142:	0000f517          	auipc	a0,0xf
    80002146:	f4650513          	add	a0,a0,-186 # 80011088 <wait_lock>
    8000214a:	fffff097          	auipc	ra,0xfffff
    8000214e:	ba2080e7          	jalr	-1118(ra) # 80000cec <release>
    if (localCount < count)
    80002152:	0179f963          	bgeu	s3,s7,80002164 <ps+0xd8>
        loc_result[localCount].state = UNUSED; // if we reach the end of processes
    80002156:	00399793          	sll	a5,s3,0x3
    8000215a:	97ce                	add	a5,a5,s3
    8000215c:	078a                	sll	a5,a5,0x2
    ...
    8000216a:	b70080e7          	jalr	-1168(ra) # 80001cd6 <myproc>
    8000216e:	86d2                	mv	a3,s4
    80002170:	8656                	mv	a2,s5
    80002172:	85da                	mv	a1,s6
    80002174:	6d28                	ld	a0,88(a0)
    80002176:	fffff097          	auipc	ra,0xfffff
    8000217a:	56c080e7          	jalr	1388(ra) # 800016e2 <copyout>
}
    8000217e:	854a                	mv	a0,s2
    80002180:	fb040113          	add	sp,s0,-80
    ...
    80002198:	6161                	add	sp,sp,80
    8000219a:	8082                	ret
        release(&p->lock);
    8000219c:	8526                	mv	a0,s1
    8000219e:	fffff097          	auipc	ra,0xfffff
    800021a2:	b4e080e7          	jalr	-1202(ra) # 80000cec <release>
        localCount++;
    800021a6:	2985                	addw	s3,s3,1
    800021a8:	0ff9f993          	zext.b	s3,s3
    for (; p < &proc[NPROC]; p++)
    800021ac:	17048493          	add	s1,s1,368
    800021b0:	f984f9e3          	bgeu	s1,s8,80002142 <ps+0xb6>
        if (localCount == count)
    800021b4:	02490913          	add	s2,s2,36
    800021b8:	053b8d63          	beq	s7,s3,80002212 <ps+0x186>
        acquire(&p->lock);
    800021bc:	8526                	mv	a0,s1
    800021be:	fffff097          	auipc	ra,0xfffff
    800021c2:	a7a080e7          	jalr	-1414(ra) # 80000c38 <acquire>
        if (p->state == UNUSED)
    800021c6:	4c9c                	lw	a5,24(s1)
    800021c8:	d3ad                	beqz	a5,8000212a <ps+0x9e>
    ...
    800021e4:	16048513          	add	a0,s1,352
    800021e8:	00000097          	auipc	ra,0x0
    800021ec:	a9e080e7          	jalr	-1378(ra) # 80001c86 <copy_array>
        if (p->parent != 0) // init
    800021f0:	60a8                	ld	a0,64(s1)
    800021f2:	d54d                	beqz	a0,8000219c <ps+0x110>
            acquire(&p->parent->lock);
    800021f4:	fffff097          	auipc	ra,0xfffff
    800021f8:	a44080e7          	jalr	-1468(ra) # 80000c38 <acquire>
            loc_result[localCount].parent_id = p->parent->pid;
    800021fc:	60a8                	ld	a0,64(s1)
    800021fe:	591c                	lw	a5,48(a0)
    80002200:	fef92e23          	sw	a5,-4(s2)
            release(&p->parent->lock);
    80002204:	fffff097          	auipc	ra,0xfffff
    80002208:	ae8080e7          	jalr	-1304(ra) # 80000cec <release>
    8000220c:	bf41                	j	8000219c <ps+0x110>
        return result;
    8000220e:	4901                	li	s2,0
    80002210:	b7bd                	j	8000217e <ps+0xf2>
    release(&wait_lock);
    80002212:	0000f517          	auipc	a0,0xf
    80002216:	e7650513          	add	a0,a0,-394 # 80011088 <wait_lock>
    8000221a:	fffff097          	auipc	ra,0xfffff
    8000221e:	ad2080e7          	jalr	-1326(ra) # 80000cec <release>
    if (localCount < count)
    80002222:	b789                	j	80002164 <ps+0xd8>

0000000080002224 <fork>:
{
    80002224:	7139                	add	sp,sp,-64
    80002226:	fc06                	sd	ra,56(sp)
    80002228:	f822                	sd	s0,48(sp)
    8000222a:	f04a                	sd	s2,32(sp)
    8000222c:	e456                	sd	s5,8(sp)
    8000222e:	0080                	add	s0,sp,64
    struct proc *p = myproc();
    80002230:	00000097          	auipc	ra,0x0
    80002234:	aa6080e7          	jalr	-1370(ra) # 80001cd6 <myproc>
    80002238:	8aaa                	mv	s5,a0
    if ((np = allocproc()) == 0)
    8000223a:	00000097          	auipc	ra,0x0
    8000223e:	ca6080e7          	jalr	-858(ra) # 80001ee0 <allocproc>
    80002242:	12050063          	beqz	a0,80002362 <fork+0x13e>
    80002246:	e852                	sd	s4,16(sp)
    80002248:	8a2a                	mv	s4,a0
    if (uvmcopy(p->pagetable, np->pagetable, p->sz) < 0)
    8000224a:	050ab603          	ld	a2,80(s5)
    8000224e:	6d2c                	ld	a1,88(a0)
    80002250:	058ab503          	ld	a0,88(s5)
    80002254:	fffff097          	auipc	ra,0xfffff
    80002258:	38a080e7          	jalr	906(ra) # 800015de <uvmcopy>
    8000225c:	04054a63          	bltz	a0,800022b0 <fork+0x8c>
    80002260:	f426                	sd	s1,40(sp)
    80002262:	ec4e                	sd	s3,24(sp)
    np->sz = p->sz;
    80002264:	050ab783          	ld	a5,80(s5)
    80002268:	04fa3823          	sd	a5,80(s4)
    *(np->trapframe) = *(p->trapframe);
    8000226c:	060ab683          	ld	a3,96(s5)
    80002270:	87b6                	mv	a5,a3
    80002272:	060a3703          	ld	a4,96(s4)
    80002276:	12068693          	add	a3,a3,288
    ...
    8000228e:	02078793          	add	a5,a5,32
    80002292:	02070713          	add	a4,a4,32
    80002296:	fed792e3          	bne	a5,a3,8000227a <fork+0x56>
    np->trapframe->a0 = 0;
    8000229a:	060a3783          	ld	a5,96(s4)
    8000229e:	0607b823          	sd	zero,112(a5)
    for (i = 0; i < NOFILE; i++)
    800022a2:	0d8a8493          	add	s1,s5,216
    800022a6:	0d8a0913          	add	s2,s4,216
    800022aa:	158a8993          	add	s3,s5,344
    800022ae:	a015                	j	800022d2 <fork+0xae>
        freeproc(np);
    800022b0:	8552                	mv	a0,s4
    800022b2:	00000097          	auipc	ra,0x0
    800022b6:	bd6080e7          	jalr	-1066(ra) # 80001e88 <freeproc>
        release(&np->lock);
    800022ba:	8552                	mv	a0,s4
    800022bc:	fffff097          	auipc	ra,0xfffff
    800022c0:	a30080e7          	jalr	-1488(ra) # 80000cec <release>
        return -1;
    800022c4:	597d                	li	s2,-1
    800022c6:	6a42                	ld	s4,16(sp)
    800022c8:	a071                	j	80002354 <fork+0x130>
    for (i = 0; i < NOFILE; i++)
    800022ca:	04a1                	add	s1,s1,8
    800022cc:	0921                	add	s2,s2,8
    800022ce:	01348b63          	beq	s1,s3,800022e4 <fork+0xc0>
        if (p->ofile[i])
    800022d2:	6088                	ld	a0,0(s1)
    800022d4:	d97d                	beqz	a0,800022ca <fork+0xa6>
            np->ofile[i] = filedup(p->ofile[i]);
    800022d6:	00002097          	auipc	ra,0x2
    800022da:	7ee080e7          	jalr	2030(ra) # 80004ac4 <filedup>
    800022de:	00a93023          	sd	a0,0(s2)
    800022e2:	b7e5                	j	800022ca <fork+0xa6>
    np->cwd = idup(p->cwd);
    800022e4:	158ab503          	ld	a0,344(s5)
    800022e8:	00002097          	auipc	ra,0x2
    800022ec:	958080e7          	jalr	-1704(ra) # 80003c40 <idup>
    800022f0:	14aa3c23          	sd	a0,344(s4)
    safestrcpy(np->name, p->name, sizeof(p->name));
    800022f4:	4641                	li	a2,16
    800022f6:	160a8593          	add	a1,s5,352
    800022fa:	160a0513          	add	a0,s4,352
    800022fe:	fffff097          	auipc	ra,0xfffff
    80002302:	b78080e7          	jalr	-1160(ra) # 80000e76 <safestrcpy>
    pid = np->pid;
    80002306:	030a2903          	lw	s2,48(s4)
    release(&np->lock);
    ...
    80002318:	d7448493          	add	s1,s1,-652 # 80011088 <wait_lock>
    8000231c:	8526                	mv	a0,s1
    8000231e:	fffff097          	auipc	ra,0xfffff
    80002322:	91a080e7          	jalr	-1766(ra) # 80000c38 <acquire>
    np->parent = p;
    80002326:	055a3023          	sd	s5,64(s4)
    release(&wait_lock);
    ...
    8000233a:	902080e7          	jalr	-1790(ra) # 80000c38 <acquire>
    np->state = RUNNABLE;
    8000233e:	478d                	li	a5,3
    80002340:	00fa2c23          	sw	a5,24(s4)
    release(&np->lock);
    ...
    8000235e:	6121                	add	sp,sp,64
    80002360:	8082                	ret
        return -1;
    80002362:	597d                	li	s2,-1
    80002364:	bfc5                	j	80002354 <fork+0x130>

0000000080002366 <scheduler>:
{
    80002366:	1101                	add	sp,sp,-32
    80002368:	ec06                	sd	ra,24(sp)
    8000236a:	e822                	sd	s0,16(sp)
    8000236c:	e426                	sd	s1,8(sp)
    8000236e:	1000                	add	s0,sp,32
        (*sched_pointer)();
    80002370:	00006497          	auipc	s1,0x6
    80002374:	5d048493          	add	s1,s1,1488 # 80008940 <sched_pointer>
    80002378:	609c                	ld	a5,0(s1)
    8000237a:	9782                	jalr	a5
    while (1)
    8000237c:	bff5                	j	80002378 <scheduler+0x12>

000000008000237e <sched>:
{
    8000237e:	7179                	add	sp,sp,-48
    ...
    8000238a:	1800                	add	s0,sp,48
    struct proc *p = myproc();
    8000238c:	00000097          	auipc	ra,0x0
    80002390:	94a080e7          	jalr	-1718(ra) # 80001cd6 <myproc>
    80002394:	84aa                	mv	s1,a0
    if (!holding(&p->lock))
    80002396:	fffff097          	auipc	ra,0xfffff
    8000239a:	828080e7          	jalr	-2008(ra) # 80000bbe <holding>
    8000239e:	c53d                	beqz	a0,8000240c <sched+0x8e>
    800023a0:	8792                	mv	a5,tp
    if (mycpu()->noff != 1)
    800023a2:	2781                	sext.w	a5,a5
    800023a4:	079e                	sll	a5,a5,0x7
    800023a6:	0000f717          	auipc	a4,0xf
    800023aa:	8ca70713          	add	a4,a4,-1846 # 80010c70 <cpus>
    800023ae:	97ba                	add	a5,a5,a4
    800023b0:	5fb8                	lw	a4,120(a5)
    800023b2:	4785                	li	a5,1
    800023b4:	06f71463          	bne	a4,a5,8000241c <sched+0x9e>
    if (p->state == RUNNING)
    800023b8:	4c98                	lw	a4,24(s1)
    800023ba:	4791                	li	a5,4
    800023bc:	06f70863          	beq	a4,a5,8000242c <sched+0xae>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800023c0:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800023c4:	8b89                	and	a5,a5,2
    if (intr_get())
    800023c6:	ebbd                	bnez	a5,8000243c <sched+0xbe>
  asm volatile("mv %0, tp" : "=r" (x) );
    800023c8:	8792                	mv	a5,tp
    intena = mycpu()->intena;
    800023ca:	0000f917          	auipc	s2,0xf
    800023ce:	8a690913          	add	s2,s2,-1882 # 80010c70 <cpus>
    800023d2:	2781                	sext.w	a5,a5
    800023d4:	079e                	sll	a5,a5,0x7
    800023d6:	97ca                	add	a5,a5,s2
    800023d8:	07c7a983          	lw	s3,124(a5)
    800023dc:	8592                	mv	a1,tp
    swtch(&p->context, &mycpu()->context);
    800023de:	2581                	sext.w	a1,a1
    800023e0:	059e                	sll	a1,a1,0x7
    800023e2:	05a1                	add	a1,a1,8
    800023e4:	95ca                	add	a1,a1,s2
    800023e6:	06848513          	add	a0,s1,104
    800023ea:	00000097          	auipc	ra,0x0
    800023ee:	748080e7          	jalr	1864(ra) # 80002b32 <swtch>
    800023f2:	8792                	mv	a5,tp
    mycpu()->intena = intena;
    800023f4:	2781                	sext.w	a5,a5
    800023f6:	079e                	sll	a5,a5,0x7
    800023f8:	993e                	add	s2,s2,a5
    800023fa:	07392e23          	sw	s3,124(s2)
}
...
000000008000244c <yield>:
{
    ...
    8000245a:	880080e7          	jalr	-1920(ra) # 80001cd6 <myproc>
    ...
    80002470:	f12080e7          	jalr	-238(ra) # 8000237e <sched>
    release(&p->lock);
    80002474:	8526                	mv	a0,s1
    80002476:	fffff097          	auipc	ra,0xfffff
    8000247a:	876080e7          	jalr	-1930(ra) # 80000cec <release>
}
...
void sleep(void *chan, struct spinlock *lk)
{
    ...
    8000249e:	83c080e7          	jalr	-1988(ra) # 80001cd6 <myproc>
    ...
    800024a8:	794080e7          	jalr	1940(ra) # 80000c38 <acquire>
    release(lk);
    800024ac:	854a                	mv	a0,s2
    800024ae:	fffff097          	auipc	ra,0xfffff
    800024b2:	83e080e7          	jalr	-1986(ra) # 80000cec <release>
    ...
    800024c2:	ec0080e7          	jalr	-320(ra) # 8000237e <sched>
...
void wakeup(void *chan)
{
    ...
    800024fc:	0080                	add	s0,sp,64
    800024fe:	8a2a                	mv	s4,a0
    struct proc *p;

    for (p = proc; p < &proc[NPROC]; p++)
    80002500:	0000f497          	auipc	s1,0xf
    80002504:	ba048493          	add	s1,s1,-1120 # 800110a0 <proc>
    {
        if (p != myproc())
        {
            acquire(&p->lock);
    ...
    for (p = proc; p < &proc[NPROC]; p++)
    8000250c:	00014917          	auipc	s2,0x14
    80002510:	79490913          	add	s2,s2,1940 # 80016ca0 <tickslock>
    ...
    8000255e:	6121                	add	sp,sp,64
    80002560:	8082                	ret

0000000080002562 <reparent>:
{
    80002562:	7179                	add	sp,sp,-48
    ...
    80002578:	b2c48493          	add	s1,s1,-1236 # 800110a0 <proc>
            pp->parent = initproc;
    8000257c:	00006a17          	auipc	s4,0x6
    80002580:	484a0a13          	add	s4,s4,1156 # 80008a00 <initproc>
    for (pp = proc; pp < &proc[NPROC]; pp++)
    80002584:	00014997          	auipc	s3,0x14
    80002588:	71c98993          	add	s3,s3,1820 # 80016ca0 <tickslock>
    8000258c:	a029                	j	80002596 <reparent+0x34>
    8000258e:	17048493          	add	s1,s1,368
    80002592:	01348d63          	beq	s1,s3,800025ac <reparent+0x4a>
        if (pp->parent == p)
    80002596:	60bc                	ld	a5,64(s1)
    80002598:	ff279be3          	bne	a5,s2,8000258e <reparent+0x2c>
            pp->parent = initproc;
    8000259c:	000a3503          	ld	a0,0(s4)
    800025a0:	e0a8                	sd	a0,64(s1)
            wakeup(initproc);
    ...
    800025b8:	6145                	add	sp,sp,48
    800025ba:	8082                	ret

00000000800025bc <exit>:
{
    800025bc:	7179                	add	sp,sp,-48
    ...
    800025d2:	708080e7          	jalr	1800(ra) # 80001cd6 <myproc>
    800025d6:	89aa                	mv	s3,a0
    if (p == initproc)
    800025d8:	00006797          	auipc	a5,0x6
    800025dc:	4287b783          	ld	a5,1064(a5) # 80008a00 <initproc>
    800025e0:	0d850493          	add	s1,a0,216
    800025e4:	15850913          	add	s2,a0,344
    800025e8:	02a79363          	bne	a5,a0,8000260e <exit+0x52>
        panic("init exiting");
    800025ec:	00006517          	auipc	a0,0x6
    800025f0:	c5450513          	add	a0,a0,-940 # 80008240 <etext+0x240>
    800025f4:	ffffe097          	auipc	ra,0xffffe
    800025f8:	f6c080e7          	jalr	-148(ra) # 80000560 <panic>
            fileclose(f);
    800025fc:	00002097          	auipc	ra,0x2
    80002600:	51a080e7          	jalr	1306(ra) # 80004b16 <fileclose>
            p->ofile[fd] = 0;
    80002604:	0004b023          	sd	zero,0(s1)
    for (int fd = 0; fd < NOFILE; fd++)
    80002608:	04a1                	add	s1,s1,8
    8000260a:	01248563          	beq	s1,s2,80002614 <exit+0x58>
        if (p->ofile[fd])
    8000260e:	6088                	ld	a0,0(s1)
    80002610:	f575                	bnez	a0,800025fc <exit+0x40>
    80002612:	bfdd                	j	80002608 <exit+0x4c>
    begin_op();
    80002614:	00002097          	auipc	ra,0x2
    80002618:	038080e7          	jalr	56(ra) # 8000464c <begin_op>
    iput(p->cwd);
    8000261c:	1589b503          	ld	a0,344(s3)
    80002620:	00002097          	auipc	ra,0x2
    80002624:	81c080e7          	jalr	-2020(ra) # 80003e3c <iput>
    end_op();
    80002628:	00002097          	auipc	ra,0x2
    8000262c:	09e080e7          	jalr	158(ra) # 800046c6 <end_op>
    p->cwd = 0;
    80002630:	1409bc23          	sd	zero,344(s3)
    acquire(&wait_lock);
    80002634:	0000f497          	auipc	s1,0xf
    80002638:	a5448493          	add	s1,s1,-1452 # 80011088 <wait_lock>
    8000263c:	8526                	mv	a0,s1
    8000263e:	ffffe097          	auipc	ra,0xffffe
    80002642:	5fa080e7          	jalr	1530(ra) # 80000c38 <acquire>
    reparent(p);
    80002646:	854e                	mv	a0,s3
    80002648:	00000097          	auipc	ra,0x0
    8000264c:	f1a080e7          	jalr	-230(ra) # 80002562 <reparent>
    wakeup(p->parent);
    80002650:	0409b503          	ld	a0,64(s3)
    ...
    80002662:	5da080e7          	jalr	1498(ra) # 80000c38 <acquire>
    p->xstate = status;
    ...
    80002676:	67a080e7          	jalr	1658(ra) # 80000cec <release>
    sched();
    8000267a:	00000097          	auipc	ra,0x0
    8000267e:	d04080e7          	jalr	-764(ra) # 8000237e <sched>
    panic("zombie exit");
    80002682:	00006517          	auipc	a0,0x6
    80002686:	bce50513          	add	a0,a0,-1074 # 80008250 <etext+0x250>
    8000268a:	ffffe097          	auipc	ra,0xffffe
    8000268e:	ed6080e7          	jalr	-298(ra) # 80000560 <panic>
...
int kill(int pid)
{
    ...
    8000269e:	1800                	add	s0,sp,48
    800026a0:	892a                	mv	s2,a0
    struct proc *p;

    for (p = proc; p < &proc[NPROC]; p++)
    800026a2:	0000f497          	auipc	s1,0xf
    800026a6:	9fe48493          	add	s1,s1,-1538 # 800110a0 <proc>
    800026aa:	00014997          	auipc	s3,0x14
    800026ae:	5f698993          	add	s3,s3,1526 # 80016ca0 <tickslock>
    {
        acquire(&p->lock);
    800026b2:	8526                	mv	a0,s1
    800026b4:	ffffe097          	auipc	ra,0xffffe
    800026b8:	584080e7          	jalr	1412(ra) # 80000c38 <acquire>
        if (p->pid == pid)
    800026bc:	589c                	lw	a5,48(s1)
    ...
    800026c8:	628080e7          	jalr	1576(ra) # 80000cec <release>
    for (p = proc; p < &proc[NPROC]; p++)
    800026cc:	17048493          	add	s1,s1,368
    800026d0:	ff3491e3          	bne	s1,s3,800026b2 <kill+0x20>
    }
    return -1;
    800026d4:	557d                	li	a0,-1
    800026d6:	a829                	j	800026f0 <kill+0x5e>
            p->killed = 1;
    800026d8:	4785                	li	a5,1
    800026da:	d49c                	sw	a5,40(s1)
            if (p->state == SLEEPING)
    800026dc:	4c98                	lw	a4,24(s1)
    800026de:	4789                	li	a5,2
    800026e0:	00f70f63          	beq	a4,a5,800026fe <kill+0x6c>
            release(&p->lock);
    800026e4:	8526                	mv	a0,s1
    800026e6:	ffffe097          	auipc	ra,0xffffe
    800026ea:	606080e7          	jalr	1542(ra) # 80000cec <release>
            return 0;
    ...
    800026fc:	8082                	ret
                p->state = RUNNABLE;
    800026fe:	478d                	li	a5,3
    80002700:	cc9c                	sw	a5,24(s1)
    80002702:	b7cd                	j	800026e4 <kill+0x52>

0000000080002704 <setkilled>:
...
void setkilled(struct proc *p)
{
    ...
    8000271a:	d49c                	sw	a5,40(s1)
    release(&p->lock);
    8000271c:	8526                	mv	a0,s1
    8000271e:	ffffe097          	auipc	ra,0xffffe
    80002722:	5ce080e7          	jalr	1486(ra) # 80000cec <release>
}
    80002726:	60e2                	ld	ra,24(sp)
    80002728:	6442                	ld	s0,16(sp)
    8000272a:	64a2                	ld	s1,8(sp)
    8000272c:	6105                	add	sp,sp,32
    8000272e:	8082                	ret

0000000080002730 <killed>:

int killed(struct proc *p)
{
    80002730:	1101                	add	sp,sp,-32
    ...
    80002742:	4fa080e7          	jalr	1274(ra) # 80000c38 <acquire>
    k = p->killed;
    80002746:	0284a903          	lw	s2,40(s1)
    release(&p->lock);
    8000274a:	8526                	mv	a0,s1
    8000274c:	ffffe097          	auipc	ra,0xffffe
    80002750:	5a0080e7          	jalr	1440(ra) # 80000cec <release>
    return k;
}
    ...
    8000275e:	6105                	add	sp,sp,32
    80002760:	8082                	ret

0000000080002762 <wait>:
{
    80002762:	715d                	add	sp,sp,-80
    80002764:	e486                	sd	ra,72(sp)
    80002766:	e0a2                	sd	s0,64(sp)
    80002768:	fc26                	sd	s1,56(sp)
    8000276a:	f84a                	sd	s2,48(sp)
    8000276c:	f44e                	sd	s3,40(sp)
    8000276e:	f052                	sd	s4,32(sp)
    80002770:	ec56                	sd	s5,24(sp)
    80002772:	e85a                	sd	s6,16(sp)
    80002774:	e45e                	sd	s7,8(sp)
    80002776:	e062                	sd	s8,0(sp)
    80002778:	0880                	add	s0,sp,80
    8000277a:	8b2a                	mv	s6,a0
    struct proc *p = myproc();
    8000277c:	fffff097          	auipc	ra,0xfffff
    80002780:	55a080e7          	jalr	1370(ra) # 80001cd6 <myproc>
    80002784:	892a                	mv	s2,a0
    acquire(&wait_lock);
    80002786:	0000f517          	auipc	a0,0xf
    8000278a:	90250513          	add	a0,a0,-1790 # 80011088 <wait_lock>
    8000278e:	ffffe097          	auipc	ra,0xffffe
    80002792:	4aa080e7          	jalr	1194(ra) # 80000c38 <acquire>
        havekids = 0;
    80002796:	4b81                	li	s7,0
                if (pp->state == ZOMBIE)
    80002798:	4a15                	li	s4,5
                havekids = 1;
    8000279a:	4a85                	li	s5,1
        for (pp = proc; pp < &proc[NPROC]; pp++)
    8000279c:	00014997          	auipc	s3,0x14
    800027a0:	50498993          	add	s3,s3,1284 # 80016ca0 <tickslock>
        sleep(p, &wait_lock); // DOC: wait-sleep
    800027a4:	0000fc17          	auipc	s8,0xf
    800027a8:	8e4c0c13          	add	s8,s8,-1820 # 80011088 <wait_lock>
    800027ac:	a0d1                	j	80002870 <wait+0x10e>
                    pid = pp->pid;
    800027ae:	0304a983          	lw	s3,48(s1)
                    if (addr != 0 && copyout(p->pagetable, addr, (char *)&pp->xstate,
    800027b2:	000b0e63          	beqz	s6,800027ce <wait+0x6c>
    800027b6:	4691                	li	a3,4
    800027b8:	02c48613          	add	a2,s1,44
    800027bc:	85da                	mv	a1,s6
    800027be:	05893503          	ld	a0,88(s2)
    800027c2:	fffff097          	auipc	ra,0xfffff
    800027c6:	f20080e7          	jalr	-224(ra) # 800016e2 <copyout>
    800027ca:	04054163          	bltz	a0,8000280c <wait+0xaa>
                    freeproc(pp);
    800027ce:	8526                	mv	a0,s1
    800027d0:	fffff097          	auipc	ra,0xfffff
    800027d4:	6b8080e7          	jalr	1720(ra) # 80001e88 <freeproc>
                    release(&pp->lock);
    ...
    800027e6:	8a650513          	add	a0,a0,-1882 # 80011088 <wait_lock>
    800027ea:	ffffe097          	auipc	ra,0xffffe
    800027ee:	502080e7          	jalr	1282(ra) # 80000cec <release>
}
    800027f2:	854e                	mv	a0,s3
    800027f4:	60a6                	ld	ra,72(sp)
    800027f6:	6406                	ld	s0,64(sp)
    800027f8:	74e2                	ld	s1,56(sp)
    800027fa:	7942                	ld	s2,48(sp)
    800027fc:	79a2                	ld	s3,40(sp)
    800027fe:	7a02                	ld	s4,32(sp)
    80002800:	6ae2                	ld	s5,24(sp)
    80002802:	6b42                	ld	s6,16(sp)
    80002804:	6ba2                	ld	s7,8(sp)
    80002806:	6c02                	ld	s8,0(sp)
    80002808:	6161                	add	sp,sp,80
    8000280a:	8082                	ret
                        release(&pp->lock);
    ...
    8000281a:	87250513          	add	a0,a0,-1934 # 80011088 <wait_lock>
    8000281e:	ffffe097          	auipc	ra,0xffffe
    80002822:	4ce080e7          	jalr	1230(ra) # 80000cec <release>
                        return -1;
    80002826:	59fd                	li	s3,-1
    80002828:	b7e9                	j	800027f2 <wait+0x90>
        for (pp = proc; pp < &proc[NPROC]; pp++)
    8000282a:	17048493          	add	s1,s1,368
    8000282e:	03348463          	beq	s1,s3,80002856 <wait+0xf4>
            if (pp->parent == p)
    80002832:	60bc                	ld	a5,64(s1)
    80002834:	ff279be3          	bne	a5,s2,8000282a <wait+0xc8>
                acquire(&pp->lock);
    80002838:	8526                	mv	a0,s1
    8000283a:	ffffe097          	auipc	ra,0xffffe
    8000283e:	3fe080e7          	jalr	1022(ra) # 80000c38 <acquire>
                if (pp->state == ZOMBIE)
    80002842:	4c9c                	lw	a5,24(s1)
    80002844:	f74785e3          	beq	a5,s4,800027ae <wait+0x4c>
                release(&pp->lock);
    80002848:	8526                	mv	a0,s1
    8000284a:	ffffe097          	auipc	ra,0xffffe
    8000284e:	4a2080e7          	jalr	1186(ra) # 80000cec <release>
                havekids = 1;
    80002852:	8756                	mv	a4,s5
    80002854:	bfd9                	j	8000282a <wait+0xc8>
        if (!havekids || killed(p))
    80002856:	c31d                	beqz	a4,8000287c <wait+0x11a>
    80002858:	854a                	mv	a0,s2
    8000285a:	00000097          	auipc	ra,0x0
    8000285e:	ed6080e7          	jalr	-298(ra) # 80002730 <killed>
    80002862:	ed09                	bnez	a0,8000287c <wait+0x11a>
        sleep(p, &wait_lock); // DOC: wait-sleep
    80002864:	85e2                	mv	a1,s8
    80002866:	854a                	mv	a0,s2
    80002868:	00000097          	auipc	ra,0x0
    8000286c:	c20080e7          	jalr	-992(ra) # 80002488 <sleep>
        havekids = 0;
    80002870:	875e                	mv	a4,s7
        for (pp = proc; pp < &proc[NPROC]; pp++)
    80002872:	0000f497          	auipc	s1,0xf
    80002876:	82e48493          	add	s1,s1,-2002 # 800110a0 <proc>
    8000287a:	bf65                	j	80002832 <wait+0xd0>
            release(&wait_lock);
    8000287c:	0000f517          	auipc	a0,0xf
    80002880:	80c50513          	add	a0,a0,-2036 # 80011088 <wait_lock>
    80002884:	ffffe097          	auipc	ra,0xffffe
    80002888:	468080e7          	jalr	1128(ra) # 80000cec <release>
            return -1;
    8000288c:	59fd                	li	s3,-1
    8000288e:	b795                	j	800027f2 <wait+0x90>

0000000080002890 <either_copyout>:
...
int either_copyout(int user_dst, uint64 dst, void *src, uint64 len)
{
    ...
    800028de:	4b6080e7          	jalr	1206(ra) # 80000d90 <memmove>
        return 0;
    800028e2:	8526                	mv	a0,s1
    800028e4:	bff9                	j	800028c2 <either_copyout+0x32>

00000000800028e6 <either_copyin>:
...
int either_copyin(void *dst, int user_src, uint64 src, uint64 len)
{
    ...
    80002902:	3d8080e7          	jalr	984(ra) # 80001cd6 <myproc>
    if (user_src)
    80002906:	c08d                	beqz	s1,80002928 <either_copyin+0x42>
    {
        return copyin(p->pagetable, dst, src, len);
    80002908:	86d2                	mv	a3,s4
    8000290a:	864e                	mv	a2,s3
    8000290c:	85ca                	mv	a1,s2
    8000290e:	6d28                	ld	a0,88(a0)
    80002910:	fffff097          	auipc	ra,0xfffff
    80002914:	e5e080e7          	jalr	-418(ra) # 8000176e <copyin>
    else
    {
    ...
    80002934:	460080e7          	jalr	1120(ra) # 80000d90 <memmove>
        return 0;
    80002938:	8526                	mv	a0,s1
    8000293a:	bff9                	j	80002918 <either_copyin+0x32>

000000008000293c <procdump>:
...
void procdump(void)
{
    ...
    80002956:	6be50513          	add	a0,a0,1726 # 80008010 <etext+0x10>
    8000295a:	ffffe097          	auipc	ra,0xffffe
    8000295e:	c50080e7          	jalr	-944(ra) # 800005aa <printf>
    for (p = proc; p < &proc[NPROC]; p++)
    80002962:	0000f497          	auipc	s1,0xf
    80002966:	89e48493          	add	s1,s1,-1890 # 80011200 <proc+0x160>
    8000296a:	00014917          	auipc	s2,0x14
    8000296e:	49690913          	add	s2,s2,1174 # 80016e00 <bcache+0x148>
    {
        if (p->state == UNUSED)
            continue;
    ...
    80002978:	8ec98993          	add	s3,s3,-1812 # 80008260 <etext+0x260>
        printf("%d <%s %s", p->pid, state, p->name);
    8000297c:	00006a97          	auipc	s5,0x6
    80002980:	8eca8a93          	add	s5,s5,-1812 # 80008268 <etext+0x268>
        printf("\n");
    80002984:	00005a17          	auipc	s4,0x5
    80002988:	68ca0a13          	add	s4,s4,1676 # 80008010 <etext+0x10>
        if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
    8000298c:	00006b97          	auipc	s7,0x6
    80002990:	e84b8b93          	add	s7,s7,-380 # 80008810 <states.0>
    80002994:	a00d                	j	800029b6 <procdump+0x7a>
        printf("%d <%s %s", p->pid, state, p->name);
    80002996:	ed06a583          	lw	a1,-304(a3)
    8000299a:	8556                	mv	a0,s5
    8000299c:	ffffe097          	auipc	ra,0xffffe
    800029a0:	c0e080e7          	jalr	-1010(ra) # 800005aa <printf>
        printf("\n");
    800029a4:	8552                	mv	a0,s4
    800029a6:	ffffe097          	auipc	ra,0xffffe
    800029aa:	c04080e7          	jalr	-1020(ra) # 800005aa <printf>
    for (p = proc; p < &proc[NPROC]; p++)
    800029ae:	17048493          	add	s1,s1,368
    800029b2:	03248263          	beq	s1,s2,800029d6 <procdump+0x9a>
        if (p->state == UNUSED)
    800029b6:	86a6                	mv	a3,s1
    800029b8:	eb84a783          	lw	a5,-328(s1)
    800029bc:	dbed                	beqz	a5,800029ae <procdump+0x72>
            state = "???";
    800029be:	864e                	mv	a2,s3
        if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
    800029c0:	fcfb6be3          	bltu	s6,a5,80002996 <procdump+0x5a>
    800029c4:	02079713          	sll	a4,a5,0x20
    800029c8:	01d75793          	srl	a5,a4,0x1d
    800029cc:	97de                	add	a5,a5,s7
    800029ce:	6390                	ld	a2,0(a5)
    800029d0:	f279                	bnez	a2,80002996 <procdump+0x5a>
            state = "???";
    800029d2:	864e                	mv	a2,s3
    800029d4:	b7c9                	j	80002996 <procdump+0x5a>
    }
}
    ...
    800029e8:	6161                	add	sp,sp,80
    800029ea:	8082                	ret

00000000800029ec <schedls>:
...
void schedls()
{
    ...
    800029fa:	88250513          	add	a0,a0,-1918 # 80008278 <etext+0x278>
    800029fe:	ffffe097          	auipc	ra,0xffffe
    80002a02:	bac080e7          	jalr	-1108(ra) # 800005aa <printf>
    printf("====================================\n");
    80002a06:	00006517          	auipc	a0,0x6
    80002a0a:	89a50513          	add	a0,a0,-1894 # 800082a0 <etext+0x2a0>
    80002a0e:	ffffe097          	auipc	ra,0xffffe
    80002a12:	b9c080e7          	jalr	-1124(ra) # 800005aa <printf>
    for (int i = 0; i < SCHEDC; i++)
    {
        if (available_schedulers[i].impl == sched_pointer)
    80002a16:	00006717          	auipc	a4,0x6
    80002a1a:	f8273703          	ld	a4,-126(a4) # 80008998 <available_schedulers+0x10>
    80002a1e:	00006797          	auipc	a5,0x6
    80002a22:	f227b783          	ld	a5,-222(a5) # 80008940 <sched_pointer>
    80002a26:	08f70763          	beq	a4,a5,80002ab4 <schedls+0xc8>
        {
            printf("[*]\t");
        }
        else
    ...
    80002a2e:	89e50513          	add	a0,a0,-1890 # 800082c8 <etext+0x2c8>
    80002a32:	ffffe097          	auipc	ra,0xffffe
    80002a36:	b78080e7          	jalr	-1160(ra) # 800005aa <printf>
        }
        printf("%s\t%d\n", available_schedulers[i].name, available_schedulers[i].id);
    80002a3a:	00006497          	auipc	s1,0x6
    80002a3e:	f1648493          	add	s1,s1,-234 # 80008950 <initcode>
    80002a42:	48b0                	lw	a2,80(s1)
    80002a44:	00006597          	auipc	a1,0x6
    80002a48:	f4458593          	add	a1,a1,-188 # 80008988 <available_schedulers>
    80002a4c:	00006517          	auipc	a0,0x6
    80002a50:	88c50513          	add	a0,a0,-1908 # 800082d8 <etext+0x2d8>
    80002a54:	ffffe097          	auipc	ra,0xffffe
    80002a58:	b56080e7          	jalr	-1194(ra) # 800005aa <printf>
        if (available_schedulers[i].impl == sched_pointer)
    80002a5c:	74b8                	ld	a4,104(s1)
    80002a5e:	00006797          	auipc	a5,0x6
    80002a62:	ee27b783          	ld	a5,-286(a5) # 80008940 <sched_pointer>
    80002a66:	06f70063          	beq	a4,a5,80002ac6 <schedls+0xda>
            printf("   \t");
    80002a6a:	00006517          	auipc	a0,0x6
    80002a6e:	85e50513          	add	a0,a0,-1954 # 800082c8 <etext+0x2c8>
    80002a72:	ffffe097          	auipc	ra,0xffffe
    80002a76:	b38080e7          	jalr	-1224(ra) # 800005aa <printf>
        printf("%s\t%d\n", available_schedulers[i].name, available_schedulers[i].id);
    80002a7a:	00006617          	auipc	a2,0x6
    80002a7e:	f4662603          	lw	a2,-186(a2) # 800089c0 <available_schedulers+0x38>
    80002a82:	00006597          	auipc	a1,0x6
    80002a86:	f2658593          	add	a1,a1,-218 # 800089a8 <available_schedulers+0x20>
    80002a8a:	00006517          	auipc	a0,0x6
    80002a8e:	84e50513          	add	a0,a0,-1970 # 800082d8 <etext+0x2d8>
    80002a92:	ffffe097          	auipc	ra,0xffffe
    80002a96:	b18080e7          	jalr	-1256(ra) # 800005aa <printf>
    }
    printf("\n*: current scheduler\n\n");
    80002a9a:	00006517          	auipc	a0,0x6
    80002a9e:	84650513          	add	a0,a0,-1978 # 800082e0 <etext+0x2e0>
    ...
    80002ab0:	6105                	add	sp,sp,32
    80002ab2:	8082                	ret
            printf("[*]\t");
    80002ab4:	00006517          	auipc	a0,0x6
    80002ab8:	81c50513          	add	a0,a0,-2020 # 800082d0 <etext+0x2d0>
    80002abc:	ffffe097          	auipc	ra,0xffffe
    80002ac0:	aee080e7          	jalr	-1298(ra) # 800005aa <printf>
    80002ac4:	bf9d                	j	80002a3a <schedls+0x4e>
    80002ac6:	00006517          	auipc	a0,0x6
    80002aca:	80a50513          	add	a0,a0,-2038 # 800082d0 <etext+0x2d0>
    80002ace:	ffffe097          	auipc	ra,0xffffe
    80002ad2:	adc080e7          	jalr	-1316(ra) # 800005aa <printf>
    80002ad6:	b755                	j	80002a7a <schedls+0x8e>

0000000080002ad8 <schedset>:
...
void schedset(int id)
{
    ...
    if (id < 0 || SCHEDC <= id)
    80002ae0:	4705                	li	a4,1
    80002ae2:	02a76f63          	bltu	a4,a0,80002b20 <schedset+0x48>
    {
        printf("Scheduler unchanged: ID out of range\n");
        return;
    }
    sched_pointer = available_schedulers[id].impl;
    80002ae6:	00551793          	sll	a5,a0,0x5
    80002aea:	00006717          	auipc	a4,0x6
    80002aee:	e6670713          	add	a4,a4,-410 # 80008950 <initcode>
    80002af2:	973e                	add	a4,a4,a5
    80002af4:	6738                	ld	a4,72(a4)
    80002af6:	00006697          	auipc	a3,0x6
    80002afa:	e4e6b523          	sd	a4,-438(a3) # 80008940 <sched_pointer>
    printf("Scheduler successfully changed to %s\n", available_schedulers[id].name);
    80002afe:	00006597          	auipc	a1,0x6
    80002b02:	e8a58593          	add	a1,a1,-374 # 80008988 <available_schedulers>
    80002b06:	95be                	add	a1,a1,a5
    80002b08:	00006517          	auipc	a0,0x6
    80002b0c:	81850513          	add	a0,a0,-2024 # 80008320 <etext+0x320>
    80002b10:	ffffe097          	auipc	ra,0xffffe
    80002b14:	a9a080e7          	jalr	-1382(ra) # 800005aa <printf>
    80002b18:	60a2                	ld	ra,8(sp)
    80002b1a:	6402                	ld	s0,0(sp)
    80002b1c:	0141                	add	sp,sp,16
    80002b1e:	8082                	ret
        printf("Scheduler unchanged: ID out of range\n");
    80002b20:	00005517          	auipc	a0,0x5
    80002b24:	7d850513          	add	a0,a0,2008 # 800082f8 <etext+0x2f8>
    80002b28:	ffffe097          	auipc	ra,0xffffe
    80002b2c:	a82080e7          	jalr	-1406(ra) # 800005aa <printf>
        return;
    80002b30:	b7e5                	j	80002b18 <schedset+0x40>

0000000080002b32 <swtch>:
    80002b32:	00153023          	sd	ra,0(a0)
    80002b36:	00253423          	sd	sp,8(a0)
    80002b3a:	e900                	sd	s0,16(a0)
    80002b3c:	ed04                	sd	s1,24(a0)
    80002b3e:	03253023          	sd	s2,32(a0)
    80002b42:	03353423          	sd	s3,40(a0)
    80002b46:	03453823          	sd	s4,48(a0)
    80002b4a:	03553c23          	sd	s5,56(a0)
    80002b4e:	05653023          	sd	s6,64(a0)
    80002b52:	05753423          	sd	s7,72(a0)
    80002b56:	05853823          	sd	s8,80(a0)
    80002b5a:	05953c23          	sd	s9,88(a0)
    80002b5e:	07a53023          	sd	s10,96(a0)
    80002b62:	07b53423          	sd	s11,104(a0)
    80002b66:	0005b083          	ld	ra,0(a1)
    80002b6a:	0085b103          	ld	sp,8(a1)
    80002b6e:	6980                	ld	s0,16(a1)
    80002b70:	6d84                	ld	s1,24(a1)
    80002b72:	0205b903          	ld	s2,32(a1)
    80002b76:	0285b983          	ld	s3,40(a1)
    80002b7a:	0305ba03          	ld	s4,48(a1)
    80002b7e:	0385ba83          	ld	s5,56(a1)
    80002b82:	0405bb03          	ld	s6,64(a1)
    80002b86:	0485bb83          	ld	s7,72(a1)
    80002b8a:	0505bc03          	ld	s8,80(a1)
    80002b8e:	0585bc83          	ld	s9,88(a1)
    80002b92:	0605bd03          	ld	s10,96(a1)
    80002b96:	0685bd83          	ld	s11,104(a1)
    80002b9a:	8082                	ret

0000000080002b9c <trapinit>:
void kernelvec();
...
void trapinit(void)
{
    ...
    80002ba4:	00005597          	auipc	a1,0x5
    80002ba8:	7d458593          	add	a1,a1,2004 # 80008378 <etext+0x378>
    80002bac:	00014517          	auipc	a0,0x14
    80002bb0:	0f450513          	add	a0,a0,244 # 80016ca0 <tickslock>
    80002bb4:	ffffe097          	auipc	ra,0xffffe
    80002bb8:	ff4080e7          	jalr	-12(ra) # 80000ba8 <initlock>
}
    80002bbc:	60a2                	ld	ra,8(sp)
    80002bbe:	6402                	ld	s0,0(sp)
    80002bc0:	0141                	add	sp,sp,16
    80002bc2:	8082                	ret

0000000080002bc4 <trapinithart>:

// set up to take exceptions and traps while in the kernel.
void trapinithart(void)
{
    80002bc4:	1141                	add	sp,sp,-16
    80002bc6:	e422                	sd	s0,8(sp)
    80002bc8:	0800                	add	s0,sp,16
  asm volatile("csrw stvec, %0" : : "r" (x));
    80002bca:	00003797          	auipc	a5,0x3
    80002bce:	65678793          	add	a5,a5,1622 # 80006220 <kernelvec>
    80002bd2:	10579073          	csrw	stvec,a5
    w_stvec((uint64)kernelvec);
}
    80002bd6:	6422                	ld	s0,8(sp)
    80002bd8:	0141                	add	sp,sp,16
    80002bda:	8082                	ret

0000000080002bdc <usertrapret>:
...
{
    80002bdc:	1141                	add	sp,sp,-16
    80002bde:	e406                	sd	ra,8(sp)
    80002be0:	e022                	sd	s0,0(sp)
    80002be2:	0800                	add	s0,sp,16
    struct proc *p = myproc();
    80002be4:	fffff097          	auipc	ra,0xfffff
    80002be8:	0f2080e7          	jalr	242(ra) # 80001cd6 <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002bec:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80002bf0:	9bf5                	and	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002bf6:	00004697          	auipc	a3,0x4
    80002bfa:	40a68693          	add	a3,a3,1034 # 80007000 <_trampoline>
    80002bfe:	00004717          	auipc	a4,0x4
    80002c02:	40270713          	add	a4,a4,1026 # 80007000 <_trampoline>
    80002c06:	8f15                	sub	a4,a4,a3
    80002c08:	040007b7          	lui	a5,0x4000
    80002c0c:	17fd                	add	a5,a5,-1 # 3ffffff <_entry-0x7c000001>
    80002c0e:	07b2                	sll	a5,a5,0xc
    80002c10:	973e                	add	a4,a4,a5
  asm volatile("csrw stvec, %0" : : "r" (x));
    80002c12:	10571073          	csrw	stvec,a4
    w_stvec(trampoline_uservec);

    // set up trapframe values that uservec will need when
    // the process next traps into the kernel.
    p->trapframe->kernel_satp = r_satp();         // kernel page table
    80002c16:	7138                	ld	a4,96(a0)
  asm volatile("csrr %0, satp" : "=r" (x) );
    80002c18:	18002673          	csrr	a2,satp
    80002c1c:	e310                	sd	a2,0(a4)
    p->trapframe->kernel_sp = p->kstack + PGSIZE; // process's kernel stack
    80002c1e:	7130                	ld	a2,96(a0)
    80002c20:	6538                	ld	a4,72(a0)
    80002c22:	6585                	lui	a1,0x1
    80002c24:	972e                	add	a4,a4,a1
    80002c26:	e618                	sd	a4,8(a2)
    p->trapframe->kernel_trap = (uint64)usertrap;
    80002c28:	7138                	ld	a4,96(a0)
    80002c2a:	00000617          	auipc	a2,0x0
    80002c2e:	13860613          	add	a2,a2,312 # 80002d62 <usertrap>
    80002c32:	eb10                	sd	a2,16(a4)
    p->trapframe->kernel_hartid = r_tp(); // hartid for cpuid()
    80002c34:	7138                	ld	a4,96(a0)
  asm volatile("mv %0, tp" : "=r" (x) );
    80002c36:	8612                	mv	a2,tp
    80002c38:	f310                	sd	a2,32(a4)
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002c3a:	10002773          	csrr	a4,sstatus
    ...
    80002c3e:	eff77713          	and	a4,a4,-257
    x |= SSTATUS_SPIE; // enable interrupts in user mode
    80002c42:	02076713          	or	a4,a4,32
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80002c46:	10071073          	csrw	sstatus,a4
    w_sstatus(x);

    // set S Exception Program Counter to the saved user pc.
    w_sepc(p->trapframe->epc);
    80002c4a:	7138                	ld	a4,96(a0)
  asm volatile("csrw sepc, %0" : : "r" (x));
    80002c4c:	6f18                	ld	a4,24(a4)
    80002c4e:	14171073          	csrw	sepc,a4

    // tell trampoline.S the user page table to switch to.
    uint64 satp = MAKE_SATP(p->pagetable);
    80002c52:	6d28                	ld	a0,88(a0)
    80002c54:	8131                	srl	a0,a0,0xc

    // jump to userret in trampoline.S at the top of memory, which
    // switches to the user page table, restores user registers,
    // and switches to user mode with sret.
    uint64 trampoline_userret = TRAMPOLINE + (userret - trampoline);
    80002c56:	00004717          	auipc	a4,0x4
    80002c5a:	44670713          	add	a4,a4,1094 # 8000709c <userret>
    80002c5e:	8f15                	sub	a4,a4,a3
    80002c60:	97ba                	add	a5,a5,a4
    ((void (*)(uint64))trampoline_userret)(satp);
    80002c62:	577d                	li	a4,-1
    80002c64:	177e                	sll	a4,a4,0x3f
    80002c66:	8d59                	or	a0,a0,a4
    80002c68:	9782                	jalr	a5
}
    80002c6a:	60a2                	ld	ra,8(sp)
    80002c6c:	6402                	ld	s0,0(sp)
    80002c6e:	0141                	add	sp,sp,16
    80002c70:	8082                	ret

0000000080002c72 <clockintr>:
    w_sepc(sepc);
    w_sstatus(sstatus);
}
...
void clockintr()
{
    ...
    acquire(&tickslock);
    80002c7c:	00014497          	auipc	s1,0x14
    80002c80:	02448493          	add	s1,s1,36 # 80016ca0 <tickslock>
    80002c84:	8526                	mv	a0,s1
    80002c86:	ffffe097          	auipc	ra,0xffffe
    80002c8a:	fb2080e7          	jalr	-78(ra) # 80000c38 <acquire>
    ticks++;
    80002c8e:	00006517          	auipc	a0,0x6
    80002c92:	d7a50513          	add	a0,a0,-646 # 80008a08 <ticks>
    80002c96:	411c                	lw	a5,0(a0)
    80002c98:	2785                	addw	a5,a5,1
    80002c9a:	c11c                	sw	a5,0(a0)
    wakeup(&ticks);
    80002c9c:	00000097          	auipc	ra,0x0
    80002ca0:	850080e7          	jalr	-1968(ra) # 800024ec <wakeup>
    release(&tickslock);
    80002ca4:	8526                	mv	a0,s1
    80002ca6:	ffffe097          	auipc	ra,0xffffe
    80002caa:	046080e7          	jalr	70(ra) # 80000cec <release>
}
...
0000000080002cb8 <devintr>:
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80002cbe:	0a07d163          	bgez	a5,80002d60 <devintr+0xa8>
{
    80002cc2:	1101                	add	sp,sp,-32
    80002cc4:	ec06                	sd	ra,24(sp)
    80002cc6:	e822                	sd	s0,16(sp)
    80002cc8:	1000                	add	s0,sp,32
        (scause & 0xff) == 9)
    80002cca:	0ff7f713          	zext.b	a4,a5
    if ((scause & 0x8000000000000000L) &&
    80002cce:	46a5                	li	a3,9
    80002cd0:	00d70c63          	beq	a4,a3,80002ce8 <devintr+0x30>
    else if (scause == 0x8000000000000001L)
    80002cd4:	577d                	li	a4,-1
    80002cd6:	177e                	sll	a4,a4,0x3f
    80002cd8:	0705                	add	a4,a4,1
        return 0;
    80002cda:	4501                	li	a0,0
    else if (scause == 0x8000000000000001L)
    80002cdc:	06e78163          	beq	a5,a4,80002d3e <devintr+0x86>
    }
}
    ...
    80002cee:	642080e7          	jalr	1602(ra) # 8000632c <plic_claim>
    80002cf2:	84aa                	mv	s1,a0
        if (irq == UART0_IRQ)
    80002cf4:	47a9                	li	a5,10
    80002cf6:	00f50963          	beq	a0,a5,80002d08 <devintr+0x50>
        else if (irq == VIRTIO0_IRQ)
    80002cfa:	4785                	li	a5,1
    80002cfc:	00f50b63          	beq	a0,a5,80002d12 <devintr+0x5a>
        return 1;
    80002d00:	4505                	li	a0,1
        else if (irq)
    80002d02:	ec89                	bnez	s1,80002d1c <devintr+0x64>
    80002d04:	64a2                	ld	s1,8(sp)
    80002d06:	bfe9                	j	80002ce0 <devintr+0x28>
            uartintr();
    80002d08:	ffffe097          	auipc	ra,0xffffe
    80002d0c:	cf2080e7          	jalr	-782(ra) # 800009fa <uartintr>
        if (irq)
    80002d10:	a839                	j	80002d2e <devintr+0x76>
            virtio_disk_intr();
    80002d12:	00004097          	auipc	ra,0x4
    80002d16:	b44080e7          	jalr	-1212(ra) # 80006856 <virtio_disk_intr>
        if (irq)
    80002d1a:	a811                	j	80002d2e <devintr+0x76>
            printf("unexpected interrupt irq=%d\n", irq);
    80002d1c:	85a6                	mv	a1,s1
    80002d1e:	00005517          	auipc	a0,0x5
    80002d22:	66250513          	add	a0,a0,1634 # 80008380 <etext+0x380>
    80002d26:	ffffe097          	auipc	ra,0xffffe
    80002d2a:	884080e7          	jalr	-1916(ra) # 800005aa <printf>
            plic_complete(irq);
    80002d2e:	8526                	mv	a0,s1
    80002d30:	00003097          	auipc	ra,0x3
    80002d34:	620080e7          	jalr	1568(ra) # 80006350 <plic_complete>
        return 1;
    80002d38:	4505                	li	a0,1
    80002d3a:	64a2                	ld	s1,8(sp)
    80002d3c:	b755                	j	80002ce0 <devintr+0x28>
        if (cpuid() == 0)
    80002d3e:	fffff097          	auipc	ra,0xfffff
    80002d42:	f6c080e7          	jalr	-148(ra) # 80001caa <cpuid>
    80002d46:	c901                	beqz	a0,80002d56 <devintr+0x9e>
  ...
  asm volatile("csrw sip, %0" : : "r" (x));
    ...
    80002d54:	b771                	j	80002ce0 <devintr+0x28>
            clockintr();
    80002d56:	00000097          	auipc	ra,0x0
    80002d5a:	f1c080e7          	jalr	-228(ra) # 80002c72 <clockintr>
    80002d5e:	b7ed                	j	80002d48 <devintr+0x90>
}
    80002d60:	8082                	ret
...
0000000080002d62 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002d7c:	4a878793          	add	a5,a5,1192 # 80006220 <kernelvec>
    80002d80:	10579073          	csrw	stvec,a5
    struct proc *p = myproc();
    80002d84:	fffff097          	auipc	ra,0xfffff
    80002d88:	f52080e7          	jalr	-174(ra) # 80001cd6 <myproc>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80002da4:	f18080e7          	jalr	-232(ra) # 80002cb8 <devintr>
    80002da8:	892a                	mv	s2,a0
    80002daa:	c151                	beqz	a0,80002e2e <usertrap+0xcc>
    if (killed(p))
    80002dac:	8526                	mv	a0,s1
    80002dae:	00000097          	auipc	ra,0x0
    80002db2:	982080e7          	jalr	-1662(ra) # 80002730 <killed>
    80002db6:	c929                	beqz	a0,80002e08 <usertrap+0xa6>
    80002db8:	a099                	j	80002dfe <usertrap+0x9c>
        panic("usertrap: not from user mode");
    80002dba:	00005517          	auipc	a0,0x5
    80002dbe:	5e650513          	add	a0,a0,1510 # 800083a0 <etext+0x3a0>
    80002dc2:	ffffd097          	auipc	ra,0xffffd
    80002dc6:	79e080e7          	jalr	1950(ra) # 80000560 <panic>
        if (killed(p))
    80002dca:	00000097          	auipc	ra,0x0
    80002dce:	966080e7          	jalr	-1690(ra) # 80002730 <killed>
    80002dd2:	e921                	bnez	a0,80002e22 <usertrap+0xc0>
        p->trapframe->epc += 4;
    80002dd4:	70b8                	ld	a4,96(s1)
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002dec:	2d8080e7          	jalr	728(ra) # 800030c0 <syscall>
    if (killed(p))
    80002df0:	8526                	mv	a0,s1
    80002df2:	00000097          	auipc	ra,0x0
    80002df6:	93e080e7          	jalr	-1730(ra) # 80002730 <killed>
    80002dfa:	c911                	beqz	a0,80002e0e <usertrap+0xac>
    80002dfc:	4901                	li	s2,0
        exit(-1);
    80002dfe:	557d                	li	a0,-1
    80002e00:	fffff097          	auipc	ra,0xfffff
    80002e04:	7bc080e7          	jalr	1980(ra) # 800025bc <exit>
    if (which_dev == 2)
    80002e08:	4789                	li	a5,2
    80002e0a:	04f90f63          	beq	s2,a5,80002e68 <usertrap+0x106>
    usertrapret();
    80002e0e:	00000097          	auipc	ra,0x0
    80002e12:	dce080e7          	jalr	-562(ra) # 80002bdc <usertrapret>
}
    ...
    80002e28:	798080e7          	jalr	1944(ra) # 800025bc <exit>
    80002e2c:	b765                	j	80002dd4 <usertrap+0x72>
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002e2e:	142025f3          	csrr	a1,scause
        printf("usertrap(): unexpected scause %p pid=%d\n", r_scause(), p->pid);
    80002e32:	5890                	lw	a2,48(s1)
    80002e34:	00005517          	auipc	a0,0x5
    80002e38:	58c50513          	add	a0,a0,1420 # 800083c0 <etext+0x3c0>
    80002e3c:	ffffd097          	auipc	ra,0xffffd
    80002e40:	76e080e7          	jalr	1902(ra) # 800005aa <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
    80002e44:	141025f3          	csrr	a1,sepc
  asm volatile("csrr %0, stval" : "=r" (x) );
    80002e48:	14302673          	csrr	a2,stval
        printf("            sepc=%p stval=%p\n", r_sepc(), r_stval());
    80002e4c:	00005517          	auipc	a0,0x5
    80002e50:	5a450513          	add	a0,a0,1444 # 800083f0 <etext+0x3f0>
    ...
    80002e62:	8a6080e7          	jalr	-1882(ra) # 80002704 <setkilled>
    80002e66:	b769                	j	80002df0 <usertrap+0x8e>
        yield(YIELD_TIMER);
    80002e68:	4505                	li	a0,1
    80002e6a:	fffff097          	auipc	ra,0xfffff
    80002e6e:	5e2080e7          	jalr	1506(ra) # 8000244c <yield>
    80002e72:	bf71                	j	80002e0e <usertrap+0xac>

0000000080002e74 <kerneltrap>:
{
    80002e74:	7179                	add	sp,sp,-48
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002ebe:	6145                	add	sp,sp,48
    80002ec0:	8082                	ret
        panic("kerneltrap: not from supervisor mode");
    80002ec2:	00005517          	auipc	a0,0x5
    80002ec6:	54e50513          	add	a0,a0,1358 # 80008410 <etext+0x410>
    80002eca:	ffffd097          	auipc	ra,0xffffd
    80002ece:	696080e7          	jalr	1686(ra) # 80000560 <panic>
        panic("kerneltrap: interrupts enabled");
    80002ed2:	00005517          	auipc	a0,0x5
    80002ed6:	56650513          	add	a0,a0,1382 # 80008438 <etext+0x438>
    80002eda:	ffffd097          	auipc	ra,0xffffd
    80002ede:	686080e7          	jalr	1670(ra) # 80000560 <panic>
        printf("scause %p\n", scause);
    80002ee2:	85ce                	mv	a1,s3
    80002ee4:	00005517          	auipc	a0,0x5
    80002ee8:	57450513          	add	a0,a0,1396 # 80008458 <etext+0x458>
    80002eec:	ffffd097          	auipc	ra,0xffffd
    80002ef0:	6be080e7          	jalr	1726(ra) # 800005aa <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002f00:	56c50513          	add	a0,a0,1388 # 80008468 <etext+0x468>
    80002f04:	ffffd097          	auipc	ra,0xffffd
    80002f08:	6a6080e7          	jalr	1702(ra) # 800005aa <printf>
        panic("kerneltrap");
    80002f0c:	00005517          	auipc	a0,0x5
    80002f10:	57450513          	add	a0,a0,1396 # 80008480 <etext+0x480>
    80002f14:	ffffd097          	auipc	ra,0xffffd
    80002f18:	64c080e7          	jalr	1612(ra) # 80000560 <panic>
    if (which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    80002f1c:	fffff097          	auipc	ra,0xfffff
    80002f20:	dba080e7          	jalr	-582(ra) # 80001cd6 <myproc>
    80002f24:	d541                	beqz	a0,80002eac <kerneltrap+0x38>
    80002f26:	fffff097          	auipc	ra,0xfffff
    80002f2a:	db0080e7          	jalr	-592(ra) # 80001cd6 <myproc>
    80002f2e:	4d18                	lw	a4,24(a0)
    80002f30:	4791                	li	a5,4
    80002f32:	f6f71de3          	bne	a4,a5,80002eac <kerneltrap+0x38>
        yield(YIELD_OTHER);
    80002f36:	4509                	li	a0,2
    80002f38:	fffff097          	auipc	ra,0xfffff
    80002f3c:	514080e7          	jalr	1300(ra) # 8000244c <yield>
    80002f40:	b7b5                	j	80002eac <kerneltrap+0x38>

0000000080002f42 <argraw>:
    return strlen(buf);
}
...
argraw(int n)
{
    ...
    80002f52:	d88080e7          	jalr	-632(ra) # 80001cd6 <myproc>
    switch (n)
    80002f56:	4795                	li	a5,5
    80002f58:	0497e163          	bltu	a5,s1,80002f9a <argraw+0x58>
    80002f5c:	048a                	sll	s1,s1,0x2
    80002f5e:	00006717          	auipc	a4,0x6
    80002f62:	8e270713          	add	a4,a4,-1822 # 80008840 <states.0+0x30>
    80002f66:	94ba                	add	s1,s1,a4
    ...
    80002f78:	6105                	add	sp,sp,32
    80002f7a:	8082                	ret
        return p->trapframe->a1;
    80002f7c:	713c                	ld	a5,96(a0)
    80002f7e:	7fa8                	ld	a0,120(a5)
    80002f80:	bfcd                	j	80002f72 <argraw+0x30>
        return p->trapframe->a2;
    80002f82:	713c                	ld	a5,96(a0)
    80002f84:	63c8                	ld	a0,128(a5)
    80002f86:	b7f5                	j	80002f72 <argraw+0x30>
        return p->trapframe->a3;
    80002f88:	713c                	ld	a5,96(a0)
    80002f8a:	67c8                	ld	a0,136(a5)
    80002f8c:	b7dd                	j	80002f72 <argraw+0x30>
        return p->trapframe->a4;
    80002f8e:	713c                	ld	a5,96(a0)
    80002f90:	6bc8                	ld	a0,144(a5)
    80002f92:	b7c5                	j	80002f72 <argraw+0x30>
        return p->trapframe->a5;
    80002f94:	713c                	ld	a5,96(a0)
    80002f96:	6fc8                	ld	a0,152(a5)
    80002f98:	bfe9                	j	80002f72 <argraw+0x30>
    panic("argraw");
    80002f9a:	00005517          	auipc	a0,0x5
    80002f9e:	4f650513          	add	a0,a0,1270 # 80008490 <etext+0x490>
    80002fa2:	ffffd097          	auipc	ra,0xffffd
    80002fa6:	5be080e7          	jalr	1470(ra) # 80000560 <panic>

0000000080002faa <fetchaddr>:
{
    ...
    80002fb4:	1000                	add	s0,sp,32
    80002fb6:	84aa                	mv	s1,a0
    80002fb8:	892e                	mv	s2,a1
    struct proc *p = myproc();
    80002fba:	fffff097          	auipc	ra,0xfffff
    80002fbe:	d1c080e7          	jalr	-740(ra) # 80001cd6 <myproc>
    if (addr >= p->sz || addr + sizeof(uint64) > p->sz) // both tests needed, in case of overflow
    80002fc2:	693c                	ld	a5,80(a0)
    80002fc4:	02f4f863          	bgeu	s1,a5,80002ff4 <fetchaddr+0x4a>
    80002fc8:	00848713          	add	a4,s1,8
    80002fcc:	02e7e663          	bltu	a5,a4,80002ff8 <fetchaddr+0x4e>
    if (copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    80002fd0:	46a1                	li	a3,8
    80002fd2:	8626                	mv	a2,s1
    80002fd4:	85ca                	mv	a1,s2
    80002fd6:	6d28                	ld	a0,88(a0)
    80002fd8:	ffffe097          	auipc	ra,0xffffe
    80002fdc:	796080e7          	jalr	1942(ra) # 8000176e <copyin>
    80002fe0:	00a03533          	snez	a0,a0
    80002fe4:	40a00533          	neg	a0,a0
}
    ...
    80002ff6:	bfcd                	j	80002fe8 <fetchaddr+0x3e>
    80002ff8:	557d                	li	a0,-1
    80002ffa:	b7fd                	j	80002fe8 <fetchaddr+0x3e>

0000000080002ffc <fetchstr>:
{
    80002ffc:	7179                	add	sp,sp,-48
    80002ffe:	f406                	sd	ra,40(sp)
    80003000:	f022                	sd	s0,32(sp)
    80003002:	ec26                	sd	s1,24(sp)
    80003004:	e84a                	sd	s2,16(sp)
    80003006:	e44e                	sd	s3,8(sp)
    80003008:	1800                	add	s0,sp,48
    8000300a:	892a                	mv	s2,a0
    8000300c:	84ae                	mv	s1,a1
    8000300e:	89b2                	mv	s3,a2
    struct proc *p = myproc();
    80003010:	fffff097          	auipc	ra,0xfffff
    80003014:	cc6080e7          	jalr	-826(ra) # 80001cd6 <myproc>
    if (copyinstr(p->pagetable, buf, addr, max) < 0)
    80003018:	86ce                	mv	a3,s3
    8000301a:	864a                	mv	a2,s2
    8000301c:	85a6                	mv	a1,s1
    8000301e:	6d28                	ld	a0,88(a0)
    80003020:	ffffe097          	auipc	ra,0xffffe
    80003024:	7dc080e7          	jalr	2012(ra) # 800017fc <copyinstr>
    80003028:	00054e63          	bltz	a0,80003044 <fetchstr+0x48>
    return strlen(buf);
    8000302c:	8526                	mv	a0,s1
    8000302e:	ffffe097          	auipc	ra,0xffffe
    80003032:	e7a080e7          	jalr	-390(ra) # 80000ea8 <strlen>
}
    ...
    80003046:	bfc5                	j	80003036 <fetchstr+0x3a>

0000000080003048 <argint>:

// Fetch the nth 32-bit system call argument.
void argint(int n, int *ip)
{
    80003048:	1101                	add	sp,sp,-32
    8000304a:	ec06                	sd	ra,24(sp)
    8000304c:	e822                	sd	s0,16(sp)
    8000304e:	e426                	sd	s1,8(sp)
    80003050:	1000                	add	s0,sp,32
    80003052:	84ae                	mv	s1,a1
    *ip = argraw(n);
    80003054:	00000097          	auipc	ra,0x0
    80003058:	eee080e7          	jalr	-274(ra) # 80002f42 <argraw>
    8000305c:	c088                	sw	a0,0(s1)
}
    8000305e:	60e2                	ld	ra,24(sp)
    80003060:	6442                	ld	s0,16(sp)
    80003062:	64a2                	ld	s1,8(sp)
    80003064:	6105                	add	sp,sp,32
    80003066:	8082                	ret

0000000080003068 <argaddr>:
...
void argaddr(int n, uint64 *ip)
{
    ...
    *ip = argraw(n);
    ...
    80003078:	ece080e7          	jalr	-306(ra) # 80002f42 <argraw>
    8000307c:	e088                	sd	a0,0(s1)
}
    8000307e:	60e2                	ld	ra,24(sp)
    80003080:	6442                	ld	s0,16(sp)
    80003082:	64a2                	ld	s1,8(sp)
    80003084:	6105                	add	sp,sp,32
    80003086:	8082                	ret

0000000080003088 <argstr>:
...
int argstr(int n, char *buf, int max)
{
    ...
    80003096:	8932                	mv	s2,a2
    uint64 addr;
    argaddr(n, &addr);
    80003098:	fd840593          	add	a1,s0,-40
    8000309c:	00000097          	auipc	ra,0x0
    800030a0:	fcc080e7          	jalr	-52(ra) # 80003068 <argaddr>
    return fetchstr(addr, buf, max);
    800030a4:	864a                	mv	a2,s2
    800030a6:	85a6                	mv	a1,s1
    800030a8:	fd843503          	ld	a0,-40(s0)
    800030ac:	00000097          	auipc	ra,0x0
    800030b0:	f50080e7          	jalr	-176(ra) # 80002ffc <fetchstr>
}
    800030b4:	70a2                	ld	ra,40(sp)
    800030b6:	7402                	ld	s0,32(sp)
    800030b8:	64e2                	ld	s1,24(sp)
    800030ba:	6942                	ld	s2,16(sp)
    800030bc:	6145                	add	sp,sp,48
    800030be:	8082                	ret

00000000800030c0 <syscall>:
...
void syscall(void)
{
    ...
    800030d0:	c0a080e7          	jalr	-1014(ra) # 80001cd6 <myproc>
    800030d4:	84aa                	mv	s1,a0

    num = p->trapframe->a7;
    800030d6:	06053903          	ld	s2,96(a0)
    800030da:	0a893783          	ld	a5,168(s2)
    800030de:	0007869b          	sext.w	a3,a5
    if (num > 0 && num < NELEM(syscalls) && syscalls[num])
    800030e2:	37fd                	addw	a5,a5,-1
    800030e4:	4761                	li	a4,24
    800030e6:	00f76f63          	bltu	a4,a5,80003104 <syscall+0x44>
    800030ea:	00369713          	sll	a4,a3,0x3
    800030ee:	00005797          	auipc	a5,0x5
    800030f2:	76a78793          	add	a5,a5,1898 # 80008858 <syscalls>
    800030f6:	97ba                	add	a5,a5,a4
    800030f8:	639c                	ld	a5,0(a5)
    800030fa:	c789                	beqz	a5,80003104 <syscall+0x44>
    {
        // Use num to lookup the system call function for num, call it,
        // and store its return value in p->trapframe->a0
        p->trapframe->a0 = syscalls[num]();
    800030fc:	9782                	jalr	a5
    800030fe:	06a93823          	sd	a0,112(s2)
    80003102:	a839                	j	80003120 <syscall+0x60>
    }
    else
    {
        printf("%d %s: unknown sys call %d\n",
    80003104:	16048613          	add	a2,s1,352
    80003108:	588c                	lw	a1,48(s1)
    8000310a:	00005517          	auipc	a0,0x5
    8000310e:	38e50513          	add	a0,a0,910 # 80008498 <etext+0x498>
    80003112:	ffffd097          	auipc	ra,0xffffd
    80003116:	498080e7          	jalr	1176(ra) # 800005aa <printf>
               p->pid, p->name, num);
        p->trapframe->a0 = -1;
    8000311a:	70bc                	ld	a5,96(s1)
    8000311c:	577d                	li	a4,-1
    8000311e:	fbb8                	sd	a4,112(a5)
    }
}
...
sys_exit(void)
{
    8000312c:	1101                	add	sp,sp,-32
    8000312e:	ec06                	sd	ra,24(sp)
    80003130:	e822                	sd	s0,16(sp)
    80003132:	1000                	add	s0,sp,32
    int n;
    argint(0, &n);
    80003134:	fec40593          	add	a1,s0,-20
    80003138:	4501                	li	a0,0
    8000313a:	00000097          	auipc	ra,0x0
    8000313e:	f0e080e7          	jalr	-242(ra) # 80003048 <argint>
    exit(n);
    80003142:	fec42503          	lw	a0,-20(s0)
    80003146:	fffff097          	auipc	ra,0xfffff
    8000314a:	476080e7          	jalr	1142(ra) # 800025bc <exit>
    return 0; // not reached
}
    8000314e:	4501                	li	a0,0
    80003150:	60e2                	ld	ra,24(sp)
    80003152:	6442                	ld	s0,16(sp)
    80003154:	6105                	add	sp,sp,32
    80003156:	8082                	ret

0000000080003158 <sys_getpid>:

uint64
sys_getpid(void)
{
    80003158:	1141                	add	sp,sp,-16
    8000315a:	e406                	sd	ra,8(sp)
    8000315c:	e022                	sd	s0,0(sp)
    8000315e:	0800                	add	s0,sp,16
    return myproc()->pid;
    80003160:	fffff097          	auipc	ra,0xfffff
    80003164:	b76080e7          	jalr	-1162(ra) # 80001cd6 <myproc>
}
    80003168:	5908                	lw	a0,48(a0)
    8000316a:	60a2                	ld	ra,8(sp)
    8000316c:	6402                	ld	s0,0(sp)
    8000316e:	0141                	add	sp,sp,16
    80003170:	8082                	ret

0000000080003172 <sys_fork>:

uint64
sys_fork(void)
{
    80003172:	1141                	add	sp,sp,-16
    80003174:	e406                	sd	ra,8(sp)
    80003176:	e022                	sd	s0,0(sp)
    80003178:	0800                	add	s0,sp,16
    return fork();
    8000317a:	fffff097          	auipc	ra,0xfffff
    8000317e:	0aa080e7          	jalr	170(ra) # 80002224 <fork>
}
    80003182:	60a2                	ld	ra,8(sp)
    80003184:	6402                	ld	s0,0(sp)
    80003186:	0141                	add	sp,sp,16
    80003188:	8082                	ret

000000008000318a <sys_wait>:
...
sys_wait(void)
{
    ...
    80003190:	1000                	add	s0,sp,32
    uint64 p;
    argaddr(0, &p);
    80003192:	fe840593          	add	a1,s0,-24
    80003196:	4501                	li	a0,0
    80003198:	00000097          	auipc	ra,0x0
    8000319c:	ed0080e7          	jalr	-304(ra) # 80003068 <argaddr>
    return wait(p);
    800031a0:	fe843503          	ld	a0,-24(s0)
    800031a4:	fffff097          	auipc	ra,0xfffff
    800031a8:	5be080e7          	jalr	1470(ra) # 80002762 <wait>
}
...
00000000800031b4 <sys_sbrk>:

uint64
sys_sbrk(void)
{
    800031b4:	7179                	add	sp,sp,-48
    ...
    argint(0, &n);
    800031be:	fdc40593          	add	a1,s0,-36
    800031c2:	4501                	li	a0,0
    800031c4:	00000097          	auipc	ra,0x0
    800031c8:	e84080e7          	jalr	-380(ra) # 80003048 <argint>
    addr = myproc()->sz;
    800031cc:	fffff097          	auipc	ra,0xfffff
    800031d0:	b0a080e7          	jalr	-1270(ra) # 80001cd6 <myproc>
    800031d4:	6924                	ld	s1,80(a0)
    if (growproc(n) < 0)
    800031d6:	fdc42503          	lw	a0,-36(s0)
    800031da:	fffff097          	auipc	ra,0xfffff
    800031de:	e56080e7          	jalr	-426(ra) # 80002030 <growproc>
    800031e2:	00054863          	bltz	a0,800031f2 <sys_sbrk+0x3e>
        return -1;
    return addr;
}
    ...
    800031ee:	6145                	add	sp,sp,48
    800031f0:	8082                	ret
        return -1;
    800031f2:	54fd                	li	s1,-1
    800031f4:	bfcd                	j	800031e6 <sys_sbrk+0x32>
...
sys_sleep(void)
{
    800031f6:	7139                	add	sp,sp,-64
    800031f8:	fc06                	sd	ra,56(sp)
    800031fa:	f822                	sd	s0,48(sp)
    800031fc:	f04a                	sd	s2,32(sp)
    800031fe:	0080                	add	s0,sp,64
    int n;
    uint ticks0;

    argint(0, &n);
    80003200:	fcc40593          	add	a1,s0,-52
    80003204:	4501                	li	a0,0
    80003206:	00000097          	auipc	ra,0x0
    8000320a:	e42080e7          	jalr	-446(ra) # 80003048 <argint>
    acquire(&tickslock);
    8000320e:	00014517          	auipc	a0,0x14
    80003212:	a9250513          	add	a0,a0,-1390 # 80016ca0 <tickslock>
    80003216:	ffffe097          	auipc	ra,0xffffe
    8000321a:	a22080e7          	jalr	-1502(ra) # 80000c38 <acquire>
    ticks0 = ticks;
    8000321e:	00005917          	auipc	s2,0x5
    80003222:	7ea92903          	lw	s2,2026(s2) # 80008a08 <ticks>
    while (ticks - ticks0 < n)
    80003226:	fcc42783          	lw	a5,-52(s0)
    8000322a:	c3b9                	beqz	a5,80003270 <sys_sleep+0x7a>
    ...
    80003234:	a7098993          	add	s3,s3,-1424 # 80016ca0 <tickslock>
    80003238:	00005497          	auipc	s1,0x5
    8000323c:	7d048493          	add	s1,s1,2000 # 80008a08 <ticks>
        if (killed(myproc()))
    80003240:	fffff097          	auipc	ra,0xfffff
    80003244:	a96080e7          	jalr	-1386(ra) # 80001cd6 <myproc>
    80003248:	fffff097          	auipc	ra,0xfffff
    8000324c:	4e8080e7          	jalr	1256(ra) # 80002730 <killed>
    80003250:	ed15                	bnez	a0,8000328c <sys_sleep+0x96>
        sleep(&ticks, &tickslock);
    80003252:	85ce                	mv	a1,s3
    80003254:	8526                	mv	a0,s1
    80003256:	fffff097          	auipc	ra,0xfffff
    8000325a:	232080e7          	jalr	562(ra) # 80002488 <sleep>
    while (ticks - ticks0 < n)
    8000325e:	409c                	lw	a5,0(s1)
    80003260:	412787bb          	subw	a5,a5,s2
    80003264:	fcc42703          	lw	a4,-52(s0)
    80003268:	fce7ece3          	bltu	a5,a4,80003240 <sys_sleep+0x4a>
    8000326c:	74a2                	ld	s1,40(sp)
    8000326e:	69e2                	ld	s3,24(sp)
    }
    release(&tickslock);
    80003270:	00014517          	auipc	a0,0x14
    80003274:	a3050513          	add	a0,a0,-1488 # 80016ca0 <tickslock>
    ...
    80003288:	6121                	add	sp,sp,64
    8000328a:	8082                	ret
            release(&tickslock);
    8000328c:	00014517          	auipc	a0,0x14
    80003290:	a1450513          	add	a0,a0,-1516 # 80016ca0 <tickslock>
    80003294:	ffffe097          	auipc	ra,0xffffe
    80003298:	a58080e7          	jalr	-1448(ra) # 80000cec <release>
            return -1;
    8000329c:	557d                	li	a0,-1
    8000329e:	74a2                	ld	s1,40(sp)
    800032a0:	69e2                	ld	s3,24(sp)
    800032a2:	b7c5                	j	80003282 <sys_sleep+0x8c>
...
sys_kill(void)
{
    800032a4:	1101                	add	sp,sp,-32
    800032a6:	ec06                	sd	ra,24(sp)
    800032a8:	e822                	sd	s0,16(sp)
    800032aa:	1000                	add	s0,sp,32
    int pid;

    argint(0, &pid);
    800032ac:	fec40593          	add	a1,s0,-20
    800032b0:	4501                	li	a0,0
    800032b2:	00000097          	auipc	ra,0x0
    800032b6:	d96080e7          	jalr	-618(ra) # 80003048 <argint>
    return kill(pid);
    800032ba:	fec42503          	lw	a0,-20(s0)
    800032be:	fffff097          	auipc	ra,0xfffff
    800032c2:	3d4080e7          	jalr	980(ra) # 80002692 <kill>
}
...
sys_uptime(void)
{
    ...
    800032dc:	9c850513          	add	a0,a0,-1592 # 80016ca0 <tickslock>
    800032e0:	ffffe097          	auipc	ra,0xffffe
    800032e4:	958080e7          	jalr	-1704(ra) # 80000c38 <acquire>
    xticks = ticks;
    800032e8:	00005497          	auipc	s1,0x5
    800032ec:	7204a483          	lw	s1,1824(s1) # 80008a08 <ticks>
    release(&tickslock);
    800032f0:	00014517          	auipc	a0,0x14
    800032f4:	9b050513          	add	a0,a0,-1616 # 80016ca0 <tickslock>
    800032f8:	ffffe097          	auipc	ra,0xffffe
    800032fc:	9f4080e7          	jalr	-1548(ra) # 80000cec <release>
    return xticks;
}
    80003300:	02049513          	sll	a0,s1,0x20
    80003304:	9101                	srl	a0,a0,0x20
    80003306:	60e2                	ld	ra,24(sp)
    80003308:	6442                	ld	s0,16(sp)
    8000330a:	64a2                	ld	s1,8(sp)
    8000330c:	6105                	add	sp,sp,32
    8000330e:	8082                	ret
...
uint64 sys_schedset(void)
{
    ...
    80003374:	1000                	add	s0,sp,32
    int id = 0;
    80003376:	fe042623          	sw	zero,-20(s0)
    argint(0, &id);
    8000337a:	fec40593          	add	a1,s0,-20
    8000337e:	4501                	li	a0,0
    80003380:	00000097          	auipc	ra,0x0
    80003384:	cc8080e7          	jalr	-824(ra) # 80003048 <argint>
    schedset(id - 1);
    80003388:	fec42503          	lw	a0,-20(s0)
    8000338c:	357d                	addw	a0,a0,-1
    8000338e:	fffff097          	auipc	ra,0xfffff
    80003392:	74a080e7          	jalr	1866(ra) # 80002ad8 <schedset>
    return 0;
}
...
00000000800033a0 <sys_yield>:

uint64 sys_yield(void)
{
    800033a0:	1141                	add	sp,sp,-16
    800033a2:	e406                	sd	ra,8(sp)
    800033a4:	e022                	sd	s0,0(sp)
    800033a6:	0800                	add	s0,sp,16
    yield(YIELD_OTHER);
    800033a8:	4509                	li	a0,2
    800033aa:	fffff097          	auipc	ra,0xfffff
    800033ae:	0a2080e7          	jalr	162(ra) # 8000244c <yield>
    return 0;
    800033b2:	4501                	li	a0,0
    800033b4:	60a2                	ld	ra,8(sp)
    800033b6:	6402                	ld	s0,0(sp)
    800033b8:	0141                	add	sp,sp,16
    800033ba:	8082                	ret
...
binit(void)
{
    ...
    800033ca:	1800                	add	s0,sp,48
  struct buf *b;

  initlock(&bcache.lock, "bcache");
    800033cc:	00005597          	auipc	a1,0x5
    800033d0:	0ec58593          	add	a1,a1,236 # 800084b8 <etext+0x4b8>
    800033d4:	00014517          	auipc	a0,0x14
    800033d8:	8e450513          	add	a0,a0,-1820 # 80016cb8 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    800033e8:	8d478793          	add	a5,a5,-1836 # 8001ecb8 <bcache+0x8000>
    800033ec:	0001c717          	auipc	a4,0x1c
    800033f0:	b3470713          	add	a4,a4,-1228 # 8001ef20 <bcache+0x8268>
    800033f4:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    800033f8:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    800033fc:	00014497          	auipc	s1,0x14
    80003400:	8d448493          	add	s1,s1,-1836 # 80016cd0 <bcache+0x18>
    ...
    8000340c:	0b8a0a13          	add	s4,s4,184 # 800084c0 <etext+0x4c0>
    b->next = bcache.head.next;
    ...
    8000341c:	01048513          	add	a0,s1,16
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80003432:	45848493          	add	s1,s1,1112
...
bread(uint dev, uint blockno)
{
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80003470:	b044b483          	ld	s1,-1276(s1) # 8001ef70 <bcache+0x82b8>
    80003474:	0001c797          	auipc	a5,0x1c
    80003478:	aac78793          	add	a5,a5,-1364 # 8001ef20 <bcache+0x8268>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    800034be:	aae4b483          	ld	s1,-1362(s1) # 8001ef68 <bcache+0x82b0>
    800034c2:	0001c797          	auipc	a5,0x1c
    800034c6:	a5e78793          	add	a5,a5,-1442 # 8001ef20 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    800034de:	fee50513          	add	a0,a0,-18 # 800084c8 <etext+0x4c8>
    ...
    800034f8:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    800034fa:	00013517          	auipc	a0,0x13
    800034fe:	7be50513          	add	a0,a0,1982 # 80016cb8 <bcache>
    80003502:	ffffd097          	auipc	ra,0xffffd
    80003506:	7ea080e7          	jalr	2026(ra) # 80000cec <release>
      acquiresleep(&b->lock);
    8000350a:	01048513          	add	a0,s1,16
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    8000356e:	f7650513          	add	a0,a0,-138 # 800084e0 <etext+0x4e0>
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    80003588:	01050913          	add	s2,a0,16
  ...
  if (b->refcnt == 0) {
    ...
    b->next = bcache.head.next;
    800035c8:	0001b797          	auipc	a5,0x1b
    800035cc:	6f078793          	add	a5,a5,1776 # 8001ecb8 <bcache+0x8000>
    800035d0:	2b87b703          	ld	a4,696(a5)
    800035d4:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    800035d6:	0001c717          	auipc	a4,0x1c
    800035da:	94a70713          	add	a4,a4,-1718 # 8001ef20 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    800035ee:	6ce50513          	add	a0,a0,1742 # 80016cb8 <bcache>
    ...
    8000360a:	ee250513          	add	a0,a0,-286 # 800084e8 <etext+0x4e8>
...
void
bpin(struct buf *b) {
    80003616:	1101                	add	sp,sp,-32
    80003618:	ec06                	sd	ra,24(sp)
    8000361a:	e822                	sd	s0,16(sp)
    8000361c:	e426                	sd	s1,8(sp)
    8000361e:	1000                	add	s0,sp,32
    80003620:	84aa                	mv	s1,a0
  acquire(&bcache.lock);
    80003622:	00013517          	auipc	a0,0x13
    80003626:	69650513          	add	a0,a0,1686 # 80016cb8 <bcache>
    8000362a:	ffffd097          	auipc	ra,0xffffd
    8000362e:	60e080e7          	jalr	1550(ra) # 80000c38 <acquire>
  b->refcnt++;
    80003632:	40bc                	lw	a5,64(s1)
    80003634:	2785                	addw	a5,a5,1
    80003636:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    80003638:	00013517          	auipc	a0,0x13
    8000363c:	68050513          	add	a0,a0,1664 # 80016cb8 <bcache>
...
bunpin(struct buf *b) {
  ...
  release(&bcache.lock);
    ...
    80003678:	64450513          	add	a0,a0,1604 # 80016cb8 <bcache>
...
000000008000370a <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    bp = bread(dev, BBLOCK(b, sb));
    80003734:	0001cb17          	auipc	s6,0x1c
    80003738:	c44b0b13          	add	s6,s6,-956 # 8001f378 <sb>
  ...
  memset(bp->data, 0, BSIZE);
    ...
    80003776:	05850513          	add	a0,a0,88
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    bp = bread(dev, BBLOCK(b, sb));
    800037cc:	41fad79b          	sraw	a5,s5,0x1f
    800037d0:	0137d79b          	srlw	a5,a5,0x13
    800037d4:	015787bb          	addw	a5,a5,s5
    800037d8:	40d7d79b          	sraw	a5,a5,0xd
    ...
    800037f8:	faa4fde3          	bgeu	s1,a0,800037b2 <balloc+0xa8>
      m = 1 << (bi % 8);
    800037fc:	00777693          	and	a3,a4,7
    80003800:	00d996bb          	sllw	a3,s3,a3
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    80003804:	41f7579b          	sraw	a5,a4,0x1f
    80003808:	01d7d79b          	srlw	a5,a5,0x1d
    8000380c:	9fb9                	addw	a5,a5,a4
    8000380e:	4037d79b          	sraw	a5,a5,0x3
    ...
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80003820:	2705                	addw	a4,a4,1
    80003822:	2485                	addw	s1,s1,1
  ...
  printf("balloc: out of blocks\n");
    ...
    8000383e:	cce50513          	add	a0,a0,-818 # 80008508 <etext+0x508>
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    ...
    80003864:	02059793          	sll	a5,a1,0x20
    80003868:	01e7d593          	srl	a1,a5,0x1e
  ...
  bn -= NDIRECT;
    80003890:	ff45849b          	addw	s1,a1,-12
  ...
  if(bn < NINDIRECT){
    ...
    if((addr = a[bn]) == 0){
    800038d8:	02049713          	sll	a4,s1,0x20
    800038dc:	01e75593          	srl	a1,a4,0x1e
...
000000008000393e <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80003956:	a4650513          	add	a0,a0,-1466 # 8001f398 <itable>
    8000395a:	ffffd097          	auipc	ra,0xffffd
    8000395e:	2de080e7          	jalr	734(ra) # 80000c38 <acquire>
  empty = 0;
    80003962:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80003964:	0001c497          	auipc	s1,0x1c
    80003968:	a4c48493          	add	s1,s1,-1460 # 8001f3b0 <itable+0x18>
    8000396c:	0001d697          	auipc	a3,0x1d
    80003970:	4d468693          	add	a3,a3,1236 # 80020e40 <log>
    80003974:	a039                	j	80003982 <iget+0x44>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80003976:	02090b63          	beqz	s2,800039ac <iget+0x6e>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    8000397a:	08848493          	add	s1,s1,136
    ...
    80003990:	ff4713e3          	bne	a4,s4,80003976 <iget+0x38>
      ip->ref++;
    80003994:	2785                	addw	a5,a5,1
    80003996:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    80003998:	0001c517          	auipc	a0,0x1c
    8000399c:	a0050513          	add	a0,a0,-1536 # 8001f398 <itable>
  ...
  release(&itable.lock);
    ...
    800039cc:	9d050513          	add	a0,a0,-1584 # 8001f398 <itable>
    ...
    800039e6:	6145                	add	sp,sp,48
    800039e8:	8082                	ret
    panic("iget: no inodes");
    800039ea:	00005517          	auipc	a0,0x5
    800039ee:	b4e50513          	add	a0,a0,-1202 # 80008538 <etext+0x538>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    80003a16:	0001c997          	auipc	s3,0x1c
    80003a1a:	96298993          	add	s3,s3,-1694 # 8001f378 <sb>
    80003a1e:	02000613          	li	a2,32
    80003a22:	05850593          	add	a1,a0,88
  ...
  if(sb.magic != FSMAGIC)
    ...
    80003a42:	04078793          	add	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    80003a46:	02f71263          	bne	a4,a5,80003a6a <fsinit+0x70>
  initlog(dev, &sb);
    80003a4a:	0001c597          	auipc	a1,0x1c
    80003a4e:	92e58593          	add	a1,a1,-1746 # 8001f378 <sb>
...
0000000080003a7a <iinit>:
{
    ...
    80003a86:	1800                	add	s0,sp,48
  initlock(&itable.lock, "itable");
    80003a88:	00005597          	auipc	a1,0x5
    80003a8c:	ad858593          	add	a1,a1,-1320 # 80008560 <etext+0x560>
    80003a90:	0001c517          	auipc	a0,0x1c
    80003a94:	90850513          	add	a0,a0,-1784 # 8001f398 <itable>
    80003a98:	ffffd097          	auipc	ra,0xffffd
    80003a9c:	110080e7          	jalr	272(ra) # 80000ba8 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003aa0:	0001c497          	auipc	s1,0x1c
    80003aa4:	92048493          	add	s1,s1,-1760 # 8001f3c0 <itable+0x28>
    80003aa8:	0001d997          	auipc	s3,0x1d
    80003aac:	3a898993          	add	s3,s3,936 # 80020e50 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003ab0:	00005917          	auipc	s2,0x5
    80003ab4:	ab890913          	add	s2,s2,-1352 # 80008568 <etext+0x568>
  ...
  for(i = 0; i < NINODE; i++) {
    80003ac4:	08848493          	add	s1,s1,136
    ...
    80003ad6:	6145                	add	sp,sp,48
    80003ad8:	8082                	ret

0000000080003ada <ialloc>:
{
    80003ada:	7139                	add	sp,sp,-64
    80003adc:	fc06                	sd	ra,56(sp)
    80003ade:	f822                	sd	s0,48(sp)
    80003ae0:	0080                	add	s0,sp,64
  for(inum = 1; inum < sb.ninodes; inum++){
    80003ae2:	0001c717          	auipc	a4,0x1c
    80003ae6:	8a272703          	lw	a4,-1886(a4) # 8001f384 <sb+0xc>
    ...
    80003b02:	0001ca17          	auipc	s4,0x1c
    80003b06:	876a0a13          	add	s4,s4,-1930 # 8001f378 <sb>
    80003b0a:	00495593          	srl	a1,s2,0x4
    ...
    80003b20:	05850993          	add	s3,a0,88
    80003b24:	00f97793          	and	a5,s2,15
    80003b28:	079a                	sll	a5,a5,0x6
  ...
  printf("ialloc: no inodes\n");
    ...
    80003b58:	a1c50513          	add	a0,a0,-1508 # 80008570 <etext+0x570>
...
0000000080003bb2 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003bc2:	0047d79b          	srlw	a5,a5,0x4
    80003bc6:	0001b597          	auipc	a1,0x1b
    80003bca:	7ca5a583          	lw	a1,1994(a1) # 8001f390 <sb+0x18>
  ...
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003bdc:	05850793          	add	a5,a0,88
    80003be0:	40d8                	lw	a4,4(s1)
    80003be2:	8b3d                	and	a4,a4,15
    80003be4:	071a                	sll	a4,a4,0x6
  ...
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    ...
    80003c10:	05048593          	add	a1,s1,80
    80003c14:	00c78513          	add	a0,a5,12
...
0000000080003c40 <idup>:
{
  ...
  release(&itable.lock);
    ...
    80003c7a:	6105                	add	sp,sp,32
    80003c7c:	8082                	ret

0000000080003c7e <ilock>:
{
    80003c7e:	1101                	add	sp,sp,-32
  ...
  if(ip->valid == 0){
    ...
    80003cb0:	8dc50513          	add	a0,a0,-1828 # 80008588 <etext+0x588>
    ...
    80003cc0:	0047d79b          	srlw	a5,a5,0x4
    80003cc4:	0001b597          	auipc	a1,0x1b
    80003cc8:	6cc5a583          	lw	a1,1740(a1) # 8001f390 <sb+0x18>
    ...
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003cda:	05850593          	add	a1,a0,88
    80003cde:	40dc                	lw	a5,4(s1)
    80003ce0:	8bbd                	and	a5,a5,15
    ...
    80003d0e:	05b1                	add	a1,a1,12
    80003d10:	05048513          	add	a0,s1,80
    ...
    80003d38:	85c50513          	add	a0,a0,-1956 # 80008590 <etext+0x590>
...
0000000080003d44 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80003d84:	82050513          	add	a0,a0,-2016 # 800085a0 <etext+0x5a0>
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    80003da0:	05050493          	add	s1,a0,80
    80003da4:	08050913          	add	s2,a0,128
    80003da8:	a021                	j	80003db0 <itrunc+0x20>
    80003daa:	0491                	add	s1,s1,4
  ...
  iupdate(ip);
    ...
    80003df8:	05850493          	add	s1,a0,88
    80003dfc:	45850913          	add	s2,a0,1112
    80003e00:	a021                	j	80003e08 <itrunc+0x78>
    80003e02:	0491                	add	s1,s1,4
...
0000000080003e3c <iput>:
{
  ...
  acquire(&itable.lock);
    80003e48:	0001b517          	auipc	a0,0x1b
    80003e4c:	55050513          	add	a0,a0,1360 # 8001f398 <itable>
  ...
  ip->ref--;
    ...
    80003e62:	37fd                	addw	a5,a5,-1
    80003e64:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    80003e66:	0001b517          	auipc	a0,0x1b
    80003e6a:	53250513          	add	a0,a0,1330 # 8001f398 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    acquiresleep(&ip->lock);
    80003e8c:	01048913          	add	s2,s1,16
    ...
    80003e9e:	4fe50513          	add	a0,a0,1278 # 8001f398 <itable>
    ...
    acquire(&itable.lock);
    80003ed0:	0001b517          	auipc	a0,0x1b
    80003ed4:	4c850513          	add	a0,a0,1224 # 8001f398 <itable>
    ...
    80003f38:	10d7e563          	bltu	a5,a3,80004042 <readi+0x10c>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003f82:	020d1d93          	sll	s11,s10,0x20
    80003f86:	020ddd93          	srl	s11,s11,0x20
    80003f8a:	05890613          	add	a2,s2,88
    ...
    80003f9a:	8fa080e7          	jalr	-1798(ra) # 80002890 <either_copyout>
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    uint addr = bmap(ip, off/BSIZE);
    80003fba:	00a4d59b          	srlw	a1,s1,0xa
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    80003fdc:	3ff4f713          	and	a4,s1,1023
    ...
    80004048:	10d7ee63          	bltu	a5,a3,80004164 <writei+0x11e>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80004092:	020d1d93          	sll	s11,s10,0x20
    80004096:	020ddd93          	srl	s11,s11,0x20
    8000409a:	05848513          	add	a0,s1,88
    ...
    800040aa:	840080e7          	jalr	-1984(ra) # 800028e6 <either_copyin>
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    uint addr = bmap(ip, off/BSIZE);
    800040d4:	00a9559b          	srlw	a1,s2,0xa
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    800040f6:	3ff97713          	and	a4,s2,1023
...
{
    80004170:	1141                	add	sp,sp,-16
    80004172:	e406                	sd	ra,8(sp)
    80004174:	e022                	sd	s0,0(sp)
    80004176:	0800                	add	s0,sp,16
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800041e2:	fc040613          	add	a2,s0,-64
    ...
    800041fe:	fc240593          	add	a1,s0,-62
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    8000426a:	a70080e7          	jalr	-1424(ra) # 80001cd6 <myproc>
    8000426e:	15853503          	ld	a0,344(a0)
...
000000008000439a <dirlink>:
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800043c8:	fc040613          	add	a2,s0,-64
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    800043f2:	fc240513          	add	a0,s0,-62
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80004440:	19450513          	add	a0,a0,404 # 800085d0 <etext+0x5d0>
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    80004454:	fe040613          	add	a2,s0,-32
...
write_head(void)
{
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800044ba:	9ba70713          	add	a4,a4,-1606 # 80020e70 <log+0x30>
    800044be:	87aa                	mv	a5,a0
    800044c0:	060a                	sll	a2,a2,0x2
  ...
  brelse(buf);
    ...
    800044ec:	6105                	add	sp,sp,32
    800044ee:	8082                	ret

00000000800044f0 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    800044f0:	0001d797          	auipc	a5,0x1d
    800044f4:	97c7a783          	lw	a5,-1668(a5) # 80020e6c <log+0x2c>
    800044f8:	0af05d63          	blez	a5,800045b2 <install_trans+0xc2>
{
    ...
    8000450e:	0080                	add	s0,sp,64
    80004510:	8b2a                	mv	s6,a0
    80004512:	0001da97          	auipc	s5,0x1d
    80004516:	95ea8a93          	add	s5,s5,-1698 # 80020e70 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    8000451a:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    8000451c:	0001d997          	auipc	s3,0x1d
    80004520:	92498993          	add	s3,s3,-1756 # 80020e40 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    8000453a:	2a05                	addw	s4,s4,1
    8000453c:	0a91                	add	s5,s5,4
    ...
    80004574:	05890593          	add	a1,s2,88
    80004578:	05850513          	add	a0,a0,88
    ...
    800045ae:	6121                	add	sp,sp,64
    800045b0:	8082                	ret
    800045b2:	8082                	ret

00000000800045b4 <initlog>:
{
    800045b4:	7179                	add	sp,sp,-48
    ...
    800045c0:	1800                	add	s0,sp,48
    800045c2:	892a                	mv	s2,a0
    800045c4:	89ae                	mv	s3,a1
  initlock(&log.lock, "log");
    800045c6:	0001d497          	auipc	s1,0x1d
    800045ca:	87a48493          	add	s1,s1,-1926 # 80020e40 <log>
    800045ce:	00004597          	auipc	a1,0x4
    800045d2:	01258593          	add	a1,a1,18 # 800085e0 <etext+0x5e0>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80004608:	86c70713          	add	a4,a4,-1940 # 80020e70 <log+0x30>
    8000460c:	060a                	sll	a2,a2,0x2
    8000460e:	962a                	add	a2,a2,a0
    log.lh.block[i] = lh->block[i];
    80004610:	4ff4                	lw	a3,92(a5)
    80004612:	c314                	sw	a3,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80004614:	0791                	add	a5,a5,4
    80004616:	0711                	add	a4,a4,4
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80004632:	8207af23          	sw	zero,-1986(a5) # 80020e6c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000465c:	7e850513          	add	a0,a0,2024 # 80020e40 <log>
    80004660:	ffffc097          	auipc	ra,0xffffc
    80004664:	5d8080e7          	jalr	1496(ra) # 80000c38 <acquire>
  while(1){
    if(log.committing){
    80004668:	0001c497          	auipc	s1,0x1c
    8000466c:	7d848493          	add	s1,s1,2008 # 80020e40 <log>
      sleep(&log, &log.lock);
    ...
    8000467c:	e10080e7          	jalr	-496(ra) # 80002488 <sleep>
    if(log.committing){
    80004680:	50dc                	lw	a5,36(s1)
    80004682:	fbed                	bnez	a5,80004674 <begin_op+0x28>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
    80004684:	5098                	lw	a4,32(s1)
    80004686:	2705                	addw	a4,a4,1
    80004688:	0027179b          	sllw	a5,a4,0x2
    8000468c:	9fb9                	addw	a5,a5,a4
    8000468e:	0017979b          	sllw	a5,a5,0x1
    ...
    800046a2:	dea080e7          	jalr	-534(ra) # 80002488 <sleep>
    800046a6:	bfe9                	j	80004680 <begin_op+0x34>
    } else {
      log.outstanding += 1;
    800046a8:	0001c517          	auipc	a0,0x1c
    800046ac:	79850513          	add	a0,a0,1944 # 80020e40 <log>
...
end_op(void)
{
    800046c6:	7139                	add	sp,sp,-64
    800046c8:	fc06                	sd	ra,56(sp)
    800046ca:	f822                	sd	s0,48(sp)
    800046cc:	f426                	sd	s1,40(sp)
    800046ce:	f04a                	sd	s2,32(sp)
    800046d0:	0080                	add	s0,sp,64
  int do_commit = 0;

  acquire(&log.lock);
    800046d2:	0001c497          	auipc	s1,0x1c
    800046d6:	76e48493          	add	s1,s1,1902 # 80020e40 <log>
  ...
  if(log.outstanding == 0){
    ...
    800046fa:	74a48493          	add	s1,s1,1866 # 80020e40 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    acquire(&log.lock);
    80004712:	0001c497          	auipc	s1,0x1c
    80004716:	72e48493          	add	s1,s1,1838 # 80020e40 <log>
    ...
    8000472e:	dc2080e7          	jalr	-574(ra) # 800024ec <wakeup>
    release(&log.lock);
    ...
    80004748:	ea450513          	add	a0,a0,-348 # 800085e8 <etext+0x5e8>
    8000474c:	ffffc097          	auipc	ra,0xffffc
    80004750:	e14080e7          	jalr	-492(ra) # 80000560 <panic>
    wakeup(&log);
    80004754:	0001c497          	auipc	s1,0x1c
    80004758:	6ec48493          	add	s1,s1,1772 # 80020e40 <log>
    8000475c:	8526                	mv	a0,s1
    8000475e:	ffffe097          	auipc	ra,0xffffe
    80004762:	d8e080e7          	jalr	-626(ra) # 800024ec <wakeup>
  release(&log.lock);
    ...
    80004778:	6121                	add	sp,sp,64
    8000477a:	8082                	ret
    8000477c:	ec4e                	sd	s3,24(sp)
    8000477e:	e852                	sd	s4,16(sp)
    80004780:	e456                	sd	s5,8(sp)
  for (tail = 0; tail < log.lh.n; tail++) {
    80004782:	0001ca97          	auipc	s5,0x1c
    80004786:	6eea8a93          	add	s5,s5,1774 # 80020e70 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    8000478a:	0001ca17          	auipc	s4,0x1c
    8000478e:	6b6a0a13          	add	s4,s4,1718 # 80020e40 <log>
    80004792:	018a2583          	lw	a1,24(s4)
    80004796:	012585bb          	addw	a1,a1,s2
    8000479a:	2585                	addw	a1,a1,1
    ...
    800047c0:	05850593          	add	a1,a0,88
    800047c4:	05848513          	add	a0,s1,88
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    800047ee:	2905                	addw	s2,s2,1
    800047f0:	0a91                	add	s5,s5,4
    ...
    log.lh.n = 0;
    8000480c:	0001c797          	auipc	a5,0x1c
    80004810:	6607a023          	sw	zero,1632(a5) # 80020e6c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    80004832:	0001c917          	auipc	s2,0x1c
    80004836:	60e90913          	add	s2,s2,1550 # 80020e40 <log>
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    ...
    8000484e:	0001c797          	auipc	a5,0x1c
    80004852:	60e7a783          	lw	a5,1550(a5) # 80020e5c <log+0x1c>
    80004856:	37fd                	addw	a5,a5,-1
    80004858:	04f65e63          	bge	a2,a5,800048b4 <log_write+0x90>
    panic("too big a transaction");
  if (log.outstanding < 1)
    8000485c:	0001c797          	auipc	a5,0x1c
    80004860:	6047a783          	lw	a5,1540(a5) # 80020e60 <log+0x20>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80004874:	60070713          	add	a4,a4,1536 # 80020e70 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  for (i = 0; i < log.lh.n; i++) {
    80004880:	2785                	addw	a5,a5,1
    80004882:	0711                	add	a4,a4,4
    80004884:	fef61be3          	bne	a2,a5,8000487a <log_write+0x56>
      break;
  }
  log.lh.block[i] = b->blockno;
    80004888:	0621                	add	a2,a2,8
    8000488a:	060a                	sll	a2,a2,0x2
    8000488c:	0001c797          	auipc	a5,0x1c
    80004890:	5b478793          	add	a5,a5,1460 # 80020e40 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    800048a8:	59c70713          	add	a4,a4,1436 # 80020e40 <log>
    800048ac:	575c                	lw	a5,44(a4)
    800048ae:	2785                	addw	a5,a5,1
    800048b0:	d75c                	sw	a5,44(a4)
    800048b2:	a82d                	j	800048ec <log_write+0xc8>
    panic("too big a transaction");
    800048b4:	00004517          	auipc	a0,0x4
    800048b8:	d4450513          	add	a0,a0,-700 # 800085f8 <etext+0x5f8>
    800048bc:	ffffc097          	auipc	ra,0xffffc
    800048c0:	ca4080e7          	jalr	-860(ra) # 80000560 <panic>
    panic("log_write outside of trans");
    800048c4:	00004517          	auipc	a0,0x4
    800048c8:	d4c50513          	add	a0,a0,-692 # 80008610 <etext+0x610>
    800048cc:	ffffc097          	auipc	ra,0xffffc
    800048d0:	c94080e7          	jalr	-876(ra) # 80000560 <panic>
  log.lh.block[i] = b->blockno;
    800048d4:	00878693          	add	a3,a5,8
    800048d8:	068a                	sll	a3,a3,0x2
    800048da:	0001c717          	auipc	a4,0x1c
    800048de:	56670713          	add	a4,a4,1382 # 80020e40 <log>
  ...
  release(&log.lock);
    800048ec:	0001c517          	auipc	a0,0x1c
    800048f0:	55450513          	add	a0,a0,1364 # 80020e40 <log>
...
acquiresleep(struct sleeplock *lk)
{
  ...
  while (lk->locked) {
    ...
    8000496a:	b22080e7          	jalr	-1246(ra) # 80002488 <sleep>
  while (lk->locked) {
  ...
  lk->pid = myproc()->pid;
    ...
    8000497a:	360080e7          	jalr	864(ra) # 80001cd6 <myproc>
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    800049c2:	b2e080e7          	jalr	-1234(ra) # 800024ec <wakeup>
  release(&lk->lk);
...
fileinit(void)
{
    80004a32:	1141                	add	sp,sp,-16
    80004a34:	e406                	sd	ra,8(sp)
    80004a36:	e022                	sd	s0,0(sp)
    80004a38:	0800                	add	s0,sp,16
  initlock(&ftable.lock, "ftable");
    80004a3a:	00004597          	auipc	a1,0x4
    80004a3e:	c0658593          	add	a1,a1,-1018 # 80008640 <etext+0x640>
    80004a42:	0001c517          	auipc	a0,0x1c
    80004a46:	54650513          	add	a0,a0,1350 # 80020f88 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    80004a94:	4f850513          	add	a0,a0,1272 # 80020f88 <ftable>
  ...
  return 0;
    ...
    80004aa6:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    80004aa8:	0001c517          	auipc	a0,0x1c
    80004aac:	4e050513          	add	a0,a0,1248 # 80020f88 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004ad4:	4b850513          	add	a0,a0,1208 # 80020f88 <ftable>
  ...
  if(f->ref < 1)
    ...
    panic("filedup");
  f->ref++;
    80004ae6:	2785                	addw	a5,a5,1
    80004ae8:	c0dc                	sw	a5,4(s1)
  release(&ftable.lock);
    80004aea:	0001c517          	auipc	a0,0x1c
    80004aee:	49e50513          	add	a0,a0,1182 # 80020f88 <ftable>
  ...
  return f;
    ...
    80004b02:	6105                	add	sp,sp,32
    80004b04:	8082                	ret
    panic("filedup");
    80004b06:	00004517          	auipc	a0,0x4
    80004b0a:	b4250513          	add	a0,a0,-1214 # 80008648 <etext+0x648>
...
{
    80004b16:	7139                	add	sp,sp,-64
    80004b18:	fc06                	sd	ra,56(sp)
    80004b1a:	f822                	sd	s0,48(sp)
    80004b1c:	f426                	sd	s1,40(sp)
    80004b1e:	0080                	add	s0,sp,64
    80004b20:	84aa                	mv	s1,a0
  struct file ff;

  acquire(&ftable.lock);
    80004b22:	0001c517          	auipc	a0,0x1c
    80004b26:	46650513          	add	a0,a0,1126 # 80020f88 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004b68:	42450513          	add	a0,a0,1060 # 80020f88 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    stati(f->ip, &st);
    80004c28:	fb840593          	add	a1,s0,-72
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004cf0:	03079693          	sll	a3,a5,0x30
    80004cf4:	92c1                	srl	a3,a3,0x30
    80004cf6:	4725                	li	a4,9
    80004cf8:	02d76a63          	bltu	a4,a3,80004d2c <fileread+0xc2>
    80004cfc:	0792                	sll	a5,a5,0x4
    80004cfe:	0001c717          	auipc	a4,0x1c
    80004d02:	1ea70713          	add	a4,a4,490 # 80020ee8 <devsw>
    ...
    80004d1c:	94850513          	add	a0,a0,-1720 # 80008660 <etext+0x660>
    ...
    80004d40:	12078963          	beqz	a5,80004e72 <filewrite+0x136>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004d7e:	c00b8b93          	add	s7,s7,-1024 # c00 <_entry-0x7ffff400>
    80004d82:	6c05                	lui	s8,0x1
    80004d84:	c00c0c1b          	addw	s8,s8,-1024 # c00 <_entry-0x7ffff400>
    ...
    80004d9a:	03079693          	sll	a3,a5,0x30
    80004d9e:	92c1                	srl	a3,a3,0x30
    80004da0:	4725                	li	a4,9
    80004da2:	0cd76a63          	bltu	a4,a3,80004e76 <filewrite+0x13a>
    80004da6:	0792                	sll	a5,a5,0x4
    80004da8:	0001c717          	auipc	a4,0x1c
    80004dac:	14070713          	add	a4,a4,320 # 80020ee8 <devsw>
  ...
  return ret;
    ...
    80004e66:	80e50513          	add	a0,a0,-2034 # 80008670 <etext+0x670>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004edc:	7a858593          	add	a1,a1,1960 # 80008680 <etext+0x680>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    wakeup(&pi->nread);
    80004f84:	21848513          	add	a0,s1,536
    80004f88:	ffffd097          	auipc	ra,0xffffd
    80004f8c:	564080e7          	jalr	1380(ra) # 800024ec <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80004fb2:	6105                	add	sp,sp,32
    80004fb4:	8082                	ret
    pi->readopen = 0;
    80004fb6:	2204a023          	sw	zero,544(s1)
    wakeup(&pi->nwrite);
    80004fba:	21c48513          	add	a0,s1,540
    80004fbe:	ffffd097          	auipc	ra,0xffffd
    80004fc2:	52e080e7          	jalr	1326(ra) # 800024ec <wakeup>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004ff0:	cea080e7          	jalr	-790(ra) # 80001cd6 <myproc>
  ...
  int i = 0;
    ...
    8000500c:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    8000500e:	21848c13          	add	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80005012:	21c48b93          	add	s7,s1,540
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    800050f8:	be2080e7          	jalr	-1054(ra) # 80001cd6 <myproc>
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80005110:	21848993          	add	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80005124:	610080e7          	jalr	1552(ra) # 80002730 <killed>
    ...
    80005132:	35a080e7          	jalr	858(ra) # 80002488 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    8000519c:	2985                	addw	s3,s3,1
    8000519e:	0905                	add	s2,s2,1
    800051a0:	fd3a91e3          	bne	s5,s3,80005162 <piperead+0x86>
    800051a4:	89d6                	mv	s3,s5
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    800051a6:	21c48513          	add	a0,s1,540
    800051aa:	ffffd097          	auipc	ra,0xffffd
    800051ae:	342080e7          	jalr	834(ra) # 800024ec <wakeup>
  release(&pi->lock);
...
{
    800051d2:	1141                	add	sp,sp,-16
    800051d4:	e422                	sd	s0,8(sp)
    800051d6:	0800                	add	s0,sp,16
    800051d8:	87aa                	mv	a5,a0
    int perm = 0;
    if(flags & 0x1)
    800051da:	8905                	and	a0,a0,1
    800051dc:	050e                	sll	a0,a0,0x3
      perm = PTE_X;
    if(flags & 0x2)
    800051de:	8b89                	and	a5,a5,2
    800051e0:	c399                	beqz	a5,800051e6 <flags2perm+0x14>
      perm |= PTE_W;
    800051e2:	00456513          	or	a0,a0,4
    return perm;
}
...
exec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    ...
    8000520c:	ace080e7          	jalr	-1330(ra) # 80001cd6 <myproc>
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    80005238:	e5040613          	add	a2,s0,-432
  ...
  if(elf.magic != ELF_MAGIC)
    ...
    80005258:	57f78793          	add	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
 ...
 bad:
  ...
  return -1;
    ...
    80005282:	21010113          	add	sp,sp,528
    80005286:	8082                	ret
    end_op();
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    8000529c:	b02080e7          	jalr	-1278(ra) # 80001d9a <proc_pagetable>
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    800052c6:	fffc8793          	add	a5,s9,-1 # fff <_entry-0x7ffff001>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800052d6:	3b650513          	add	a0,a0,950 # 80008688 <etext+0x688>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    pa = walkaddr(pagetable, va + i);
    80005304:	02091593          	sll	a1,s2,0x20
    80005308:	9181                	srl	a1,a1,0x20
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    8000532e:	2d85                	addw	s11,s11,1
    80005330:	038d0d1b          	addw	s10,s10,56
    ...
    80005344:	e1840613          	add	a2,s0,-488
  ...
  p = myproc();
    ...
    800053dc:	8fe080e7          	jalr	-1794(ra) # 80001cd6 <myproc>
    800053e0:	8aaa                	mv	s5,a0
  uint64 oldsz = p->sz;
    800053e2:	05053c83          	ld	s9,80(a0)
  sz = PGROUNDUP(sz);
    800053e6:	6985                	lui	s3,0x1
    800053e8:	19fd                	add	s3,s3,-1 # fff <_entry-0x7ffff001>
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80005466:	0015069b          	addw	a3,a0,1
  ...
  ustack[argc] = 0;
    800054a0:	00349793          	sll	a5,s1,0x3
    800054a4:	f9078793          	add	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdcf10>
    800054a8:	97a2                	add	a5,a5,s0
    800054aa:	f007b023          	sd	zero,-256(a5)
  sp -= (argc+1) * sizeof(uint64);
    800054ae:	00148693          	add	a3,s1,1
    800054b2:	068e                	sll	a3,a3,0x3
    800054b4:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    800054b8:	ff097913          	and	s2,s2,-16
  sz = sz1;
    800054bc:	e0843983          	ld	s3,-504(s0)
  if(sp < stackbase)
    800054c0:	f57966e3          	bltu	s2,s7,8000540c <exec+0x220>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    800054c4:	e9040613          	add	a2,s0,-368
  ...
  p->trapframe->a1 = sp;
    800054d8:	060ab783          	ld	a5,96(s5) # 1060 <_entry-0x7fffefa0>
  ...
  if(pagetable)
    ...
    80005594:	8a6080e7          	jalr	-1882(ra) # 80001e36 <proc_freepagetable>
  return -1;
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  argint(n, &fd);
    800055da:	fdc40593          	add	a1,s0,-36
    800055de:	ffffe097          	auipc	ra,0xffffe
    800055e2:	a6a080e7          	jalr	-1430(ra) # 80003048 <argint>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    800055f4:	6e6080e7          	jalr	1766(ra) # 80001cd6 <myproc>
    800055f8:	fdc42703          	lw	a4,-36(s0)
    800055fc:	01a70793          	add	a5,a4,26
    80005600:	078e                	sll	a5,a5,0x3
    80005602:	953e                	add	a0,a0,a5
    80005604:	651c                	ld	a5,8(a0)
...
fdalloc(struct file *f)
{
  ...
  return -1;
    ...
    8000565c:	6105                	add	sp,sp,32
    8000565e:	8082                	ret
      p->ofile[fd] = f;
    80005660:	01a50793          	add	a5,a0,26
    80005664:	078e                	sll	a5,a5,0x3
    80005666:	963e                	add	a2,a2,a5
    80005668:	e604                	sd	s1,8(a2)
      return fd;
...
create(char *path, short type, short major, short minor)
{
  ...
  if((dp = nameiparent(path, name)) == 0)
    80005684:	fb040593          	add	a1,s0,-80
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    800056d0:	37f9                	addw	a5,a5,-2
    800056d2:	17c2                	sll	a5,a5,0x30
    800056d4:	93c1                	srl	a5,a5,0x30
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    80005738:	fb040593          	add	a1,s0,-80
  ...
  return ip;
    ...
    80005772:	f3a58593          	add	a1,a1,-198 # 800086a8 <etext+0x6a8>
    ...
    8000578a:	f2a58593          	add	a1,a1,-214 # 800086b0 <etext+0x6b0>
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    800057a0:	fb040593          	add	a1,s0,-80
...
{
    800057f2:	7179                	add	sp,sp,-48
    800057f4:	f406                	sd	ra,40(sp)
    800057f6:	f022                	sd	s0,32(sp)
    800057f8:	1800                	add	s0,sp,48
  if(argfd(0, 0, &f) < 0)
    800057fa:	fd840613          	add	a2,s0,-40
...
000000008000584a <sys_read>:
{
    ...
    80005850:	1800                	add	s0,sp,48
  argaddr(1, &p);
    80005852:	fd840593          	add	a1,s0,-40
    80005856:	4505                	li	a0,1
    80005858:	ffffe097          	auipc	ra,0xffffe
    8000585c:	810080e7          	jalr	-2032(ra) # 80003068 <argaddr>
  argint(2, &n);
    80005860:	fe440593          	add	a1,s0,-28
    80005864:	4509                	li	a0,2
    80005866:	ffffd097          	auipc	ra,0xffffd
    8000586a:	7e2080e7          	jalr	2018(ra) # 80003048 <argint>
  if(argfd(0, 0, &f) < 0)
    8000586e:	fe840613          	add	a2,s0,-24
...
{
    800058a2:	7179                	add	sp,sp,-48
    800058a4:	f406                	sd	ra,40(sp)
    800058a6:	f022                	sd	s0,32(sp)
    800058a8:	1800                	add	s0,sp,48
  argaddr(1, &p);
    800058aa:	fd840593          	add	a1,s0,-40
    800058ae:	4505                	li	a0,1
    800058b0:	ffffd097          	auipc	ra,0xffffd
    800058b4:	7b8080e7          	jalr	1976(ra) # 80003068 <argaddr>
  argint(2, &n);
    800058b8:	fe440593          	add	a1,s0,-28
    800058bc:	4509                	li	a0,2
    800058be:	ffffd097          	auipc	ra,0xffffd
    800058c2:	78a080e7          	jalr	1930(ra) # 80003048 <argint>
  if(argfd(0, 0, &f) < 0)
    800058c6:	fe840613          	add	a2,s0,-24
...
{
    800058fa:	1101                	add	sp,sp,-32
    800058fc:	ec06                	sd	ra,24(sp)
    800058fe:	e822                	sd	s0,16(sp)
    80005900:	1000                	add	s0,sp,32
  if(argfd(0, &fd, &f) < 0)
    80005902:	fe040613          	add	a2,s0,-32
    80005906:	fec40593          	add	a1,s0,-20
  ...
  myproc()->ofile[fd] = 0;
    ...
    8000591e:	3bc080e7          	jalr	956(ra) # 80001cd6 <myproc>
    80005922:	fec42783          	lw	a5,-20(s0)
    80005926:	07e9                	add	a5,a5,26
    80005928:	078e                	sll	a5,a5,0x3
    8000592a:	953e                	add	a0,a0,a5
    8000592c:	00053423          	sd	zero,8(a0)
  fileclose(f);
...
0000000080005948 <sys_fstat>:
{
  ...
  argaddr(1, &st);
    80005950:	fe040593          	add	a1,s0,-32
    80005954:	4505                	li	a0,1
    80005956:	ffffd097          	auipc	ra,0xffffd
    8000595a:	712080e7          	jalr	1810(ra) # 80003068 <argaddr>
  if(argfd(0, 0, &f) < 0)
    8000595e:	fe840613          	add	a2,s0,-24
...
000000008000598e <sys_link>:
{
  ...
  if((ip = namei(old)) == 0){
    800059d0:	ed040513          	add	a0,s0,-304
  ...
  if((dp = nameiparent(new, name)) == 0)
    80005a12:	fd040593          	add	a1,s0,-48
    80005a16:	f5040513          	add	a0,s0,-176
  ...
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    ...
    80005a3a:	fd040593          	add	a1,s0,-48
...
0000000080005ae0 <sys_unlink>:
{
  ...
  if((dp = nameiparent(path, name)) == 0){
    80005b08:	fb040593          	add	a1,s0,-80
    80005b0c:	f3040513          	add	a0,s0,-208
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    80005b28:	b8458593          	add	a1,a1,-1148 # 800086a8 <etext+0x6a8>
    80005b2c:	fb040513          	add	a0,s0,-80
    ...
    80005b40:	b7458593          	add	a1,a1,-1164 # 800086b0 <etext+0x6b0>
    80005b44:	fb040513          	add	a0,s0,-80
  ...
  if((ip = dirlookup(dp, name, &off)) == 0)
    80005b56:	f2c40613          	add	a2,s0,-212
    80005b5a:	fb040593          	add	a1,s0,-80
  ...
  memset(&de, 0, sizeof(de));
    ...
    80005b8c:	fc040513          	add	a0,s0,-64
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80005b9e:	fc040613          	add	a2,s0,-64
  ...
  return 0;
    ...
    80005c0a:	ab250513          	add	a0,a0,-1358 # 800086b8 <etext+0x6b8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005c2c:	f1840613          	add	a2,s0,-232
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005c5a:	a7a50513          	add	a0,a0,-1414 # 800086d0 <etext+0x6d0>
...
sys_open(void)
{
    80005cc2:	7131                	add	sp,sp,-192
    80005cc4:	fd06                	sd	ra,184(sp)
    80005cc6:	f922                	sd	s0,176(sp)
    80005cc8:	0180                	add	s0,sp,192
  int fd, omode;
  struct file *f;
  struct inode *ip;
  int n;
  ...
  argint(1, &omode);
    80005cca:	f4c40593          	add	a1,s0,-180
    80005cce:	4505                	li	a0,1
    80005cd0:	ffffd097          	auipc	ra,0xffffd
    80005cd4:	378080e7          	jalr	888(ra) # 80003048 <argint>
  if((n = argstr(0, path, MAXPATH)) < 0)
    80005cd8:	08000613          	li	a2,128
    80005cdc:	f5040593          	add	a1,s0,-176
    80005ce0:	4501                	li	a0,0
    80005ce2:	ffffd097          	auipc	ra,0xffffd
    80005ce6:	3a6080e7          	jalr	934(ra) # 80003088 <argstr>
  ...
  f->readable = !(omode & O_WRONLY);
    ...
    80005d6a:	0017c713          	xor	a4,a5,1
    80005d6e:	8b05                	and	a4,a4,1
    80005d70:	00e90423          	sb	a4,8(s2)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    80005d74:	0037f713          	and	a4,a5,3
    80005d78:	00e03733          	snez	a4,a4
    80005d7c:	00e904a3          	sb	a4,9(s2)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    80005d80:	4007f793          	and	a5,a5,1024
  ...
  return fd;
    ...
    if((ip = namei(path)) == 0){
    80005dc0:	f5040513          	add	a0,s0,-176
...
sys_mkdir(void)
{
    80005e66:	7175                	add	sp,sp,-144
    80005e68:	e506                	sd	ra,136(sp)
    80005e6a:	e122                	sd	s0,128(sp)
    80005e6c:	0900                	add	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;
...
sys_mknod(void)
{
    80005ec6:	7135                	add	sp,sp,-160
    80005ec8:	ed06                	sd	ra,152(sp)
    80005eca:	e922                	sd	s0,144(sp)
    80005ecc:	1100                	add	s0,sp,160
  struct inode *ip;
  char path[MAXPATH];
  int major, minor;
  ...
  argint(1, &major);
    80005ed6:	f6c40593          	add	a1,s0,-148
    80005eda:	4505                	li	a0,1
    80005edc:	ffffd097          	auipc	ra,0xffffd
    80005ee0:	16c080e7          	jalr	364(ra) # 80003048 <argint>
  argint(2, &minor);
    80005ee4:	f6840593          	add	a1,s0,-152
    80005ee8:	4509                	li	a0,2
    80005eea:	ffffd097          	auipc	ra,0xffffd
    80005eee:	15e080e7          	jalr	350(ra) # 80003048 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80005ef2:	08000613          	li	a2,128
    80005ef6:	f7040593          	add	a1,s0,-144
    80005efa:	4501                	li	a0,0
    80005efc:	ffffd097          	auipc	ra,0xffffd
    80005f00:	18c080e7          	jalr	396(ra) # 80003088 <argstr>
    ...
    80005f12:	f7040513          	add	a0,s0,-144
...
sys_chdir(void)
{
  ...
  iput(p->cwd);
    80005fa6:	15893503          	ld	a0,344(s2)
  ...
  p->cwd = ip;
    80005fba:	14993c23          	sd	s1,344(s2)
  return 0;
...
sys_exec(void)
{
    80005ff2:	7121                	add	sp,sp,-448
    80005ff4:	ff06                	sd	ra,440(sp)
    80005ff6:	fb22                	sd	s0,432(sp)
    80005ff8:	0380                	add	s0,sp,448
  char path[MAXPATH], *argv[MAXARG];
  int i;
  uint64 uargv, uarg;

  argaddr(1, &uargv);
    80005ffa:	e4840593          	add	a1,s0,-440
    80005ffe:	4505                	li	a0,1
    80006000:	ffffd097          	auipc	ra,0xffffd
    80006004:	068080e7          	jalr	104(ra) # 80003068 <argaddr>
  if(argstr(0, path, MAXPATH) < 0) {
    80006008:	08000613          	li	a2,128
    8000600c:	f5040593          	add	a1,s0,-176
    80006010:	4501                	li	a0,0
    80006012:	ffffd097          	auipc	ra,0xffffd
    80006016:	076080e7          	jalr	118(ra) # 80003088 <argstr>
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80006048:	00391513          	sll	a0,s2,0x3
    8000604c:	e4040593          	add	a1,s0,-448
    80006050:	e4843783          	ld	a5,-440(s0)
    80006054:	953e                	add	a0,a0,a5
    80006056:	ffffd097          	auipc	ra,0xffffd
    8000605a:	f54080e7          	jalr	-172(ra) # 80002faa <fetchaddr>
    ...
    80006082:	f7e080e7          	jalr	-130(ra) # 80002ffc <fetchstr>
    80006086:	00054663          	bltz	a0,80006092 <sys_exec+0xa0>
    if(i >= NELEM(argv)){
    8000608a:	0905                	add	s2,s2,1
    8000608c:	09a1                	add	s3,s3,8
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80006092:	f5040913          	add	s2,s0,-176
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80006118:	bc2080e7          	jalr	-1086(ra) # 80001cd6 <myproc>
    8000611c:	84aa                	mv	s1,a0

  argaddr(0, &fdarray);
    8000611e:	fd840593          	add	a1,s0,-40
    80006122:	4501                	li	a0,0
    80006124:	ffffd097          	auipc	ra,0xffffd
    80006128:	f44080e7          	jalr	-188(ra) # 80003068 <argaddr>
  if(pipealloc(&rf, &wf) < 0)
    8000612c:	fc840593          	add	a1,s0,-56
    80006130:	fd040513          	add	a0,s0,-48
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80006170:	fc440613          	add	a2,s0,-60
    80006174:	fd843583          	ld	a1,-40(s0)
    80006178:	6ca8                	ld	a0,88(s1)
    ...
    80006188:	fc040613          	add	a2,s0,-64
    8000618c:	fd843583          	ld	a1,-40(s0)
    80006190:	0591                	add	a1,a1,4
    80006192:	6ca8                	ld	a0,88(s1)
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800061a6:	07e9                	add	a5,a5,26
    800061a8:	078e                	sll	a5,a5,0x3
    800061aa:	97a6                	add	a5,a5,s1
    800061ac:	0007b423          	sd	zero,8(a5)
    p->ofile[fd1] = 0;
    800061b0:	fc042783          	lw	a5,-64(s0)
    800061b4:	07e9                	add	a5,a5,26
    800061b6:	078e                	sll	a5,a5,0x3
    800061b8:	94be                	add	s1,s1,a5
    800061ba:	0004b423          	sd	zero,8(s1)
    fileclose(rf);
    ...
    800061de:	0007c763          	bltz	a5,800061ec <sys_pipe+0xe2>
      p->ofile[fd0] = 0;
    800061e2:	07e9                	add	a5,a5,26
    800061e4:	078e                	sll	a5,a5,0x3
    800061e6:	97a6                	add	a5,a5,s1
    800061e8:	0007b423          	sd	zero,8(a5)
    fileclose(rf);
    ...
    8000620e:	6121                	add	sp,sp,64
    80006210:	8082                	ret
	...

0000000080006220 <kernelvec>:
    80006220:	7111                	add	sp,sp,-256
    ...
    80006260:	c15fc0ef          	jal	80002e74 <kerneltrap>
...
plicinithart(void)
{
    800062f4:	1141                	add	sp,sp,-16
    800062f6:	e406                	sd	ra,8(sp)
    800062f8:	e022                	sd	s0,0(sp)
    800062fa:	0800                	add	s0,sp,16
  int hart = cpuid();
    800062fc:	ffffc097          	auipc	ra,0xffffc
    80006300:	9ae080e7          	jalr	-1618(ra) # 80001caa <cpuid>
  
  // set enable bits for this hart's S-mode
  // for the uart and virtio disk.
  *(uint32*)PLIC_SENABLE(hart) = (1 << UART0_IRQ) | (1 << VIRTIO0_IRQ);
    80006304:	0085171b          	sllw	a4,a0,0x8
  ...
  *(uint32*)PLIC_SPRIORITY(hart) = 0;
    80006316:	00d5151b          	sllw	a0,a0,0xd
...
00000000800063fc <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000640c:	31058593          	add	a1,a1,784 # 80008718 <etext+0x718>
    80006410:	0001c517          	auipc	a0,0x1c
    80006414:	c5850513          	add	a0,a0,-936 # 80022068 <disk+0x128>
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    8000642c:	97678793          	add	a5,a5,-1674 # 74726976 <_entry-0xb8d968a>
    80006430:	18f71c63          	bne	a4,a5,800065c8 <virtio_disk_init+0x1cc>
     *R(VIRTIO_MMIO_VERSION) != 2 ||
    80006434:	100017b7          	lui	a5,0x10001
    80006438:	0791                	add	a5,a5,4 # 10001004 <_entry-0x6fffeffc>
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    80006448:	07a1                	add	a5,a5,8 # 10001008 <_entry-0x6fffeff8>
    ...
    8000645e:	55178793          	add	a5,a5,1361 # 554d4551 <_entry-0x2ab2baaf>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80006480:	75f70713          	add	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc6df>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  if(*R(VIRTIO_MMIO_QUEUE_READY))
    ...
    800064ac:	04478793          	add	a5,a5,68 # 10001044 <_entry-0x6fffefbc>
  ...
  uint32 max = *R(VIRTIO_MMIO_QUEUE_NUM_MAX);
    ...
    800064bc:	03478793          	add	a5,a5,52 # 10001034 <_entry-0x6fffefcc>
  ...
  disk.desc = kalloc();
    ...
    800064da:	a6a48493          	add	s1,s1,-1430 # 80021f40 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80006500:	a4c73703          	ld	a4,-1460(a4) # 80021f48 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80006518:	0001c497          	auipc	s1,0x1c
    8000651c:	a2848493          	add	s1,s1,-1496 # 80021f40 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
    ...
    80006640:	1880                	add	s0,sp,112
    80006642:	8a2a                	mv	s4,a0
    80006644:	8bae                	mv	s7,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    80006646:	00c52c83          	lw	s9,12(a0)
    8000664a:	001c9c9b          	sllw	s9,s9,0x1
    8000664e:	1c82                	sll	s9,s9,0x20
    80006650:	020cdc93          	srl	s9,s9,0x20

  acquire(&disk.vdisk_lock);
    80006654:	0001c517          	auipc	a0,0x1c
    80006658:	a1450513          	add	a0,a0,-1516 # 80022068 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    80006666:	44a1                	li	s1,8
      disk.free[i] = 0;
    80006668:	0001cb17          	auipc	s6,0x1c
    8000666c:	8d8b0b13          	add	s6,s6,-1832 # 80021f40 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80006672:	0001cc17          	auipc	s8,0x1c
    80006676:	9f6c0c13          	add	s8,s8,-1546 # 80022068 <disk+0x128>
  ...
  for(int i = 0; i < 3; i++){
    8000668a:	2905                	addw	s2,s2,1
    8000668c:	0611                	add	a2,a2,4 # 1004 <_entry-0x7fffeffc>
    8000668e:	05590f63          	beq	s2,s5,800066ec <virtio_disk_rw+0xc4>
    idx[i] = alloc_desc();
    80006692:	85b2                	mv	a1,a2
  for(int i = 0; i < NUM; i++){
    80006694:	0001c717          	auipc	a4,0x1c
    80006698:	8ac70713          	add	a4,a4,-1876 # 80021f40 <disk>
    8000669c:	87ce                	mv	a5,s3
    if(disk.free[i]){
    8000669e:	01874683          	lbu	a3,24(a4)
    800066a2:	fee9                	bnez	a3,8000667c <virtio_disk_rw+0x54>
  for(int i = 0; i < NUM; i++){
    800066a4:	2785                	addw	a5,a5,1
    800066a6:	0705                	add	a4,a4,1
    ...
    800066d8:	88450513          	add	a0,a0,-1916 # 80021f58 <disk+0x18>
    800066dc:	ffffc097          	auipc	ra,0xffffc
    800066e0:	dac080e7          	jalr	-596(ra) # 80002488 <sleep>
  for(int i = 0; i < 3; i++){
    800066e4:	f9040613          	add	a2,s0,-112
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    800066f0:	00451693          	sll	a3,a0,0x4

  if(write)
    800066f4:	0001c797          	auipc	a5,0x1c
    800066f8:	84c78793          	add	a5,a5,-1972 # 80021f40 <disk>
    800066fc:	00a50713          	add	a4,a0,10
    80006700:	0712                	sll	a4,a4,0x4
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    80006716:	0a868613          	add	a2,a3,168
  ...
  disk.desc[idx[1]].addr = (uint64) b->data;
    80006736:	0712                	sll	a4,a4,0x4
    80006738:	963a                	add	a2,a2,a4
    8000673a:	058a0593          	add	a1,s4,88
  ...
  if(write)
    ...
    80006750:	0016161b          	sllw	a2,a2,0x1
    disk.desc[idx[1]].flags = 0; // device reads b->data
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    80006754:	00166613          	or	a2,a2,1
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    80006764:	00250613          	add	a2,a0,2
    80006768:	0612                	sll	a2,a2,0x4
    8000676a:	963e                	add	a2,a2,a5
    8000676c:	577d                	li	a4,-1
    8000676e:	00e60823          	sb	a4,16(a2)
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    80006772:	0592                	sll	a1,a1,0x4
    80006774:	98ae                	add	a7,a7,a1
    80006776:	03068713          	add	a4,a3,48
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800067ca:	0001c917          	auipc	s2,0x1c
    800067ce:	89e90913          	add	s2,s2,-1890 # 80022068 <disk+0x128>
  while(b->disk == 1) {
    ...
    800067e0:	cac080e7          	jalr	-852(ra) # 80002488 <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800067f0:	00290713          	add	a4,s2,2
    800067f4:	0712                	sll	a4,a4,0x4
    800067f6:	0001b797          	auipc	a5,0x1b
    800067fa:	74a78793          	add	a5,a5,1866 # 80021f40 <disk>
    800067fe:	97ba                	add	a5,a5,a4
    80006800:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80006804:	0001b997          	auipc	s3,0x1b
    80006808:	73c98993          	add	s3,s3,1852 # 80021f40 <disk>
    8000680c:	00491713          	sll	a4,s2,0x4
    ...
    80006828:	8885                	and	s1,s1,1
    8000682a:	f0ed                	bnez	s1,8000680c <virtio_disk_rw+0x1e4>
  free_chain(idx[0]);

  release(&disk.vdisk_lock);
    8000682c:	0001c517          	auipc	a0,0x1c
    80006830:	83c50513          	add	a0,a0,-1988 # 80022068 <disk+0x128>
...
virtio_disk_intr()
{
    80006856:	1101                	add	sp,sp,-32
    80006858:	ec06                	sd	ra,24(sp)
    8000685a:	e822                	sd	s0,16(sp)
    8000685c:	e426                	sd	s1,8(sp)
    8000685e:	1000                	add	s0,sp,32
  acquire(&disk.vdisk_lock);
    80006860:	0001b497          	auipc	s1,0x1b
    80006864:	6e048493          	add	s1,s1,1760 # 80021f40 <disk>
    80006868:	0001c517          	auipc	a0,0x1c
    8000686c:	80050513          	add	a0,a0,-2048 # 80022068 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    800068a2:	8b9d                	and	a5,a5,7
    800068a4:	078e                	sll	a5,a5,0x3
    800068a6:	97ba                	add	a5,a5,a4
    800068a8:	43dc                	lw	a5,4(a5)

    if(disk.info[id].status != 0)
    800068aa:	00278713          	add	a4,a5,2
    800068ae:	0712                	sll	a4,a4,0x4
    ...
    800068b8:	0789                	add	a5,a5,2
    800068ba:	0792                	sll	a5,a5,0x4
    ...
    800068c8:	c28080e7          	jalr	-984(ra) # 800024ec <wakeup>

    disk.used_idx += 1;
    800068cc:	0204d783          	lhu	a5,32(s1)
    800068d0:	2785                	addw	a5,a5,1
    800068d2:	17c2                	sll	a5,a5,0x30
    800068d4:	93c1                	srl	a5,a5,0x30
  ...
  release(&disk.vdisk_lock);
    800068e4:	0001b517          	auipc	a0,0x1b
    800068e8:	78450513          	add	a0,a0,1924 # 80022068 <disk+0x128>
    ...
    800068fa:	6105                	add	sp,sp,32
    800068fc:	8082                	ret
      panic("virtio_disk_intr status");
    800068fe:	00002517          	auipc	a0,0x2
    80006902:	ee250513          	add	a0,a0,-286 # 800087e0 <etext+0x7e0>
