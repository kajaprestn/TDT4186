...
main(int argc, char *argv[])
{
  ...
  14:	80058593          	add	a1,a1,-2048 # 810 <malloc+0x100>
  18:	4509                	li	a0,2
  ...
  52:	7da58593          	add	a1,a1,2010 # 828 <malloc+0x118>
  56:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	4d050513          	add	a0,a0,1232 # 8a0 <digits>
 3d8:	883a                	mv	a6,a4
 3da:	2705                	addw	a4,a4,1
 3dc:	02c5f7bb          	remuw	a5,a1,a2
 3e0:	1782                	sll	a5,a5,0x20
 3e2:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	37270713          	add	a4,a4,882 # 848 <malloc+0x138>
 ...
 566:	33eb8b93          	add	s7,s7,830 # 8a0 <digits>
 56a:	03c9d793          	srl	a5,s3,0x3c
 ...
 57e:	0992                	sll	s3,s3,0x4
 580:	397d                	addw	s2,s2,-1
 ...
 5bc:	28890913          	add	s2,s2,648 # 840 <malloc+0x130>
        while(*s != 0){
 ...
 6c4:	00e6ea63          	bltu	a3,a4,6d8 <free+0x4a>
{
 ...
 6dc:	6390                	ld	a2,0(a5)
 6de:	02059813          	sll	a6,a1,0x20
 6e2:	01c85713          	srl	a4,a6,0x1c
 ...
 6ec:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 6f0:	4790                	lw	a2,8(a5)
 6f2:	02061593          	sll	a1,a2,0x20
 6f6:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 710:	7139                	add	sp,sp,-64
 712:	fc06                	sd	ra,56(sp)
 714:	f822                	sd	s0,48(sp)
 716:	f426                	sd	s1,40(sp)
 718:	ec4e                	sd	s3,24(sp)
 71a:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 71c:	02051493          	sll	s1,a0,0x20
 720:	9081                	srl	s1,s1,0x20
 722:	04bd                	add	s1,s1,15
 724:	8091                	srl	s1,s1,0x4
 726:	0014899b          	addw	s3,s1,1
 ...
 760:	8a490913          	add	s2,s2,-1884 # 1000 <freep>
  if(p == (char*)-1)
 764:	5afd                	li	s5,-1
 ...
 774:	8a078793          	add	a5,a5,-1888 # 1010 <base>
 ...
 7de:	c798                	sw	a4,8(a5)
        p += p->s.size;
 7e0:	02071693          	sll	a3,a4,0x20
 7e4:	01c6d713          	srl	a4,a3,0x1c
