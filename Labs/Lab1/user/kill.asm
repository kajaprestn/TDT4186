...
main(int argc, char **argv)
{
  ...
  50:	7d458593          	add	a1,a1,2004 # 820 <malloc+0x10a>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	4c250513          	add	a0,a0,1218 # 898 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e0:	36470713          	add	a4,a4,868 # 840 <malloc+0x12a>
 ...
 56c:	330b8b93          	add	s7,s7,816 # 898 <digits>
 ...
 5c2:	27a90913          	add	s2,s2,634 # 838 <malloc+0x122>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7e4:	c798                	sw	a4,8(a5)
        p += p->s.size;
 7e6:	02071693          	sll	a3,a4,0x20
 7ea:	01c6d713          	srl	a4,a3,0x1c
