...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	2de50513          	add	a0,a0,734 # 1370 <malloc+0x108>
      9a:	00001097          	auipc	ra,0x1
      9e:	e0e080e7          	jalr	-498(ra) # ea8 <mkdir>
  if(chdir("grindir") != 0){
      a2:	00001517          	auipc	a0,0x1
      a6:	2ce50513          	add	a0,a0,718 # 1370 <malloc+0x108>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c0:	2bc50513          	add	a0,a0,700 # 1378 <malloc+0x110>
  ...
  chdir("/");
      ...
      e2:	2c250513          	add	a0,a0,706 # 13a0 <malloc+0x138>
      e6:	00001097          	auipc	ra,0x1
      ea:	dca080e7          	jalr	-566(ra) # eb0 <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	2c298993          	add	s3,s3,706 # 13b0 <malloc+0x148>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	2b098993          	add	s3,s3,688 # 13a8 <malloc+0x140>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	57c90913          	add	s2,s2,1404 # 1680 <malloc+0x418>
    ...
    if(what == 1){
     ...
     116:	2a650513          	add	a0,a0,678 # 13b8 <malloc+0x150>
    ...
    int what = rand() % 23;
     ...
     174:	25850513          	add	a0,a0,600 # 13c8 <malloc+0x160>
     ...
     18e:	22e50513          	add	a0,a0,558 # 13b8 <malloc+0x150>
     ...
     1a0:	1d450513          	add	a0,a0,468 # 1370 <malloc+0x108>
     ...
     1fc:	1f050513          	add	a0,a0,496 # 13e8 <malloc+0x180>
     ...
     21e:	1de50513          	add	a0,a0,478 # 13f8 <malloc+0x190>
     ...
     28e:	19650513          	add	a0,a0,406 # 1420 <malloc+0x1b8>
     ...
     2cc:	17850513          	add	a0,a0,376 # 1440 <malloc+0x1d8>
     ...
     2de:	16e50513          	add	a0,a0,366 # 1448 <malloc+0x1e0>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	bae080e7          	jalr	-1106(ra) # e90 <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	0f658593          	add	a1,a1,246 # 13e0 <malloc+0x178>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	15e50513          	add	a0,a0,350 # 1450 <malloc+0x1e8>
     ...
     308:	16450513          	add	a0,a0,356 # 1468 <malloc+0x200>
     30c:	00001097          	auipc	ra,0x1
     310:	b84080e7          	jalr	-1148(ra) # e90 <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	0d458593          	add	a1,a1,212 # 13e8 <malloc+0x180>
     31c:	00001517          	auipc	a0,0x1
     320:	15c50513          	add	a0,a0,348 # 1478 <malloc+0x210>
     ...
     354:	13050513          	add	a0,a0,304 # 1480 <malloc+0x218>
     ...
     3a2:	0e250513          	add	a0,a0,226 # 1480 <malloc+0x218>
     ...
     402:	0a250513          	add	a0,a0,162 # 14a0 <malloc+0x238>
     ...
     42e:	06e50513          	add	a0,a0,110 # 1498 <malloc+0x230>
     ...
     450:	03450513          	add	a0,a0,52 # 1480 <malloc+0x218>
     ...
     46a:	04a50513          	add	a0,a0,74 # 14b0 <malloc+0x248>
     ...
     4b8:	fcc50513          	add	a0,a0,-52 # 1480 <malloc+0x218>
     ...
     514:	fb850513          	add	a0,a0,-72 # 14c8 <malloc+0x260>
     ...
     540:	fa458593          	add	a1,a1,-92 # 14e0 <malloc+0x278>
     ...
     642:	e4250513          	add	a0,a0,-446 # 1480 <malloc+0x218>
     ...
     65c:	ed850513          	add	a0,a0,-296 # 1530 <malloc+0x2c8>
     ...
     670:	ec450513          	add	a0,a0,-316 # 1530 <malloc+0x2c8>
     ...
     688:	e5c58593          	add	a1,a1,-420 # 14e0 <malloc+0x278>
     ...
     6ce:	e6650513          	add	a0,a0,-410 # 1530 <malloc+0x2c8>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	7be080e7          	jalr	1982(ra) # e90 <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e5c50513          	add	a0,a0,-420 # 1538 <malloc+0x2d0>
     ...
     6fa:	e5a50513          	add	a0,a0,-422 # 1550 <malloc+0x2e8>
     ...
     714:	e5850513          	add	a0,a0,-424 # 1568 <malloc+0x300>
     ...
     730:	e5450513          	add	a0,a0,-428 # 1580 <malloc+0x318>
     ...
     74a:	e6250513          	add	a0,a0,-414 # 15a8 <malloc+0x340>
     ...
     832:	e1a58593          	add	a1,a1,-486 # 1648 <malloc+0x3e0>
     ...
     856:	dfe50513          	add	a0,a0,-514 # 1650 <malloc+0x3e8>
     ...
     870:	c5c58593          	add	a1,a1,-932 # 14c8 <malloc+0x260>
     874:	4509                	li	a0,2
     ...
     88c:	c4058593          	add	a1,a1,-960 # 14c8 <malloc+0x260>
     890:	4509                	li	a0,2
     ...
     8e8:	cec58593          	add	a1,a1,-788 # 15d0 <malloc+0x368>
     8ec:	4509                	li	a0,2
     ...
     95c:	b2858593          	add	a1,a1,-1240 # 1480 <malloc+0x218>
     960:	4509                	li	a0,2
     ...
     9a8:	c2c58593          	add	a1,a1,-980 # 15d0 <malloc+0x368>
     9ac:	4509                	li	a0,2
     ...
     9ec:	be858593          	add	a1,a1,-1048 # 15d0 <malloc+0x368>
     9f0:	4509                	li	a0,2
     ...
     a54:	a3058593          	add	a1,a1,-1488 # 1480 <malloc+0x218>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	a2450513          	add	a0,a0,-1500 # 1498 <malloc+0x230>
     a7c:	00000097          	auipc	ra,0x0
     a80:	414080e7          	jalr	1044(ra) # e90 <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	9c450513          	add	a0,a0,-1596 # 1448 <malloc+0x1e0>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aca:	9ba50513          	add	a0,a0,-1606 # 1480 <malloc+0x218>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b14:	97050513          	add	a0,a0,-1680 # 1480 <malloc+0x218>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f2c:	81050513          	add	a0,a0,-2032 # 1738 <digits>
     f30:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1032:	6b270713          	add	a4,a4,1714 # 16e0 <malloc+0x478>
  ...
  putc(fd, 'x');
    ...
    10be:	67eb8b93          	add	s7,s7,1662 # 1738 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1114:	56890913          	add	s2,s2,1384 # 1678 <malloc+0x410>
        while(*s != 0){
