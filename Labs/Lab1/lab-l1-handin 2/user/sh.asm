...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	30e58593          	add	a1,a1,782 # 1320 <malloc+0x108>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d058593          	add	a1,a1,720 # 1330 <malloc+0x118>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	29e50513          	add	a0,a0,670 # 1338 <malloc+0x120>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37270713          	add	a4,a4,882 # 1438 <malloc+0x220>
    ...
    panic("runcmd");
      ...
      e6:	25e50513          	add	a0,a0,606 # 1340 <malloc+0x128>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	24458593          	add	a1,a1,580 # 1348 <malloc+0x130>
     10c:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     154:	20858593          	add	a1,a1,520 # 1358 <malloc+0x140>
     158:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1ea:	18250513          	add	a0,a0,386 # 1368 <malloc+0x150>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	ddca8a93          	add	s5,s5,-548 # 1390 <malloc+0x178>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ca:	daa50513          	add	a0,a0,-598 # 1370 <malloc+0x158>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	cfa60613          	add	a2,a2,-774 # 1398 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6de:	cdeb0b13          	add	s6,s6,-802 # 13b8 <malloc+0x1a0>
  ...
  return ret;
     ...
     70c:	c9850513          	add	a0,a0,-872 # 13a0 <malloc+0x188>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c3e50513          	add	a0,a0,-962 # 13a8 <malloc+0x190>
...
0000000000000794 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b4:	c1060613          	add	a2,a2,-1008 # 13c0 <malloc+0x1a8>
     7b8:	85ce                	mv	a1,s3
     7ba:	854a                	mv	a0,s2
...
0000000000000802 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     824:	ba8a0a13          	add	s4,s4,-1112 # 13c8 <malloc+0x1b0>
  ...
  if(peek(ps, es, ";")){
     ...
     85a:	b7a60613          	add	a2,a2,-1158 # 13d0 <malloc+0x1b8>
     85e:	85ce                	mv	a1,s3
     860:	854a                	mv	a0,s2
...
00000000000008aa <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c0:	adc60613          	add	a2,a2,-1316 # 1398 <malloc+0x180>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f0:	afc60613          	add	a2,a2,-1284 # 13e8 <malloc+0x1d0>
     8f4:	85ca                	mv	a1,s2
     8f6:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96e:	ae670713          	add	a4,a4,-1306 # 1450 <malloc+0x238>
...
00000000000009e6 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a1a:	91260613          	add	a2,a2,-1774 # 1328 <malloc+0x110>
     a1e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a50:	9bc58593          	add	a1,a1,-1604 # 1408 <malloc+0x1f0>
     a54:	4509                	li	a0,2
     a56:	00000097          	auipc	ra,0x0
     a5a:	6dc080e7          	jalr	1756(ra) # 1132 <fprintf>
    panic("syntax");
     a5e:	00001517          	auipc	a0,0x1
     a62:	94250513          	add	a0,a0,-1726 # 13a0 <malloc+0x188>
...
0000000000000a6e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	99a48493          	add	s1,s1,-1638 # 1418 <malloc+0x200>
     a86:	4589                	li	a1,2
     a88:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	8ec58593          	add	a1,a1,-1812 # 1420 <malloc+0x208>
     b3c:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     edc:	5e850513          	add	a0,a0,1512 # 14c0 <digits>
     ee0:	883a                	mv	a6,a4
     ee2:	2705                	addw	a4,a4,1
     ee4:	02c5f7bb          	remuw	a5,a1,a2
     ee8:	1782                	sll	a5,a5,0x20
     eea:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fe2:	48a70713          	add	a4,a4,1162 # 1468 <malloc+0x250>
  ...
  putc(fd, 'x');
    ...
    106e:	456b8b93          	add	s7,s7,1110 # 14c0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c4:	37090913          	add	s2,s2,880 # 1430 <malloc+0x218>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1268:	dac90913          	add	s2,s2,-596 # 2010 <freep>
  if(p == (char*)-1)
    126c:	5afd                	li	s5,-1
    ...
    127c:	e1078793          	add	a5,a5,-496 # 2088 <base>
