...
00000000000001ec <main>:
{
 ...
 25e:	80658593          	add	a1,a1,-2042 # a60 <malloc+0x108>
 262:	4509                	li	a0,2
 ...
 294:	7f050513          	add	a0,a0,2032 # a80 <malloc+0x128>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 61c:	4e050513          	add	a0,a0,1248 # af8 <digits>
 620:	883a                	mv	a6,a4
 622:	2705                	addw	a4,a4,1
 624:	02c5f7bb          	remuw	a5,a1,a2
 628:	1782                	sll	a5,a5,0x20
 62a:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 71a:	00271793          	sll	a5,a4,0x2
 71e:	00000717          	auipc	a4,0x0
 722:	38270713          	add	a4,a4,898 # aa0 <malloc+0x148>
 ...
 7ae:	34eb8b93          	add	s7,s7,846 # af8 <digits>
 ...
 804:	29890913          	add	s2,s2,664 # a98 <malloc+0x140>
        while(*s != 0){
