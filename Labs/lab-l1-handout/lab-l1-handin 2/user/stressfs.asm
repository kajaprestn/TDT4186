...
main(int argc, char *argv[])
{
  ...
  1a:	8da78793          	add	a5,a5,-1830 # 8f0 <malloc+0x136>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	89450513          	add	a0,a0,-1900 # 8c0 <malloc+0x106>
  ...
  6c:	87050513          	add	a0,a0,-1936 # 8d8 <malloc+0x11e>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	83250513          	add	a0,a0,-1998 # 8e8 <malloc+0x12e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47e:	4e650513          	add	a0,a0,1254 # 960 <digits>
 482:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 584:	38870713          	add	a4,a4,904 # 908 <malloc+0x14e>
 ...
 610:	354b8b93          	add	s7,s7,852 # 960 <digits>
 ...
 666:	29e90913          	add	s2,s2,670 # 900 <malloc+0x146>
        while(*s != 0){
