...
main(void)
{
  ...
  12:	8a250513          	add	a0,a0,-1886 # 8b0 <malloc+0x10a>
  ...
  3a:	88290913          	add	s2,s2,-1918 # 8b8 <malloc+0x112>
  3e:	854a                	mv	a0,s2
  ...
  6e:	89e50513          	add	a0,a0,-1890 # 908 <malloc+0x162>
  ...
  8c:	82850513          	add	a0,a0,-2008 # 8b0 <malloc+0x10a>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	81650513          	add	a0,a0,-2026 # 8b0 <malloc+0x10a>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	82450513          	add	a0,a0,-2012 # 8d0 <malloc+0x12a>
  ...
  d2:	81a50513          	add	a0,a0,-2022 # 8e8 <malloc+0x142>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	81250513          	add	a0,a0,-2030 # 8f0 <malloc+0x14a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46a:	52250513          	add	a0,a0,1314 # 988 <digits>
 46e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 568:	00271793          	sll	a5,a4,0x2
 56c:	00000717          	auipc	a4,0x0
 570:	3c470713          	add	a4,a4,964 # 930 <malloc+0x18a>
 ...
 5fc:	390b8b93          	add	s7,s7,912 # 988 <digits>
 ...
 652:	2da90913          	add	s2,s2,730 # 928 <malloc+0x182>
        while(*s != 0){
