...
main(int argc, char *argv[])
{
  ...
  34:	810a8a93          	add	s5,s5,-2032 # 840 <malloc+0x104>
  ...
  76:	7d658593          	add	a1,a1,2006 # 848 <malloc+0x10c>
  7a:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 506:	35670713          	add	a4,a4,854 # 858 <malloc+0x11c>
 ...
 592:	322b8b93          	add	s7,s7,802 # 8b0 <digits>
 ...
 5e8:	26c90913          	add	s2,s2,620 # 850 <malloc+0x114>
        while(*s != 0){
