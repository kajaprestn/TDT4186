...
void forktest(void)
{
  ...
  46:	87e50513          	add	a0,a0,-1922 # 8c0 <malloc+0x10c>
  ...
  70:	874b0b13          	add	s6,s6,-1932 # 8e0 <malloc+0x12c>
            printf("CHILD %d: %d\n", n, i);
  74:	00001a97          	auipc	s5,0x1
  78:	85ca8a93          	add	s5,s5,-1956 # 8d0 <malloc+0x11c>
    for (unsigned long long i = 0; i < 1000; i++)
  ...
  ac:	84850513          	add	a0,a0,-1976 # 8f0 <malloc+0x13c>
...
memset(void *dst, int c, uint n)
{
 ...
 17a:	87aa                	mv	a5,a0
 17c:	1602                	sll	a2,a2,0x20
 17e:	9201                	srl	a2,a2,0x20
 180:	00a60733          	add	a4,a2,a0
    cdst[i] = c;
 184:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
 188:	0785                	add	a5,a5,1
...
gets(char *buf, int max)
{
 ...
 1d8:	4b35                	li	s6,13
  for(i=0; i+1 < max; ){
 1da:	89a6                	mv	s3,s1
 1dc:	2485                	addw	s1,s1,1
 1de:	0344d863          	bge	s1,s4,20e <gets+0x56>
    cc = read(0, &c, 1);
 1e2:	4605                	li	a2,1
 1e4:	faf40593          	add	a1,s0,-81
 1e8:	4501                	li	a0,0
...
{
 22c:	1101                	add	sp,sp,-32
 22e:	ec06                	sd	ra,24(sp)
 230:	e822                	sd	s0,16(sp)
 232:	e04a                	sd	s2,0(sp)
 234:	1000                	add	s0,sp,32
 236:	892e                	mv	s2,a1
  int fd;
  int r;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 478:	4ec50513          	add	a0,a0,1260 # 960 <digits>
 47c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 57e:	38e70713          	add	a4,a4,910 # 908 <malloc+0x154>
 ...
 60a:	35ab8b93          	add	s7,s7,858 # 960 <digits>
 ...
 660:	2a490913          	add	s2,s2,676 # 900 <malloc+0x14c>
        while(*s != 0){
...
free(void *ap)
{
 732:	1141                	add	sp,sp,-16
 734:	e422                	sd	s0,8(sp)
 736:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 738:	ff050693          	add	a3,a0,-16
 ...
 768:	00e6ea63          	bltu	a3,a4,77c <free+0x4a>
{
 ...
 780:	6390                	ld	a2,0(a5)
 782:	02059813          	sll	a6,a1,0x20
 786:	01c85713          	srl	a4,a6,0x1c
 ...
 790:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 794:	4790                	lw	a2,8(a5)
 796:	02061593          	sll	a1,a2,0x20
 79a:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 804:	80090913          	add	s2,s2,-2048 # 1000 <freep>
  if(p == (char*)-1)
 808:	5afd                	li	s5,-1
 ...
 882:	c798                	sw	a4,8(a5)
        p += p->s.size;
 884:	02071693          	sll	a3,a4,0x20
 888:	01c6d713          	srl	a4,a3,0x1c
