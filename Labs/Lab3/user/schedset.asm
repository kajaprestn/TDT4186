...
int main(int argc, char *argv[])
{
  ...
  12:	81250513          	add	a0,a0,-2030 # 820 <malloc+0x10e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	4ce50513          	add	a0,a0,1230 # 8a0 <digits>
 3da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	00271793          	sll	a5,a4,0x2
 4d8:	00000717          	auipc	a4,0x0
 4dc:	37070713          	add	a4,a4,880 # 848 <malloc+0x136>
 ...
 568:	33cb8b93          	add	s7,s7,828 # 8a0 <digits>
 ...
 5be:	28690913          	add	s2,s2,646 # 840 <malloc+0x12e>
        while(*s != 0){
