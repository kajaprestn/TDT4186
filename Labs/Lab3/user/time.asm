...
int main(int argc, char *argv[])
{
  ...
  4c:	84850513          	add	a0,a0,-1976 # 890 <malloc+0x10a>
  50:	00000097          	auipc	ra,0x0
  54:	67e080e7          	jalr	1662(ra) # 6ce <printf>
        printf("Usage: time [exec] [arg1 arg2 ...]\n");
  58:	00001517          	auipc	a0,0x1
  5c:	85050513          	add	a0,a0,-1968 # 8a8 <malloc+0x122>
  ...
  78:	85c50513          	add	a0,a0,-1956 # 8d0 <malloc+0x14a>
  ...
  aa:	85250513          	add	a0,a0,-1966 # 8f8 <malloc+0x172>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44a:	53250513          	add	a0,a0,1330 # 978 <digits>
 44e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 550:	3d470713          	add	a4,a4,980 # 920 <malloc+0x19a>
 ...
 5dc:	3a0b8b93          	add	s7,s7,928 # 978 <digits>
 ...
 632:	2ea90913          	add	s2,s2,746 # 918 <malloc+0x192>
        while(*s != 0){
